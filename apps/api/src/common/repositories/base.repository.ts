...
export abstract class BaseRepository<TEntity extends ObjectLiteral> {
  ...
  /**
   * Partially updates an entity in the database. Optionally emits a corresponding event based on the changes.
   *
   ...
   * @param params.entity - Optional pre-fetched entity to use instead of fetching from the database.
