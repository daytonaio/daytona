...
const configuration = {
  ...
  mockRunner: {
    domain: process.env.MOCK_RUNNER_DOMAIN,
    apiKey: process.env.MOCK_RUNNER_API_KEY,
    proxyUrl: process.env.MOCK_RUNNER_PROXY_URL,
    apiUrl: process.env.MOCK_RUNNER_API_URL,
    cpu: parseInt(process.env.MOCK_RUNNER_CPU || '4', 10),
    memory: parseInt(process.env.MOCK_RUNNER_MEMORY || '8', 10),
    disk: parseInt(process.env.MOCK_RUNNER_DISK || '50', 10),
    gpu: parseInt(process.env.MOCK_RUNNER_GPU || '0', 10),
