...
const configuration = {
  ...
  defaultOrganizationQuota: {
    ...
    totalSnapshotQuota: parseInt(process.env.DEFAULT_ORG_QUOTA_TOTAL_SNAPSHOT_QUOTA || '300', 10),
  ...
  admin: {
    ...
    totalSnapshotQuota: parseInt(process.env.ADMIN_TOTAL_SNAPSHOT_QUOTA || '300', 10),
