...
const configuration = {
  ...
  runnerScore: {
    thresholds: {
      declarativeBuild: parseInt(process.env.RUNNER_DECLARATIVE_BUILD_SCORE_THRESHOLD || '30', 10),
      availability: parseInt(process.env.RUNNER_AVAILABILITY_SCORE_THRESHOLD || '30', 10),
    },
    weights: {
      ...
      allocatedCpu: parseFloat(process.env.RUNNER_ALLOCATED_CPU_WEIGHT || '0.01'),
      allocatedMemory: parseFloat(process.env.RUNNER_ALLOCATED_MEMORY_WEIGHT || '0.01'),
      allocatedDisk: parseFloat(process.env.RUNNER_ALLOCATED_DISK_WEIGHT || '0.01'),
    },
    penalty: {
      exponents: {
    ...
    targetValues: {
      ideal: {
        ...
        allocCpu: parseInt(process.env.RUNNER_IDEAL_ALLOC_CPU || '0', 10),
        allocMem: parseInt(process.env.RUNNER_IDEAL_ALLOC_MEM || '0', 10),
        allocDisk: parseInt(process.env.RUNNER_IDEAL_ALLOC_DISK || '0', 10),
      },
      antiIdeal: {
