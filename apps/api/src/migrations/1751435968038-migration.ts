...
export class Migration1751435968038 implements MigrationInterface {
  name = 'Migration1751435968038'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "snapshot_target_propagation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "target" character varying NOT NULL, "desiredConcurrentSandboxes" integer NOT NULL, "userMinimum" integer NOT NULL DEFAULT '0', "snapshotId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "snapshot_target_propagation_id_pk" PRIMARY KEY ("id"))`,
    )
