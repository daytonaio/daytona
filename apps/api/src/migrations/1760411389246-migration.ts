...
export class Migration1760411389246 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."disk_state_enum" AS ENUM('fresh', 'pulling', 'ready', 'attached', 'detached', 'pending_push', 'pushing', 'stored', 'pending_delete', 'deleting', 'deleted', 'error', 'pending_fork', 'forking', 'locked')`,
    )
    await queryRunner.query(
