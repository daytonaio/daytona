...
export class RegionController {
  ...
  async listRegions(
    ...
    if (includeShared) {
      ...
      const availableSharedRegions = sharedRegions.filter((region) => !region.hidden)
  ...
  async createRegion(
    ...
    const region = await this.regionService.create(createRegionDto, authContext.organizationId)
