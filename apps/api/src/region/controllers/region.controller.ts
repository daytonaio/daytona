...
export class RegionController {
  ...
  @ApiQuery({
    name: 'includeGlobal',
    description: 'Include global regions in the response',
    required: false,
    type: Boolean,
  })
  ...
  async listRegions(
    ...
    const regions = await this.regionService.findAll(authContext.organization, includeGlobal)
  ...
  async getRegionByName(
    ...
    const region = await this.regionService.findOneByNameAndOrganization(name, authContext.organizationId)
    return RegionDto.fromRegion(region)
  }
