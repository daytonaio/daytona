...
import { CreateSnapshotTargetPropagationDto } from './create-snasphot-target-propagation.dto'
...
export class CreateSnapshotDto {
  ...
  @ApiPropertyOptional({
    ...
    type: [CreateSnapshotTargetPropagationDto],
  })
  @IsOptional()
  @IsArray()
  targetPropagations?: CreateSnapshotTargetPropagationDto[]
}
