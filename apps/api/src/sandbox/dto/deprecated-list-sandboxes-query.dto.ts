...
export enum DeprecatedSandboxSortField {
  ID = 'id',
  NAME = 'name',
  STATE = 'state',
  SNAPSHOT = 'snapshot',
...
export enum DeprecatedSandboxSortDirection {
  ASC = 'asc',
  DESC = 'desc',
}

export const DEPRECATED_DEFAULT_SANDBOX_SORT_FIELD = DeprecatedSandboxSortField.CREATED_AT
export const DEPRECATED_DEFAULT_SANDBOX_SORT_DIRECTION = DeprecatedSandboxSortDirection.DESC

const VALID_QUERY_STATES = Object.values(SandboxState).filter((state) => state !== SandboxState.DESTROYED)

@ApiSchema({ name: 'DeprecatedListSandboxesQuery' })
export class DeprecatedListSandboxesQueryDto {
  @PageNumber(1)
  page = 1
  ...
  @ApiProperty({
    ...
    required: false,
    enum: DeprecatedSandboxSortField,
    default: DEPRECATED_DEFAULT_SANDBOX_SORT_FIELD,
  })
  @IsOptional()
  @IsEnum(DeprecatedSandboxSortField)
  sort = DEPRECATED_DEFAULT_SANDBOX_SORT_FIELD

  @ApiProperty({
    name: 'order',
    description: 'Direction to sort by',
    required: false,
    enum: DeprecatedSandboxSortDirection,
    default: DEPRECATED_DEFAULT_SANDBOX_SORT_DIRECTION,
  })
  @IsOptional()
  @IsEnum(DeprecatedSandboxSortDirection)
  order = DEPRECATED_DEFAULT_SANDBOX_SORT_DIRECTION
}
