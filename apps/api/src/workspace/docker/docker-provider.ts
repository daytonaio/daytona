...
export class DockerProvider implements OnModuleInit {
  ...
  public async startTerminalProcess(container: Docker.Container, port = 22222): Promise<void> {
    try {
      ...
      // Don't throw the error to prevent breaking the workspace creation
    }
  }
  ...
  async remove(containerId: string): Promise<void> {
    try {
      ...
      throw error // Rethrow to let workspace service handle the error state
    }
  }
