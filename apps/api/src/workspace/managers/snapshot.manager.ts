...
export class SnapshotManager {
  ...
  async handleSnapshotRunnerStateBuildingSnapshot(snapshotRunner: SnapshotRunner) {
    ...
    const runnerWorkspaceApi = this.runnerApiFactory.createSnapshotApi(runner)
    const response = (await runnerWorkspaceApi.snapshotExists(snapshotRunner.snapshotRef)).data
