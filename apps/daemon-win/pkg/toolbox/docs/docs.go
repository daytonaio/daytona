        ...
        "/files/permissions": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Owner (not supported on Windows - ignored)",
                        "name": "owner",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Group (not supported on Windows - ignored)",
                        "name": "group",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "ExecuteRequest": {
            ...
            "properties": {
                ...
                "timeout": {
                    "description": "Timeout in seconds, defaults to 360 seconds",
                    "type": "integer"
                }
            }
        },
        ...
        "GetRecordingResponse": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/recording.RecordingStatus"
                }
            }
        },
        "GitAddRequest": {
        ...
        "StartRecordingRequest": {
            ...
            "properties": {
                "label": {
                    "description": "Optional custom label for the recording",
                    "type": "string"
                }
            }
        },
