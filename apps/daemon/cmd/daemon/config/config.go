...
type Config struct {
	...
	TerminationGracePeriodSeconds        int    `envconfig:"DAYTONA_TERMINATION_GRACE_PERIOD_SECONDS"`
	TerminationCheckIntervalMilliseconds int    `envconfig:"DAYTONA_TERMINATION_CHECK_INTERVAL_MILLISECONDS"`
}
