...
func TerminateProcessTreeGracefully(ctx context.Context, proc *os.Process, gracePeriod, checkInterval time.Duration) error {
	...
	log.Debugf("PID %d SIGTERM timed out or failed, sending SIGKILL", pid)
	if isGroupLeader {
