    ...
    const e = {
          ...
          let _ = (t.AccessibilityManager = class extends h.Disposable {
            constructor(e, t) {
              ...
              if (
                ...
                (this._liveRegionDebouncer = this.register(new a.TimeBasedDebouncer(this._renderRows.bind(this)))),
              ...
              this._terminal.element.insertAdjacentElement('afterbegin', this._accessibilityContainer),
                ...
                this.register((0, d.addDisposableDomListener)(window, 'resize', () => this._refreshRowsDimensions())),
                this._refreshRows(),
                this.register(
                  (0, h.toDisposable)(() => {
          ...
          let c = (t.Linkifier2 = class extends a.Disposable {
            ...
            attachToDom(e, t, i) {
              ;(this._element = e),
                ...
                this.register((0, n.addDisposableDomListener)(this._element, 'mouseup', this._handleMouseUp.bind(this)))
            }
            _handleMouseMove(e) {
                ...
                t
                  ...
                  : n.provideLinks(e.y, (t) => {
                      ...
                      null === (s = this._activeProviderReplies) || void 0 === s || s.set(i, o),
                        (r = this._checkLinkProviderResult(i, e, r)),
                        (null === (n = this._activeProviderReplies) || void 0 === n ? void 0 : n.size) ===
                          this._linkProviders.length && this._removeIntersectingLinks(e.y, this._activeProviderReplies)
                    })
            }
            ...
            (t.RenderDebouncer = class {
              ...
              dispose() {
                this._animationFrame &&
                  (this._parentWindow.cancelAnimationFrame(this._animationFrame), (this._animationFrame = void 0))
              }
          ...
          class P extends y.CoreTerminal {
            ...
            constructor(e = {}) {
              super(e),
                ...
                this._setup(),
                (this.linkifier2 = this.register(this._instantiationService.createInstance(n.Linkifier2))),
                this.linkifier2.registerLinkProvider(this._instantiationService.createInstance(a.OscLinkProvider)),
                ...
                this.register((0, w.forwardEvent)(this._inputHandler.onTitleChange, this._onTitleChange)),
                this.register((0, w.forwardEvent)(this._inputHandler.onA11yChar, this._onA11yCharEmitter)),
                this.register((0, w.forwardEvent)(this._inputHandler.onA11yTab, this._onA11yTabEmitter)),
              ...
              if (this._themeService)
                for (const t of e) {
                  ...
                  switch (t.type) {
                    ...
                    case 1:
                      if ('ansi' === e)
                        this._themeService.modifyColors((e) => (e.ansi[t.index] = b.rgba.toColor(...t.color)))
                      else {
                        const i = e
            ...
            _bindKeys() {
              this.register((0, r.addDisposableDomListener)(this.textarea, 'keyup', (e) => this._keyUp(e), !0)),
                this.register((0, r.addDisposableDomListener)(this.textarea, 'keydown', (e) => this._keyDown(e), !0)),
                this.register((0, r.addDisposableDomListener)(this.textarea, 'keypress', (e) => this._keyPress(e), !0)),
                this.register(
                ...
                this.register((0, r.addDisposableDomListener)(this.textarea, 'input', (e) => this._inputEvent(e), !0)),
            ...
            open(e) {
              ...
              ;(this._viewportElement = O.createElement('div')),
                ...
                this.register((0, r.addDisposableDomListener)(this.textarea, 'blur', () => this._handleTextAreaBlur())),
              ...
              this._renderService.hasRenderer() || this._renderService.setRenderer(this._createRenderer()),
                ...
                this.register(
                  this._selectionService.onRequestScrollLines((e) => this.scrollLines(e.amount, e.suppressScrollEvent)),
                ),
                ...
                this.coreMouseService.onProtocolChange((e) => {
                  e
                    ? ('debug' === this.optionsService.rawOptions.logLevel &&
                        this._logService.debug('Binding to mouse events:', this.coreMouseService.explainEvents(e)),
                    ...
                    2 & e
                      ? s.mouseup || (t.addEventListener('mouseup', n.mouseup), (s.mouseup = n.mouseup))
                      : (this._document.removeEventListener('mouseup', s.mouseup),
            ...
            getSelectionPosition() {
              if (this._selectionService && this._selectionService.hasSelection)
                return {
                  start: { x: this._selectionService.selectionStart[0], y: this._selectionService.selectionStart[1] },
            ...
            _keyDown(e) {
              ...
              if (!t && !this._compositionHelper.keydown(e))
                return (
                  this.options.scrollOnUserInput && this.buffer.ybase !== this.buffer.ydisp && this.scrollToBottom(), !1
                )
        ...
        1680: function (e, t, i) {
          ...
          let l = (t.Viewport = class extends h.Disposable {
            ...
            _bubbleScroll(e, t) {
              ...
              return (
                !((t < 0 && 0 !== this._viewportElement.scrollTop) || (t > 0 && i < this._lastRecordedBufferHeight)) ||
          ...
          let c = (t.BufferDecorationRenderer = class extends a.Disposable {
            constructor(e, t, i, s) {
              super(),
                ...
                this.register((0, n.addDisposableDomListener)(window, 'resize', () => this._queueRefresh())),
                this.register(
            ...
            _createElement(e) {
              ...
              s.classList.add('xterm-decoration'),
                s.classList.toggle(
                  ...
                  'top' === (null === (t = null == e ? void 0 : e.options) || void 0 === t ? void 0 : t.layer),
                ),
          ...
          let u = (t.OverviewRulerRenderer = class extends h.Disposable {
            ...
            _refreshColorZonePadding() {
              this._colorZoneStore.setPadding({
                full: Math.floor(
                  (this._bufferService.buffers.active.lines.length / (this._canvas.height - 1)) * l.full,
                ),
                left: Math.floor(
                  (this._bufferService.buffers.active.lines.length / (this._canvas.height - 1)) * l.left,
                ),
                center: Math.floor(
                  (this._bufferService.buffers.active.lines.length / (this._canvas.height - 1)) * l.center,
                ),
                right: Math.floor(
                  (this._bufferService.buffers.active.lines.length / (this._canvas.height - 1)) * l.right,
                ),
              }),
                (this._lastKnownBufferLength = this._bufferService.buffers.normal.lines.length)
            }
            ...
            _renderColorZone(e) {
              ;(this._ctx.fillStyle = e.color),
                this._ctx.fillRect(
                  _[e.position || 'full'],
                  Math.round(
                    (this._canvas.height - 1) * (e.startBufferLine / this._bufferService.buffers.active.lines.length) -
                      l[e.position || 'full'] / 2,
                  ),
                  d[e.position || 'full'],
                  Math.round(
            ...
            for (; o !== i || a !== s; )
              (o += r ? 1 : -1),
                r && o > n.cols - 1
                  ...
                  : !r &&
                    o < 0 &&
                    ((h += n.buffer.translateBufferLineToString(a, !1, 0, e + 1)), (o = n.cols - 1), (e = o), a--)
            ...
            b = (t.DomRenderer = class extends _.Disposable {
              ...
              _injectCss(e) {
                ...
                ;(t += `${this._terminalSelector} .${v} .xterm-dim { color: ${l.color.multiplyOpacity(e.foreground, 0.5).css};}`),
                  ...
                  (t +=
                    '@keyframes blink_box_shadow_' + this._terminalClass + ' { 50% {  border-bottom-style: hidden; }}'),
                  (t +=
            ...
            createRow(e, t, i, s, r, a, h, l, _, f, p) {
              ...
              for (let M = 0; M < b; M++) {
                ...
                if (
                  ...
                  (w = I.isInvisible() ? o.WHITESPACE_CELL_CHAR : I.getChars() || o.WHITESPACE_CELL_CHAR),
                  I.isUnderline() &&
                  ...
                  (this._decorationService.forEachDecorationAtCell(M, t, void 0, (e) => {
                    ;('top' !== e.options.layer && J) ||
                      (e.backgroundColorRGB &&
                        ((K = 50331648), (z = (e.backgroundColorRGB.rgba >> 8) & 16777215), (V = e.backgroundColorRGB)),
                      e.foregroundColorRGB &&
                        ((j = 50331648), ($ = (e.foregroundColorRGB.rgba >> 8) & 16777215), (G = e.foregroundColorRGB)),
            ...
            (t.WidthCache = class {
              ...
              get(e, t, i) {
                ...
                if (!t && !i && 1 === e.length && (s = e.charCodeAt(0)) < 256)
                  return -9999 !== this._flat[s] ? this._flat[s] : (this._flat[s] = this._measure(e, 0))
                let r = e
                t && (r += 'B'), i && (r += 'I')
          ...
          let u = (t.RenderService = class extends l.Disposable {
            ...
            constructor(e, t, i, s, r, h, _, u) {
              if (
                ...
                (this._renderDebouncer = new o.RenderDebouncer(_.window, (e, t) => this._renderRows(e, t))),
                ...
                this.register(
                  (0, n.addDisposableDomListener)(_.window, 'resize', () => this.handleDevicePixelRatioChange()),
                ),
        ...
        9312: function (e, t, i) {
          ...
          let g = (t.SelectionService = class extends l.Disposable {
            ...
            _selectWordAtCursor(e, t) {
              ...
              if (r)
                return (
                  ...
                  (this._model.selectionStartLength = (0, _.getRangeLength)(r, this._bufferService.cols)),
            ...
            handleMouseDown(e) {
              if (
                ((this._mouseDownTimeStamp = e.timeStamp), (2 !== e.button || !this.hasSelection) && 0 === e.button)
              ) {
                if (!this._enabled) {
              ...
              if (this._model.selectionEnd && this._model.selectionStart && this._dragScrollAmount) {
                ...
                this._dragScrollAmount > 0
                  ? (3 !== this._activeSelectionMode && (this._model.selectionEnd[0] = this._bufferService.cols),
                    (this._model.selectionEnd[1] = Math.min(e.ydisp + this._bufferService.rows, e.lines.length - 1)))
            ...
            _getWordAt(e, t, i = !0, s = !0) {
              ...
              if (' ' === o.charAt(a)) {
                ...
                for (
                  ;
                  i < n.length && h + 1 < o.length && !this._isCharWordSeparator(n.loadCell(i + 1, this._workCell));
          ...
          ;(t.NULL_COLOR = { css: '#00000000', rgba: 0 }),
            ...
            (function (e) {
              ...
              e.toColor = function (e) {
                ...
                if ((t.fillRect(0, 0, 1, 1), ([r, n, o, a] = t.getImageData(0, 0, 1, 1).data), 255 !== a))
                  throw new Error('css.toColor: Unsupported css format')
        ...
        8969: (e, t, i) => {
          ...
          class S extends s.Disposable {
            ...
            resize(e, t) {
              isNaN(e) ||
                isNaN(t) ||
                ((e = Math.max(e, a.MINIMUM_COLS)), (t = Math.max(t, a.MINIMUM_ROWS)), this._bufferService.resize(e, t))
            }
            scroll(e, t = !1) {
          ...
          class E extends h.Disposable {
            ...
            constructor(e, t, i, s, r, h, _, f, v = new a.EscapeSequenceParser()) {
              super(),
                ...
                this._parser.registerCsiHandler({ intermediates: ' ', final: 'q' }, (e) => this.setCursorStyle(e)),
                ...
                this._parser.registerCsiHandler({ intermediates: '"', final: 'q' }, (e) => this.selectProtected(e)),
                this._parser.registerCsiHandler({ intermediates: '$', final: 'p' }, (e) => this.requestMode(e, !0)),
                ...
                this._parser.registerOscHandler(4, new p.OscHandler((e) => this.setOrReportIndexedColor(e))),
                this._parser.registerOscHandler(8, new p.OscHandler((e) => this.setHyperlink(e))),
                this._parser.registerOscHandler(10, new p.OscHandler((e) => this.setOrReportFgColor(e))),
                this._parser.registerOscHandler(11, new p.OscHandler((e) => this.setOrReportBgColor(e))),
                this._parser.registerOscHandler(12, new p.OscHandler((e) => this.setOrReportCursorColor(e))),
                this._parser.registerOscHandler(104, new p.OscHandler((e) => this.restoreIndexedColor(e))),
                ...
                this._parser.registerOscHandler(112, new p.OscHandler((e) => this.restoreCursorColor(e))),
              ...
              for (const e in o.CHARSETS)
                this._parser.registerEscHandler({ intermediates: '(', final: e }, () => this.selectCharset('(' + e)),
                  this._parser.registerEscHandler({ intermediates: ')', final: e }, () => this.selectCharset(')' + e)),
                  this._parser.registerEscHandler({ intermediates: '*', final: e }, () => this.selectCharset('*' + e)),
                  this._parser.registerEscHandler({ intermediates: '+', final: e }, () => this.selectCharset('+' + e)),
                  this._parser.registerEscHandler({ intermediates: '-', final: e }, () => this.selectCharset('-' + e)),
                ...
                if (
                  ...
                  if (
                    (l &&
                      ...
                      2 === u.getWidth(a - 1) &&
                        u.setCellFromCodePoint(a - 1, _.NULL_CELL_CODE, _.NULL_CELL_WIDTH, d.fg, d.bg, d.extended)),
                    u.setCellFromCodePoint(this._activeBuffer.x++, s, r, d.fg, d.bg, d.extended),
                    r > 0)
                  )
                    for (; --r; ) u.setCellFromCodePoint(this._activeBuffer.x++, 0, 0, d.fg, d.bg, d.extended)
                } else
            ...
            backspace() {
              ...
              if ((this._restrictCursor(this._bufferService.cols), this._activeBuffer.x > 0)) this._activeBuffer.x--
                ...
                (null === (e = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y)) ||
                void 0 === e
                  ? void 0
                  : e.isWrapped)
              ) {
            ...
            cursorDown(e) {
              ...
              return (
                t >= 0 ? this._moveCursor(0, Math.min(t, e.params[0] || 1)) : this._moveCursor(0, e.params[0] || 1), !0
              )
            }
            cursorForward(e) {
            ...
            scrollUp(e) {
              ...
              return (
                this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), !0
              )
            }
            scrollDown(e) {
              let t = e.params[0] || 1
            ...
            selectCharset(e) {
              return 2 !== e.length
                ...
                : ('/' === e[0] || this._charsetService.setgCharset(S[e[0]], o.CHARSETS[e[1]] || o.DEFAULT_CHARSET), !0)
            }
            index() {
              return (
                this._restrictCursor(),
        ...
        9282: (e, t, i) => {
          ...
          t.updateWindowsModeWrappedState = function (e) {
            ...
            r &&
              i &&
              (r.isWrapped =
                i[s.CHAR_DATA_CODE_INDEX] !== s.NULL_CELL_CODE && i[s.CHAR_DATA_CODE_INDEX] !== s.WHITESPACE_CELL_CODE)
          }
        },
        3734: (e, t) => {
          ...
          class h {
            ...
            addCodepointToCell(e, t) {
              ...
              2097152 & i
                ...
                : (2097151 & i
                    ? ((this._combined[e] = (0, o.stringFromCodePoint)(2097151 & i) + (0, o.stringFromCodePoint)(t)),
                      (i &= -2097152),
                      (i |= 2097152))
                    : (i = t | (1 << 22)),
                  (this._data[3 * e + 0] = i))
            ...
            translateToString(e = !1, t = 0, i = this.length) {
              ...
              for (; t < i; ) {
                const e = this._data[3 * t + 0],
                  i = 2097151 & e
                ;(s += 2097152 & e ? this._combined[t] : i ? (0, o.stringFromCodePoint)(i) : n.WHITESPACE_CELL_CHAR),
                  (t += e >> 22 || 1)
              }
              return s
            }
              ...
              decode(e, t) {
                ...
                for (; d < i; ) {
                  ...
                  if (((s = e[d++]), s < 128)) t[a++] = s
                    ...
                    if (
                      ((h = ((7 & s) << 18) | ((63 & r) << 12) | ((63 & n) << 6) | (63 & o)), h < 65536 || h > 1114111)
                    )
                      continue
                    t[a++] = h
                  }
                ...
                if (
                  ...
                  for (; s >= 0 && ((i = this._active[s].unhook(e)), !0 !== i); s--)
                    if (i instanceof Promise)
                      return (
                        (this._stack.paused = !0), (this._stack.loopPosition = s), (this._stack.fallThrough = !1), i
                      )
                  s--
                }
                for (; s >= 0; s--)
                  if (((i = this._active[s].unhook(!1)), i instanceof Promise))
                    return (this._stack.paused = !0), (this._stack.loopPosition = s), (this._stack.fallThrough = !0), i
        ...
        2015: (e, t, i) => {
          ...
          class c extends s.Disposable {
            ...
            parse(e, t, i) {
              ...
              if (this._parseStack.state)
                if (2 === this._parseStack.state) (this._parseStack.state = 0), (o = this._parseStack.chunkPos + 1)
                  ...
                  switch (this._parseStack.state) {
                    ...
                    case 6:
                      if (
                        ((r = e[this._parseStack.chunkPos]), (s = this._dcsParser.unhook(24 !== r && 26 !== r, i)), s)
                      )
                        return s
                      ...
                      break
                    case 5:
                      if (((r = e[this._parseStack.chunkPos]), (s = this._oscParser.end(24 !== r && 26 !== r, i)), s))
                        return s
                      27 === r && (this._parseStack.transition |= 1),
                        this._params.reset(),
                        this._params.addParam(0),
              ...
              for (let i = o; i < t; ++i) {
                switch (
                  ((r = e[i]), (n = this._transitions.table[(this.currentState << 8) | (r < 160 ? r : h)]), n >> 4)
                ) {
                  case 2:
                    for (let s = i + 1; ; ++s) {
                  ...
                  if ((1 === this._state && this._start(), this._active.length)) {
                    ...
                    for (; s >= 0; s--)
                      if (((i = this._active[s].end(!1)), i instanceof Promise))
                        return (
                          (this._stack.paused = !0), (this._stack.loopPosition = s), (this._stack.fallThrough = !0), i
                        )
