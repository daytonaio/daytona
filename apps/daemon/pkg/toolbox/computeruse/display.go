...
func (u *ComputerUse) TakeCompressedScreenshot(c *gin.Context) {
	showCursor := c.Query("show_cursor") == "true"
	params := getCompressionParams(c)
...
func (u *ComputerUse) TakeCompressedRegionScreenshot(c *gin.Context) {
	var region struct {
		X      int `form:"x"`
		Y      int `form:"y"`
	...
	if err := c.ShouldBindQuery(&region); err != nil {
...
func (u *ComputerUse) GetDisplayInfo(c *gin.Context) {
...
func (u *ComputerUse) GetWindows(c *gin.Context) {
