    ...
    "paths": {
        ...
        "/computeruse/a11y/wait": {
            "post": {
                ...
                "operationId": "WaitAccessibility",
                "parameters": [
                    {
                        "description": "Wait request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/AccessibilityWaitRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/AccessibilityWaitResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
