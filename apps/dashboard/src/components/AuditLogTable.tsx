  ...
  const columns: ColumnDef<AuditLog>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="space-y-1">
            <div className="font-medium truncate">{targetType}</div>
            <div className="text-sm text-muted-foreground truncate">{targetId}</div>
          </div>
        )
      },
    },
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="space-y-1">
            ...
            {!errorMessage ? (
              <div className="text-sm text-muted-foreground truncate">{statusCode}</div>
            ) : (
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
