...
interface SandboxDetailsSheetProps {
  ...
  handleStart: (id: string) => unknown
  handleStop: (id: string) => unknown
  handleDelete: (id: string) => unknown
  handleArchive: (id: string) => unknown
  getRegionName: (regionId: string) => string | undefined
  writePermitted: boolean
  deletePermitted: boolean
  handleRecover: (id: string) => unknown
  onCreateSshAccess: (id: string) => unknown
  onRevokeSshAccess: (id: string) => unknown
  onScreenRecordings: (id: string) => unknown
  onNavigate: (direction: 'prev' | 'next') => unknown
  hasPrev: boolean
  hasNext: boolean
  initialTab?: SandboxDetailsSheetTabValue
  activeTab?: SandboxDetailsSheetTabValue
  onTabChange?: (tab: SandboxDetailsSheetTabValue) => unknown
}
