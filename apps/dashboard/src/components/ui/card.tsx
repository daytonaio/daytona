...
function CardTitle({ ref, className, ...props }: React.ComponentProps<'div'>) {
  return <div ref={ref} className={cn('text-xl font-semibold leading-none tracking-tight', className)} {...props} />
}
...
function CardContent({ ref, className, ...props }: React.ComponentProps<'div'>) {
  return <div ref={ref} className={cn('p-4 w-full', className)} {...props} />
}

function CardFooter({ ref, className, ...props }: React.ComponentProps<'div'>) {
  return <div ref={ref} className={cn('flex items-center p-4 border-t border-border', className)} {...props} />
}
