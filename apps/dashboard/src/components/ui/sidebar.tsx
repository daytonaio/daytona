    ...
    >
      ...
      <div
        className={cn(
          ...
          { 'md:top-12 md:bottom-0 md:h-[calc(100svh-3rem)]': isBannerVisible },
          {
            'left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]': side === 'left',
            'right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]': side !== 'left',
          },
...
function SidebarTrigger({ ref, className, onClick, ...props }: React.ComponentProps<typeof Button>) {
...
function SidebarRail({ ref, className, ...props }: React.ComponentProps<'button'>) {
  const { toggleSidebar } = useSidebar()
  ...
  return (
    <main
      ...
      className={cn(
        ...
        'peer-data-[variant=inset]:min-h-[calc(100svh_-_(var(--spacing)_*_4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow',
        className,
      )}
      {...props}
    />
...
function SidebarInput({ ref, className, ...props }: React.ComponentProps<typeof Input>) {
  return (
    <Input
      ref={ref}
      data-sidebar="input"
...
function SidebarSeparator({ ref, className, ...props }: React.ComponentProps<typeof Separator>) {
  return (
    <Separator
      ref={ref}
...
function SidebarMenuBadge({ ref, className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ref={ref}
