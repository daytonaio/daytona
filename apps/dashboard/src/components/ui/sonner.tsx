...
function stopToastEventPropagation(event: React.SyntheticEvent) {
...
const Toaster = ({ className, toastOptions, ...props }: ToasterProps) => {
  ...
  return (
    <div
      className="contents"
      onPointerDown={stopToastEventPropagation}
      onClick={stopToastEventPropagation}
      onFocus={stopToastEventPropagation}
    >
      <Sonner
