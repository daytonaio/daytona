...
const Playground: React.FC = () => {
  ...
  const sandboxCreationCodeSnippetsData = useMemo(
    () => ({
      [CodeLanguage.PYTHON]: {
...
`,
  ...
  return (
    <div className="px-6 py-2">
      ...
      <div className="w-full p-6 flex flex-col space-y-2 md:flex-row md:space-x-2 md:space-y-0">
                ...
                {codeSnippetSupportedLanguages.map((language) => (
                  <TabsContent value={language.value}>
                    <CodeBlock
                      ...
                      code={sandboxCreationCodeSnippetsData[language.value].code}
