...
import { Region, CreateRegion, CreateRegionResponse, OrganizationRolePermissionsEnum } from '@daytonaio/api-client'
...
const Regions: React.FC = () => {
  ...
  const fetchRegions = useCallback(
    async (showTableLoadingState = true) => {
      ...
      try {
        const response = (await regionsApi.listRegions(selectedOrganization.id, false)).data
        setRegions(response)
      } catch (error) {
