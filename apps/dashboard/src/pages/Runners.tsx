...
const Runners: React.FC = () => {
  ...
  const [loadingRegionsData, setLoadingRegionsData] = useState(true)
  ...
  return (
    <div className="px-6 py-2">
      ...
      <RunnerTable
        data={runners}
        regions={regions}
        loading={loadingRunnersData || loadingRegionsData}
