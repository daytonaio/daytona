...
- `id` _str_ - Unique identifier for the Sandbox.
- `snapshot` _Optional[str]_ - Daytona snapshot used to create the Sandbox.
...
- `backup_state` _Optional[str]_ - Current state of Sandbox backup.
- `backup_created_at` _Optional[str]_ - When the backup was created.
...
- `last_backup` _Optional[str]_ - When the last backup was created.
