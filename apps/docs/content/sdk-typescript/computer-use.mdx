...
- `Promise<void>` - Process error logs
...
- `Promise<void>` - Status information about the specific process
...
- `Promise<void>` - Status information about all VNC desktop processes
...
- `Promise<KeyboardHotkeyResponse>` - Hotkey operation result
...
- `Promise<KeyboardPressResponse>` - Press operation result
...
- `Promise<KeyboardTypeResponse>` - Type operation result
...
scroll(
   ...
   y: number,
   direction: "up" | "down",
amount?: number): Promise<MouseScrollResponse>
```
...
- `Promise<MouseScrollResponse>` - Scroll operation result
