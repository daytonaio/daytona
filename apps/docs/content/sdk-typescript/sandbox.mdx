...
- `created` _string_ - The creation timestamp of the project
  - _Inherited from_: `WorkspaceInfo.created`
...
- `autoArchiveInterval?` _number_ - Auto-archive interval in minutes
  - _Inherited from_: `Workspace.autoArchiveInterval`
- `autoStopInterval?` _number_ - Auto-stop interval in minutes (0 means disabled)
  - _Inherited from_: `Workspace.autoStopInterval`
- `cpu?` _number_ - The CPU quota for the workspace
  - _Inherited from_: `Workspace.cpu`
- `disk?` _number_ - The disk quota for the workspace
  - _Inherited from_: `Workspace.disk`
- `env` _\[key: string\]: string_ - Environment variables for the workspace

  - _Inherited from_: `Workspace.env`

- `errorReason?` _string_ - The error reason of the workspace
  - _Inherited from_: `Workspace.errorReason`
- `gpu?` _number_ - The GPU quota for the workspace
  - _Inherited from_: `Workspace.gpu`
- `id` _string_ - The ID of the workspace
  - _Inherited from_: `Workspace.id`
- `image?` _string_ - The image used for the workspace
  - _Inherited from_: `Workspace.image`
- `info?` _SandboxInfo_
- `labels` _\[key: string\]: string_ - Labels for the workspace

  - _Inherited from_: `Workspace.labels`

- `memory?` _number_ - The memory quota for the workspace
  - _Inherited from_: `Workspace.memory`
