  ...
  return [
    ...
    },
    {
      ...
      entries: [
        ...
        {
          type: 'link',
          href: localizePath('/docs/rate-limits', locale),
          label: labels['sidebarconfig.rateLimits'],
          description: labels['sidebarconfig.rateLimitsDescription'],
          attrs: {
            icon: 'rate.svg',
          },
        },
    ...
    {
      type: 'group',
      label: labels['sidebarconfig.experimental'],
      homePageHref: localizePath('/docs', locale),
      category: NavigationCategory.GENERAL,
      entries: [
        {
          ...
          label: labels['sidebarconfig.otelCollection'],
          disablePagination: true,
          attrs: {
            icon: 'telemetry.svg',
          },
