...
Daytona API keys are used to authenticate requests to the [Daytona API](/docs/tools/api). You can view, create, or delete your API Keys on the [API Keys](https://app.daytona.io/dashboard/keys) page.
...
To use an API key in your application, set the `DAYTONA_API_KEY` environment variable as described on the [Configuration](/docs/configuration) page.
