...
**What we'll build:** A system that analyzes a movies dataset, identifies voting trends over time, and generates professional visualizations - all through natural language prompts to Claude.
...
We'll be using a publicly available dataset of about 10,000 movies. You can download it directly from:
...
prompt = f"""
I have a CSV file about movies. It has about 10k rows. It's saved in the sandbox at /home/daytona/dataset.csv.
...
<Image
  src={chartImage}
  alt="Movie Vote Average Analysis Chart"
  width={600}
