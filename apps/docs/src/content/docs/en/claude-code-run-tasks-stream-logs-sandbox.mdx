...
> **Note:** Streaming logs in Python is only supported when using `AsyncDaytona`.
```python
import os
import asyncio
...
:::tip[Claude Code Sandbox & Terminal]
If you want to learn how to run Claude Code inside a Daytona sandbox and interact with it via terminal, check out our [Claude Coding Agent guide](https://github.com/daytonaio/daytona/tree/main/guides/typescript/claude-coding-agent).
:::
