...
>
  <LinkCard
    title="Computer Use TypeScript SDK"
    link="/docs/en/typescript-sdk/computer-use"
    icon="seti:typescript"
  >
    <p>TypeScript SDK reference for computer use operations.</p>
  </LinkCard>
  <LinkCard
    title="Computer Use Python Sync SDK"
    link="/docs/en/python-sdk/sync/computer-use"
    icon="seti:python"
  >
    <p>Python Sync SDK reference for computer use operations.</p>
  </LinkCard>
  <LinkCard
    title="Computer Use Python Async SDK"
    link="/docs/en/python-sdk/async/async-computer-use"
    icon="seti:python"
  >
    <p>Python Async SDK reference for computer use operations.</p>
  </LinkCard>
  <LinkCard title="Computer Use Ruby SDK" link="/docs/en/ruby-sdk/computer-use" icon="seti:ruby">
    <p>Ruby SDK reference for computer use operations.</p>
  </LinkCard>
  <LinkCard
    title="Computer Use Go SDK"
    link="/docs/en/go-sdk/daytona#ComputerUseService"
    icon="seti:go"
  >
    <p>Go SDK reference for computer use operations.</p>
  </LinkCard>
  <LinkCard title="Computer Use Java SDK" link="/docs/en/java-sdk/computer-use" icon="seti:java">
    <p>Java SDK reference for computer use operations.</p>
  </LinkCard>
  <LinkCard
    title="Computer Use Toolbox API"
    link="/docs/en/tools/api/#daytona-toolbox/tag/computer-use"
    icon="seti:json"
  >
    <p>OpenAPI specification for computer use Toolbox API endpoints.</p>
  </LinkCard>
</CardGrid>
