...
For more information, see the [Python SDK](/docs/en/python-sdk/daytona), [TypeScript SDK](/docs/en/typescript-sdk/daytona), [Ruby SDK](/docs/en/ruby-sdk/daytona), and [Go SDK](/docs/en/go-sdk/daytona) references:
...
>
> [**Config (Go SDK)**](/docs/en/go-sdk/daytona)
