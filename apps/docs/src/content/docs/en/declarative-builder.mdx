...
See: [CreateSandboxFromImageParams (Python SDK)](/docs/python-sdk/sync/daytona#createsandboxfromimageparams), [CreateSandboxFromImageParams (TypeScript SDK)](/docs/typescript-sdk/daytona#createsandboxfromimageparams), [CreateSandboxFromImageParams (Ruby SDK)](/docs/ruby-sdk/daytona#createsandboxfromimageparams)
...
See: [CreateSnapshotParams (Python SDK)](/docs/python-sdk/sync/snapshot#createsnapshotparams), [CreateSnapshotParams (TypeScript SDK)](/docs/typescript-sdk/snapshot#createsnapshotparams), [CreateSnapshotParams (Ruby SDK)](/docs/ruby-sdk/snapshot#createsnapshotparams)
...
See: [base (Python SDK)](/docs/python-sdk/common/image#imagebase), [debian_slim (Python SDK)](/docs/python-sdk/common/image#imagedebian_slim), [base (TypeScript SDK)](/docs/typescript-sdk/image#base), [debianSlim (TypeScript SDK)](/docs/typescript-sdk/image#debianslim), [base (Ruby SDK)](/docs/ruby-sdk/image#base), [debian_slim (Ruby SDK)](/docs/ruby-sdk/image#debian_slim)
...
See: [pip_install (Python SDK)](/docs/python-sdk/common/image#imagepip_install), [pip_install_from_requirements (Python SDK)](/docs/python-sdk/common/image#imagepip_install_from_requirements), [pip_install_from_pyproject (Python SDK)](/docs/python-sdk/common/image#imagepip_install_from_pyproject), [pipInstall (TypeScript SDK)](/docs/typescript-sdk/image#pipinstall), [pipInstallFromRequirements (TypeScript SDK)](/docs/typescript-sdk/image#pipinstallfromrequirements), [pipInstallFromPyproject (TypeScript SDK)](/docs/typescript-sdk/image#pipinstallfrompyproject), [pip_install (Ruby SDK)](/docs/ruby-sdk/image#pip_install), [pip_install_from_requirements (Ruby SDK)](/docs/ruby-sdk/image#pip_install_from_requirements), [pip_install_from_pyproject (Ruby SDK)](/docs/ruby-sdk/image#pip_install_from_pyproject)
...
See: [add_local_file (Python SDK)](/docs/python-sdk/common/image#imageadd_local_file), [add_local_dir (Python SDK)](/docs/python-sdk/common/image#imageadd_local_dir), [addLocalFile (TypeScript SDK)](/docs/typescript-sdk/image#addlocalfile), [addLocalDir (TypeScript SDK)](/docs/typescript-sdk/image#addlocaldir), [add_local_file (Ruby SDK)](/docs/ruby-sdk/image#add_local_file), [add_local_dir (Ruby SDK)](/docs/ruby-sdk/image#add_local_dir)
...
See: [env (Python SDK)](/docs/python-sdk/common/image#imageenv), [workdir (Python SDK)](/docs/python-sdk/common/image#imageworkdir), [env (TypeScript SDK)](/docs/typescript-sdk/image#env), [workdir (TypeScript SDK)](/docs/typescript-sdk/image#workdir), [env (Ruby SDK)](/docs/ruby-sdk/image#env), [workdir (Ruby SDK)](/docs/ruby-sdk/image#workdir)
