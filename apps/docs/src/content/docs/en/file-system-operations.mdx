...
For more information, see the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/), [Ruby SDK](/docs/en/ruby-sdk/), and [API](/docs/en/tools/api/#daytona-toolbox) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/), [Ruby SDK](/docs/en/ruby-sdk/), and [API](/docs/en/tools/api/) references:
...
>
> [**find text infiles (API)**](/docs/en/tools/api#daytona-toolbox/tag/file-system/GET/files/find)
>
