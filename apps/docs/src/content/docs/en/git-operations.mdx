...
>
> [**clone repository (Ruby SDK)**](/docs/en/ruby-sdk/sync/git/#gitclone)
>
...
>
> [**get repository status (Ruby SDK)**](/docs/en/ruby-sdk/sync/git/#gitstatus)
>
...
>
> [**create branch (Ruby SDK)**](/docs/en/ruby-sdk/sync/git/#gitcreate_branch)
>
...
>
> [**checkout branch (Ruby SDK)**](/docs/en/ruby-sdk/sync/git/#gitcheckout_branch)
>
...
>
> [**delete branch (Ruby SDK)**](/docs/en/ruby-sdk/sync/git/#gitdelete_branch)
>
...
>
> [**add (Ruby SDK)**](/docs/en/ruby-sdk/sync/git/#gitadd)
>
...
>
> [**commit (Ruby SDK)**](/docs/en/ruby-sdk/sync/git/#gitcommit)
>
...
>
> [**push (Ruby SDK)**](/docs/en/ruby-sdk/sync/git/#gitpush)
>
...
>
> [**pull (Ruby SDK)**](/docs/en/ruby-sdk/sync/git/#gitpull)
>
