...
This guarantees the sandbox is always torn down — on successful runs, on caught LLM errors, and on infrastructure failures. Confirm in your [Daytona Dashboard](https://app.daytona.io/dashboard); there should be no leftover sandboxes after a run completes.
