...
- `code` _String_ - Python code to execute
- `options` _RunCodeOptions_ - execution options including callbacks and timeout; may be {@code null}
...
- `cwd` _String_ - working directory for the new context; {@code null} uses sandbox default
