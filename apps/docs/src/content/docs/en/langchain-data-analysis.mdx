...
<Tabs>
  <TabItem label="Python" icon="seti:python">
    ```bash
    pip install daytona langchain langchain-anthropic langchain-daytona-data-analysis python-dotenv
    ```
...
:::note
The list of preinstalled packages in a sandbox can be found at [Daytona's Default Snapshot documentation](https://www.daytona.io/docs/en/snapshots/#default-snapshot).
:::
