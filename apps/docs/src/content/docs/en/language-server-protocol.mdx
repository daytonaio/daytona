...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/lsp-server/) and [TypeScript SDK](/docs/en/typescript-sdk/lsp-server/) references:

> [**create_lsp_server (Python SDK)**](/docs/en/python-sdk/sync/lsp-server#lspservercreate_lsp_server)
>
> [**createLspServer (TypeScript SDK)**](/docs/en/typescript-sdk/lsp-server#createlspserver)
>
> [**create_lsp_server (Ruby SDK)**](/docs/en/ruby-sdk/lsp-server#create_lsp_server)
>
> [**createLspServer (Ruby SDK)**](/docs/en/ruby-sdk/lsp-server#createlspserver)
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/), [TypeScript SDK](/docs/en/typescript-sdk/), and [Ruby SDK](/docs/en/ruby-sdk/) references:
...
>
> [**LspLanguageId (Ruby SDK)**](/docs/en/ruby-sdk/daytona#lsplanguageid)
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/) and [TypeScript SDK](/docs/en/typescript-sdk/) references:
