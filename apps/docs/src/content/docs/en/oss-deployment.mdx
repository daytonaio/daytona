...
| `DEFAULT_ORG_QUOTA_ACTIVE_SNAPSHOT_QUOTA`  | number  | `1000`                                               | Default organization active snapshot quota                                                           |
...
| `ADMIN_ACTIVE_SNAPSHOT_QUOTA`              | number  | `100`                                                | Admin active snapshot quota, used only upon initial setup                                            |
