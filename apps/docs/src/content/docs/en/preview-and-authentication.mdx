...
To avoid this warning, you can send the `X-Daytona-Skip-Preview-Warning: true` header, upgrade to [Tier 3](/docs/en/limits) or deploy your own [custom preview proxy](/docs/en/custom-domain-authentication).
:::
