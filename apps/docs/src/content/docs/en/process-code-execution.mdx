...
>
  <LinkCard title="Process TypeScript SDK" link="/docs/en/typescript-sdk/process" icon="seti:typescript">
    <p>TypeScript SDK reference for process operations.</p>
  </LinkCard>
  <LinkCard title="Process Python Sync SDK" link="/docs/en/python-sdk/sync/process" icon="seti:python">
    <p>Python Sync SDK reference for process operations.</p>
  </LinkCard>
  <LinkCard title="Process Python Async SDK" link="/docs/en/python-sdk/async/async-process" icon="seti:python">
    <p>Python Async SDK reference for process operations.</p>
  </LinkCard>
  <LinkCard title="Process Ruby SDK" link="/docs/en/ruby-sdk/process" icon="seti:ruby">
    <p>Ruby SDK reference for process operations.</p>
  </LinkCard>
  <LinkCard
    title="Process Go SDK"
    link="/docs/en/go-sdk/daytona#ProcessService"
    icon="seti:go"
  >
    <p>Go SDK reference for process operations.</p>
  </LinkCard>
  <LinkCard title="Process Java SDK" link="/docs/en/java-sdk/process" icon="seti:java">
    <p>Java SDK reference for process operations.</p>
  </LinkCard>
  <LinkCard
    title="Process Toolbox API"
    link="/docs/en/tools/api/#daytona-toolbox/tag/process"
    icon="seti:json"
  >
    <p>OpenAPI specification for process Toolbox API endpoints.</p>
  </LinkCard>
</CardGrid>
