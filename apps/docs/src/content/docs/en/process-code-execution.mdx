...
Each sandbox has an internal entrypoint session created to run the configured entrypoint command. You can retrieve the entrypoint session details and read its logs.
