...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processcreate_pty_session), [TypeScript SDK](/docs/en/typescript-sdk/process/#createpty), [Ruby SDK](/docs/en/ruby-sdk/process/#create_pty_session), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api#daytona-toolbox/tag/process) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processconnect_pty_session), [TypeScript SDK](/docs/en/typescript-sdk/process/#connectpty), [Ruby SDK](/docs/en/ruby-sdk/process/#connect_pty_session), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api#daytona-toolbox/tag/process) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processlist_pty_sessions), [TypeScript SDK](/docs/en/typescript-sdk/process/#listptysessions), [Ruby SDK](/docs/en/ruby-sdk/process/#list_pty_sessions), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api#daytona-toolbox/tag/process) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processget_pty_session_info), [TypeScript SDK](/docs/en/typescript-sdk/process/#getptysessioninfo), [Ruby SDK](/docs/en/ruby-sdk/process/#get_pty_session_info), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api#daytona-toolbox/tag/process) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processkill_pty_session), [TypeScript SDK](/docs/en/typescript-sdk/process/#killptysession), [Ruby SDK](/docs/en/ruby-sdk/process/#delete_pty_session), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api#daytona-toolbox/tag/process) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processresize_pty_session), [TypeScript SDK](/docs/en/typescript-sdk/process/#resizeptysession), [Ruby SDK](/docs/en/ruby-sdk/process/#resize_pty_session), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api#daytona-toolbox/tag/process) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/), [Ruby SDK](/docs/en/ruby-sdk/), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api#daytona-toolbox/tag/process) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/), [Ruby SDK](/docs/en/ruby-sdk/), [Go SDK](/docs/en/go-sdk/)references:
