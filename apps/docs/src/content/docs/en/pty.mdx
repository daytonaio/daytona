...
>
  <LinkCard
    title="PTY TypeScript SDK"
    link="/docs/en/typescript-sdk/pty"
    icon="seti:typescript"
  >
    <p>TypeScript SDK reference for PTY operations.</p>
  </LinkCard>
  <LinkCard
    title="PTY Python Sync SDK"
    link="/docs/en/python-sdk/sync/process"
    icon="seti:python"
  >
    <p>Python Sync SDK reference for PTY operations.</p>
  </LinkCard>
  <LinkCard
    title="PTY Python Async SDK"
    link="/docs/en/python-sdk/async/async-process"
    icon="seti:python"
  >
    <p>Python Async SDK reference for PTY operations.</p>
  </LinkCard>
  <LinkCard title="PTY Ruby SDK" link="/docs/en/ruby-sdk/process" icon="seti:ruby">
    <p>Ruby SDK reference for PTY operations.</p>
  </LinkCard>
  <LinkCard
    title="PTY Go SDK"
    ...
    icon="seti:go"
  >
    <p>Go SDK reference for PTY operations.</p>
  </LinkCard>
  <LinkCard title="PTY Java SDK" link="/docs/en/java-sdk/pty" icon="seti:java">
    <p>Java SDK reference for PTY operations.</p>
  </LinkCard>
  <LinkCard
    title="PTY Toolbox API"
    link="/docs/en/tools/api/#daytona-toolbox/tag/process"
    icon="seti:json"
  >
    <p>OpenAPI specification for PTY Toolbox API endpoints.</p>
  </LinkCard>
</CardGrid>
