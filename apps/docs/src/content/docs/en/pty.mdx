...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processcreate_pty_session), [TypeScript SDK](/docs/en/typescript-sdk/process/#createpty), and [Ruby SDK](/docs/en/ruby-sdk/process/#create_pty_session) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processconnect_pty_session), [TypeScript SDK](/docs/en/typescript-sdk/process/#connectpty), and [Ruby SDK](/docs/en/ruby-sdk/process/#connect_pty_session) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processlist_pty_sessions), [TypeScript SDK](/docs/en/typescript-sdk/process/#listptysessions), and [Ruby SDK](/docs/en/ruby-sdk/process/#list_pty_sessions) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processget_pty_session_info), [TypeScript SDK](/docs/en/typescript-sdk/process/#getptysessioninfo), and [Ruby SDK](/docs/en/ruby-sdk/process/#get_pty_session_info) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processkill_pty_session), [TypeScript SDK](/docs/en/typescript-sdk/process/#killptysession), and [Ruby SDK](/docs/en/ruby-sdk/process/#delete_pty_session) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/process/#processresize_pty_session), [TypeScript SDK](/docs/en/typescript-sdk/process/#resizeptysession), and [Ruby SDK](/docs/en/ruby-sdk/process/#resize_pty_session) references:
