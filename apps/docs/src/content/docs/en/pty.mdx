...
pty_size=PtySize(cols=200, rows=100)
)

# Send interactive command

pty_handle.send_input('read -p "Are you accepting the terms and conditions? (y/n): " name && echo "Hello, $name!"\n')
time.sleep(1)
...
// Send interactive command
await ptyHandle.sendInput('read -p "Are you accepting the terms and conditions? (y/n): " confirm && if [ "$confirm" = "y" ]; then echo "You accepted the terms and conditions"; else echo "You did not accept the terms and conditions"; fi\n')
