...
:::note
Uninstalling the chart does not automatically deregister the region from the Daytona API. You may need to manually remove the region through the Daytona dashboard or API.
:::
