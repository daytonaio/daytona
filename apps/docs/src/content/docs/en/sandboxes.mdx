...
For more information, see the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/), [Ruby SDK](/docs/en/ruby-sdk/), [API](/docs/en/tools/api/#daytona/), and [CLI](/docs/en/tools/cli/) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/daytona#resources), [Ruby SDK](/docs/en/ruby-sdk/), [CLI](/docs/en/tools/cli/), and [API](/docs/en/tools/api/) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/), [Ruby SDK](/docs/en/ruby-sdk/), [CLI](/docs/en/tools/cli/), and [API](/docs/en/tools/api/#daytona) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#sandboxrecover), [TypeScript SDK](/docs/en/typescript-sdk/sandbox#recover), [Ruby SDK](/docs/en/ruby-sdk/sandbox#recover), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/recover) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#sandboxdelete), [TypeScript SDK](/docs/en/typescript-sdk/sandbox#delete), [Ruby SDK](/docs/en/ruby-sdk/sandbox#delete), [CLI](/docs/en/tools/cli/#daytona-delete), and [API](/docs/en/tools/api/#daytona/tag/sandbox/DELETE/sandbox/{sandboxIdOrName}) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#sandboxset_auto_archive_interval), [TypeScript SDK](/docs/en/typescript-sdk/sandbox#setautoarchiveinterval), [Ruby SDK](/docs/en/ruby-sdk/sandbox#auto_archive_interval), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/autoarchive/{interval}) references:
