...
The sandbox details page header a summary of the sandbox and actions to perform on the sandbox:
...
- [**Labels**](#labels): key-value pairs assigned to the sandbox
- [**Timestamps**](#timestamps): when the sandbox was created and when the last event occurred
