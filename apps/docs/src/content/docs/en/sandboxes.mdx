...
func main() {
	...
	// Create an ephemeral sandbox
	autoStopInterval := int32(5)
	params := types.SnapshotParams{
		SandboxBaseParams: types.SandboxBaseParams{
			Language: types.CodeLanguagePython,
			Ephemeral: types.Ptr(true),
	...
	log.Printf("Created ephemeral sandbox: %s\n", sandbox.ID)
}
```
...
func main() {
	...
	// The sandbox ID can later be used to find the sandbox and start it
	sandbox, err = client.Find(ctx, sandbox.ID)
	if err != nil {
		log.Fatal(err)
	}
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#sandboxarchive), [TypeScript SDK](/docs/en/typescript-sdk/sandbox#archive), [Ruby SDK](/docs/en/ruby-sdk/sandbox#archive), [Go SDK](/docs/en/go-sdk/), [CLI](/docs/en/tools/cli/#daytona-archive), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/archive) references:
...
func main() {
	...
	// Recover sandbox
	err = sandbox.Recover(ctx)
	if err != nil {
		log.Fatal(err)
	}

	log.Printf("Recovered sandbox: %s\n", sandbox.ID)
}
```
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#sandboxrecover), [TypeScript SDK](/docs/en/typescript-sdk/sandbox#recover), [Ruby SDK](/docs/en/ruby-sdk/sandbox#recover), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/recover) references:
...
func main() {
	...
	// Check if the Sandbox is recoverable
	if sandbox.Recoverable != nil && *sandbox.Recoverable {
		err = sandbox.Recover(ctx)
		if err != nil {
			log.Fatal(err)
		}
		log.Println("Sandbox recovered successfully")
	}
}
```
...
func main() {
	...
	log.Println("Sandbox deleted successfully")
}
```
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#sandboxdelete), [TypeScript SDK](/docs/en/typescript-sdk/sandbox#delete), [Ruby SDK](/docs/en/ruby-sdk/sandbox#delete), [Go SDK](/docs/en/go-sdk/), [CLI](/docs/en/tools/cli/#daytona-delete), and [API](/docs/en/tools/api/#daytona/tag/sandbox/DELETE/sandbox/{sandboxIdOrName}) references:
...
func main() {
	...
	autoStopInterval := int32(0)
	params := types.SnapshotParams{
		Snapshot: types.Ptr("my-snapshot-name"),
		SandboxBaseParams: types.SandboxBaseParams{
			AutoStopInterval: &autoStopInterval,
		},
	}
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#sandboxset_autostop_interval), [TypeScript SDK](/docs/en/typescript-sdk/sandbox#setautostopinterval), [Ruby SDK](/docs/en/ruby-sdk/sandbox#auto_stop_interval), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/autostop/1) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#sandboxset_auto_archive_interval), [TypeScript SDK](/docs/en/typescript-sdk/sandbox#setautoarchiveinterval), [Ruby SDK](/docs/en/ruby-sdk/sandbox#auto_archive_interval), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/autoarchive/{interval}) references:
...
func main() {
	...
	// Delete the sandbox immediately after it has been stopped
	err = sandbox.SetAutoDeleteInterval(ctx, 0)
	if err != nil {
		log.Fatal(err)
	}

	// Disable auto-deletion
	err = sandbox.SetAutoDeleteInterval(ctx, -1)
	if err != nil {
		log.Fatal(err)
	}
}
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#sandboxset_auto_delete_interval), [TypeScript SDK](/docs/en/typescript-sdk/sandbox#setautodeleteinterval), [Ruby SDK](/docs/en/ruby-sdk/sandbox#auto_delete_interval), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/autodelete/{interval}) references:
...
func main() {
	...
	autoStopInterval := int32(0)
	params := types.SnapshotParams{
		Snapshot: types.Ptr("my_awesome_snapshot"),
		SandboxBaseParams: types.SandboxBaseParams{
			AutoStopInterval: &autoStopInterval,
		},
	}
