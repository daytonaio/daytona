...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/daytona#daytonacreate), [TypeScript SDK](/docs/en/typescript-sdk/daytona#create), and [Ruby SDK](/docs/en/ruby-sdk/daytona#create), [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox), and [CLI](/docs/en/tools/cli/#daytona-create) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/sandbox#resources), [TypeScript SDK](/docs/en/typescript-sdk/daytona#resources), and [Ruby SDK](/docs/en/ruby-sdk/daytona#resources) references:
...
>
> [**Resources (Ruby SDK)**](/docs/en/ruby-sdk/sandbox#resources)
...
Daytona provides options to start sandboxes in [Daytona Dashboard ↗](https://app.daytona.io/dashboard/) or programmatically using the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/), [Ruby SDK](/docs/en/ruby-sdk/), [CLI](/docs/en/tools/cli/#daytona-start), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/start) references.
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxstart), [TypeScript SDK](/docs/typescript-sdk/sandbox#start), [Ruby SDK](/docs/ruby-sdk/sandbox#start), [CLI](/docs/en/tools/cli/#daytona-start), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/start) references:
...
>
>
> [**stop (Ruby SDK)**](/docs/ruby-sdk/sandbox#stop)
>
> [**find_one (Ruby SDK)**](/docs/ruby-sdk/sandbox#find_one)
>
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxarchive), [TypeScript SDK](/docs/typescript-sdk/sandbox#archive), [Ruby SDK](/docs/ruby-sdk/sandbox#archive), [CLI](/docs/en/tools/cli/#daytona-archive), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/archive) references:
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxrecover), [TypeScript SDK](/docs/typescript-sdk/sandbox#recover), [Ruby SDK](/docs/ruby-sdk/sandbox#recover), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/recover) references:
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxdelete), [TypeScript SDK](/docs/typescript-sdk/sandbox#delete), [Ruby SDK](/docs/ruby-sdk/sandbox#delete), [CLI](/docs/en/tools/cli/#daytona-delete), and [API](/docs/en/tools/api/#daytona/tag/sandbox/DELETE/sandbox/{sandboxIdOrName}) references:
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxset_autostop_interval), [TypeScript SDK](/docs/typescript-sdk/sandbox#set_auto_stop_interval), [Ruby SDK](/docs/ruby-sdk/sandbox#set_auto_stop_interval), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/autostop/1) references:
...
For more information, see the [Python SDK](/docs/python-sdk/sync/sandbox#sandboxset_auto_archive_interval), [TypeScript SDK](/docs/typescript-sdk/sandbox#set_auto_archive_interval), [Ruby SDK](/docs/ruby-sdk/sandbox#set_auto_archive_interval), and [API](/docs/en/tools/api/#daytona/tag/sandbox/POST/sandbox/{sandboxIdOrName}/autoarchive/{interval}) references:
