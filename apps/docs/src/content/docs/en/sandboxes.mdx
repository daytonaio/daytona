...
Daytona provides methods to get a sandbox by its ID or name using the [Python SDK](/docs/en/python-sdk/), [TypeScript SDK](/docs/en/typescript-sdk/), [Ruby SDK](/docs/en/ruby-sdk/), [Go SDK](/docs/en/go-sdk/daytona/), [CLI](/docs/en/tools/cli/), and [API](/docs/en/tools/api/#daytona) references.
...
sandbox = daytona.get("my-awesome-sandbox")
print(sandbox.state)
```
...
```typescript
// Get a sandbox by ID or name
const sandbox = await daytona.get("my-awesome-sandbox");
...
> [**get (Python SDK)**](/docs/en/python-sdk/sync/daytona#daytonaget)
>
> [**get (TypeScript SDK)**](/docs/en/typescript-sdk/daytona#get)
>
> [**get (Ruby SDK)**](/docs/en/ruby-sdk/daytona#get)
>
> [**Get (Go SDK)**](/docs/en/go-sdk/daytona/#Client.Get)
>
> [**info (CLI)**](/docs/en/tools/cli/#daytona-info)
>
> [**get (API)**](/docs/en/tools/api/#daytona/tag/sandbox/GET/sandbox/{sandboxIdOrName})
