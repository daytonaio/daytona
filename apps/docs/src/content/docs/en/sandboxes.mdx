...
- Explicit sandbox activity refresh calls (for example, `sandbox.refreshActivity()` in the TypeScript SDK)

#### What does not reset the timer

The following do not reset the timer:

- Most SDK calls that do not update sandbox activity
