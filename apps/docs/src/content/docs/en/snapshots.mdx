...
Daytona also supports running [Docker](#run-docker-in-a-sandbox) and [Kubernetes](#run-kubernetes-in-a-sandbox) workloads inside sandboxes using snapshots.

## Create Snapshots

Daytona provides methods to create snapshots from [public images](#using-public-images), [private images](#using-images-from-private-registries), [local images](#using-local-images), and the [declarative builder](#using-the-declarative-builder). You can create snapshots using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/snapshots), or programmatically using the Daytona [SDK](/docs/en/getting-started#sdks), [CLI](/docs/en/tools/cli#daytona-snapshot), or [API](/docs/en/tools/api#daytona/tag/snapshots).
...
<TabItem label="CLI" icon="seti:terminal">

```bash
daytona snapshot create my-snapshot --image python:3.11-slim --resources 2 4096
```
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/snapshot), [TypeScript SDK](/docs/en/typescript-sdk/snapshot), [Ruby SDK](/docs/en/ruby-sdk/snapshot), [Go SDK](/docs/en/go-sdk/), [CLI](/docs/en/tools/cli), and [API](/docs/en/tools/api/#daytona/tag/snapshots) references:
...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/snapshot), [TypeScript SDK](/docs/en/typescript-sdk/snapshot), [Ruby SDK](/docs/en/ruby-sdk/snapshot), [Go SDK](/docs/en/go-sdk/), [CLI](/docs/en/tools/cli#daytona-snapshot), and [API](/docs/en/tools/api/#daytona/tag/snapshots) references.
...
2. Run **`daytona snapshot push <your_local_docker_image>`** to create a snapshot and push it to Daytona:
...
``` 
The above command creates Alpine sandboxes with 2 vCPU, 4GiB of memory and 8GiB of disk space.
:::
...
[Declarative Builder](/docs/declarative-builder) provides a powerful, code-first approach to defining dependencies for Daytona Sandboxes. Instead of importing images from a container registry, you can programmatically define them using the Daytona [SDKs](/docs/en/getting-started#sdks).
...
For more information, see the [Python SDK](/docs/python-sdk/sync/snapshot#snapshotget), [TypeScript SDK](/docs/typescript-sdk/snapshot#get), and [Ruby SDK](/docs/ruby-sdk/snapshot#get) references:
...
For more information, see the [Python SDK](/docs/python-sdk/sync/snapshot), [TypeScript SDK](/docs/typescript-sdk/snapshot), and [Ruby SDK](/docs/ruby-sdk/snapshot), [Go SDK](/docs/go-sdk/), [CLI](/docs/tools/cli#daytona-snapshot), and [API](/docs/tools/api/#daytona/tag/snapshots) references.
...
>
> [**list (CLI)**](/docs/en/tools/cli#daytona-snapshot)
>
...
For more information, see the [Python SDK](/docs/python-sdk/sync/snapshot#snapshotactivate), [TypeScript SDK](/docs/typescript-sdk/snapshot#activate), and [Ruby SDK](/docs/ruby-sdk/snapshot#activate) references:
...
> [**delete (Python SDK)**](/docs/python-sdk/sync/snapshot#snapshotdelete)
>
> [**delete (TypeScript SDK)**](/docs/typescript-sdk/snapshot#delete)
>
> [**delete (Ruby SDK)**](/docs/ruby-sdk/snapshot#delete)
