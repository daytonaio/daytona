...
For more information, see the [Python SDK](/docs/en/python-sdk/sync/snapshot#create), [TypeScript SDK](/docs/en/typescript-sdk/snapshot#create), [Ruby SDK](/docs/en/ruby-sdk/snapshot#create), [Go SDK](/docs/en/go-sdk/), and [API](/docs/en/tools/api/#daytona/tag/snapshots/POST/snapshots) references:
...
For more information, see the [Python SDK](/docs/python-sdk/sync/snapshot#snapshotlist), [TypeScript SDK](/docs/typescript-sdk/snapshot#list), and [Ruby SDK](/docs/ruby-sdk/snapshot#list) references:
