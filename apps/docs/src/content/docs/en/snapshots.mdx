...
- **Resources** (optional): The resources you want the underlying Sandboxes to have. By default, Daytona Sandboxes use **2 vCPU**, **4GiB memory**, and **8GiB storage**.
...
For more information, see the [Python SDK](/docs/python-sdk/sync/snapshot#create), [TypeScript SDK](/docs/typescript-sdk/snapshot#create), and [Ruby SDK](/docs/ruby-sdk/snapshot#create) references:
...
Snapshots can be customized with specific resource requirements. By default, Daytona Sandboxes use **2 vCPU**, **4GB RAM**, and **8GiB disk**. For more information, see [sandbox resources](/docs/en/sandboxes#resources).
