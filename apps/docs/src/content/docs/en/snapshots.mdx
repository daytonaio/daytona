...
```bash
daytona snapshot create my-snapshot --image python:3.11-slim --cpu 2 --memory 4
```
...
```bash
daytona snapshot create my-snapshot --image python:3.11-slim
```
...
```bash
daytona snapshot create my-snapshot --image python:3.11-slim --cpu 2 --memory 4 --disk 8
```
...
```bash
daytona snapshot create my-snapshot --image python:3.11-slim --region us
```
