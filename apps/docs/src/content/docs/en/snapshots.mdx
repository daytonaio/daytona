...
await daytona.snapshot.create(
  { name: 'my-awesome-snapshot', image: image },
  { onLogs: console.log }
)
```
...
>
  <LinkCard
    title="Snapshot TypeScript SDK"
    link="/docs/en/typescript-sdk/snapshot"
    icon="seti:typescript"
  >
    <p>TypeScript SDK reference for snapshot operations.</p>
  </LinkCard>
  <LinkCard
    title="Snapshot Python Sync SDK"
    link="/docs/en/python-sdk/sync/snapshot"
    icon="seti:python"
  >
    <p>Python Sync SDK reference for snapshot operations.</p>
  </LinkCard>
  <LinkCard
    title="Snapshot Python Async SDK"
    link="/docs/en/python-sdk/async/async-snapshot"
    icon="seti:python"
  >
    <p>Python Async SDK reference for snapshot operations.</p>
  </LinkCard>
  <LinkCard title="Snapshot Ruby SDK" link="/docs/en/ruby-sdk/snapshot" icon="seti:ruby">
    <p>Ruby SDK reference for snapshot operations.</p>
  </LinkCard>
  <LinkCard
    title="Snapshot Go SDK"
    link="/docs/en/go-sdk/daytona#SnapshotService"
    icon="seti:go"
  >
    <p>Go SDK reference for snapshot operations.</p>
  </LinkCard>
  <LinkCard title="Snapshot Java SDK" link="/docs/en/java-sdk/snapshot" icon="seti:java">
    <p>Java SDK reference for snapshot operations.</p>
  </LinkCard>
  <LinkCard
    title="Snapshot API"
    link="/docs/en/tools/api/#daytona/tag/snapshots"
    icon="seti:json"
  >
    <p>OpenAPI specification for snapshot API endpoints.</p>
  </LinkCard>
  <LinkCard title="Snapshot CLI" link="/docs/en/tools/cli#daytona-snapshot" icon="seti:shell">
    <p>CLI reference for snapshot operations.</p>
  </LinkCard>
</CardGrid>
