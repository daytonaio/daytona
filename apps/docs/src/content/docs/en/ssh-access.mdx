...
>
  ...
  >
    <p>TypeScript SDK reference for SSH access operations.</p>
  </LinkCard>
  <LinkCard
    ...
    icon="seti:python"
  >
    <p>Python Sync SDK reference for SSH access operations.</p>
  </LinkCard>
  <LinkCard
    ...
    icon="seti:python"
  >
    <p>Python Async SDK reference for SSH access operations.</p>
  </LinkCard>
  <LinkCard title="Sandbox Ruby SDK" link="/docs/en/ruby-sdk/sandbox" icon="seti:ruby">
    <p>Ruby SDK reference for SSH access operations.</p>
  </LinkCard>
  ...
  <LinkCard title="SSH CLI" link="/docs/en/tools/cli#daytona-ssh" icon="seti:shell">
    <p>CLI reference for SSH operations.</p>
  </LinkCard>
</CardGrid>
