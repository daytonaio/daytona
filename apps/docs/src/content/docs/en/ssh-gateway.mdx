...
And that's it! VSCode will automatically install everything it needs to run inside the sandbox and you can use it just as you would locally.
...
And that's it! The JetBrains Gateway will automatically install everything it needs to run inside the sandbox and you can use it just as you would locally.
