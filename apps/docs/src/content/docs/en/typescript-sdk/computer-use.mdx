...
```ts
new ComputerUse(sandboxId: string, apiClient: ComputerUseApi): ComputerUse
```
...
```ts
new Display(sandboxId: string, apiClient: ComputerUseApi): Display
```
...
```ts
new Keyboard(sandboxId: string, apiClient: ComputerUseApi): Keyboard
```
...
```ts
new Mouse(sandboxId: string, apiClient: ComputerUseApi): Mouse
```
...
```ts
new Screenshot(sandboxId: string, apiClient: ComputerUseApi): Screenshot
```
