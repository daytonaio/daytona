...
- `~~items~~` _Sandbox\[\]_
- `~~page~~` _number_
    - _Inherited from_: `DeprecatedPaginatedSandboxes.page`
- `~~total~~` _number_
    - _Inherited from_: `DeprecatedPaginatedSandboxes.total`
- `~~totalPages~~` _number_
    - _Inherited from_: `DeprecatedPaginatedSandboxes.totalPages`




Use PaginatedSandboxesV2 instead. Will be removed on April 1, 2026.

**Extends:**

- `Omit`\<`DeprecatedPaginatedSandboxes`, `"items"`\>
...
- `items` _Sandbox\[\]_ - List of Sandboxes for the current page.
- `nextCursor` _string_ - Cursor for the next page of results. Null if there are no more results.
## SandboxCodeToolbox
