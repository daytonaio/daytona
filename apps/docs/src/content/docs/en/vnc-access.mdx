...
VNC is the visual interface for users, while [Computer Use](/docs/en/computer-use) is the programmatic API for agents. Through VNC, you can manually interact with the desktop and observe AI agents performing automated tasks via Computer Use in real-time.
