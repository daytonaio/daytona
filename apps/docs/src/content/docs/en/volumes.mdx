...
> [**volume.create (Python SDK)**](/docs/en/python-sdk/sync/volume#volumeservicecreate)
>
> [**volume.create (TypeScript SDK)**](/docs/en/typescript-sdk/volume#create)
>
> [**volume.create (Ruby SDK)**](/docs/en/ruby-sdk/volume#create)
