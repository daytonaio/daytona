...
:::note
For connecting to a VPN network, you need to [create or access your Daytona Sandbox](/docs/en/sandboxes) and **have access to your VPN network provider credentials**.
:::
