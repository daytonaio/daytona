...
以下の機能を提供します。完全なAPIリファレンスとメソッドシグネチャについては、[Python](/docs/en/python-sdk/common/image)および[TypeScript](/docs/en/typescript-sdk/image) SDKリファレンスをご確認ください。
...
詳細なメソッドシグネチャと使用例については、[Python](/docs/en/python-sdk/common/image)および[TypeScript](/docs/en/typescript-sdk/image) SDKリファレンスを参照してください。
