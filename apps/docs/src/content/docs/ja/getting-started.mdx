...
このエンドポイントにプログラムでアクセスする必要がありますか？[Preview & Authentication](/docs/en/preview-and-authentication)について詳しく学んでください。

:::tip
Sandbox [Web Terminal](/docs/en/web-terminal)には、ポート`22222`のプレビューURLを出力するか、単にDashboard -> Sandboxesに移動してTerminal入力サインをクリックすることでアクセスできます。
:::
