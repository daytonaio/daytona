...
参照: [get&#95;session&#95;command&#95;logs&#95;async (Python SDK)](/docs/python-sdk/sync/process/#processget_session_command_logs_async)、[getSessionCommandLogs (TypeScript SDK)](/docs/typescript-sdk/process/#getsessioncommandlogs)