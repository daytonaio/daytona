...
Daytona のサンドボックスから送信されるトラフィックは、次の IP アドレスからのものとして扱われます。
...
:::caution[重要な更新]
送信元 IP アドレス一覧は、インフラストラクチャの更新に伴い、現在変更される場合があります。厳格なファイアウォールを構成している場合は、このページを適宜確認するか、最新の一覧について [support@daytona.io](mailto:support@daytona.io) までお問い合わせください。
:::
