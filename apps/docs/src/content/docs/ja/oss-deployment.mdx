...
| `DB_TLS_ENABLED`                           | boolean | `false`                                              | データベース接続のTLS有効化          |
| `DB_TLS_REJECT_UNAUTHORIZED`               | boolean | `true`                                               | 未承認TLS証明書の拒否        |
...
| `OIDC_MANAGEMENT_API_ENABLED`              | boolean | (empty)                                              | OIDC管理API有効化                  |
...
| `OTEL_ENABLED`                             | boolean | `true`                                               | OpenTelemetryトレース有効化                |
| `OTEL_COLLECTOR_URL`                       | string  | `http://jaeger:4318/v1/traces`                       | OpenTelemetryコレクターURL                 |
| `MAINTENANCE_MODE`                         | boolean | `false`                                              | メンテナンスモード有効化                     |
...
| `RUN_MIGRATIONS`                           | boolean | `true`                                               | 起動時にデータベースマイグレーションを有効化       |
