...
| `DB_PORT`                                  | 数値      | `5432`                                               | PostgreSQL データベース ポート                                         |
| `DB_USERNAME`                              | 文字列     | `user`                                               | PostgreSQL データベースのユーザー名                                       |
| `DB_PASSWORD`                              | 文字列     | `pass`                                               | PostgreSQL データベース パスワード                                       |
| `DB_DATABASE`                              | 文字列     | `daytona`                                            | PostgreSQL データベース名                                            |
| `DB_TLS_ENABLED`                           | boolean | `false`                                              | データベース接続の TLS を有効にする                                          |
| `DB_TLS_REJECT_UNAUTHORIZED`               | ブール値    | `true`                                               | 信頼されていない TLS 証明書を拒否する                                         |
| `REDIS_HOST`                               | 文字列     | `redis`                                              | Redis サーバーホスト名                                                |
| `REDIS_PORT`                               | 数値      | `6379`                                               | Redis サーバーのポート                                                |
| `OIDC_CLIENT_ID`                           | 文字列     | `daytona`                                            | OIDC クライアント ID                                                |
| `OIDC_ISSUER_BASE_URL`                     | 文字列     | `http://dex:5556/dex`                                | OIDC Issuer ベース URL                                           |
| `PUBLIC_OIDC_DOMAIN`                       | string  | `http://localhost:5556/dex`                          | 公開 OIDC ドメイン                                                  |
| `OIDC_AUDIENCE`                            | 文字列     | `daytona`                                            | OIDC オーディエンス ID                                               |
| `OIDC_MANAGEMENT_API_ENABLED`              | boolean | （空）                                                  | OIDC 管理 API を有効化する                                            |
| `OIDC_MANAGEMENT_API_CLIENT_ID`            | 文字列     | (empty)                                              | OIDC 管理 API クライアント ID                                         |
| `OIDC_MANAGEMENT_API_CLIENT_SECRET`        | 文字列     | （空）                                                  | OIDC 管理 API のクライアントシークレット                                     |
| `OIDC_MANAGEMENT_API_AUDIENCE`             | 文字列     | (empty)                                              | OIDC 管理 API 用 audience                                        |
| `DEFAULT_SNAPSHOT`                         | string  | `daytonaio/sandbox:0.4.3`                            | サンドボックスのデフォルトスナップショットイメージ                                     |
| `DASHBOARD_URL`                            | 文字列     | `http://localhost:3000/dashboard`                    | ダッシュボード URL                                                   |
| `DASHBOARD_BASE_API_URL`                   | 文字列     | `http://localhost:3000`                              | ダッシュボード用のベース API URL                                          |
| `POSTHOG_API_KEY`                          | 文字列     | `phc_bYtEsdMDrNLydXPD4tufkBrHKgfO2zbycM30LOowYNv`    | 分析用の PostHog API キー                                           |
| `POSTHOG_HOST`                             | string  | `https://d18ag4dodbta3l.cloudfront.net`              | PostHog のホスト URL                                              |
| `POSTHOG_ENVIRONMENT`                      | string  | `local`                                              | PostHog 環境識別子                                                 |
| `TRANSIENT_REGISTRY_URL`                   | string  | `http://registry:6000`                               | 一時的なレジストリ URL                                                 |
| `TRANSIENT_REGISTRY_ADMIN`                 | 文字列     | `admin`                                              | 一時レジストリ管理者のユーザー名                                              |
| `TRANSIENT_REGISTRY_PASSWORD`              | string  | `password`                                           | レジストリ管理者用一時パスワード                                              |
| `TRANSIENT_REGISTRY_PROJECT_ID`            | 文字列     | `daytona`                                            | 一時レジストリ用プロジェクト ID                                             |
| `INTERNAL_REGISTRY_URL`                    | 文字列     | `http://registry:6000`                               | 内部レジストリ URL                                                   |
| `INTERNAL_REGISTRY_ADMIN`                  | 文字列     | `admin`                                              | 内部レジストリ管理者ユーザー名                                               |
| `INTERNAL_REGISTRY_PASSWORD`               | string  | `password`                                           | 内部レジストリの管理者パスワード                                              |
...
| `SMTP_PASSWORD`                            | 文字列     | (空)                                                  | SMTP パスワード                                                    |
| `SMTP_SECURE`                              | boolean | (空)                                                  | SMTP の暗号化接続を有効にする                                             |
| `SMTP_EMAIL_FROM`                          | 文字列     | `"Daytona チーム <no-reply@daytona.io>"`                | SMTP 送信者メールアドレス                                               |
| `S3_ENDPOINT`                              | string  | `http://minio:9000`                                  | S3互換ストレージのエンドポイント                                             |
| `S3_STS_ENDPOINT`                          | string  | `http://minio:9000/minio/v1/assume-role`             | S3 STS エンドポイント                                                |
...
| `S3_ACCOUNT_ID`                            | 文字列     | `/`                                                  | S3 アカウントID                                                    |
| `S3_ROLE_NAME`                             | string  | `/`                                                  | S3 ロール名                                                       |
| `ENVIRONMENT`                              | 文字列     | `dev`                                                | アプリケーション環境                                                    |
| `MAX_AUTO_ARCHIVE_INTERVAL`                | 数値      | `43200`                                              | 自動アーカイブの最大実行間隔（秒）                                             |
| `OTEL_ENABLED`                             | ブール値    | `true`                                               | OpenTelemetry トレーシングを有効にする                                    |
...
| `PROXY_API_KEY`                            | 文字列     | `super_secret_key`                                   | プロキシ API キー                                                   |
| `PROXY_TEMPLATE_URL`                       | 文字列     | `http://{{PORT}}-{{sandboxId}}.proxy.localhost:4000` | プロキシテンプレートのURLパターン                                            |
| `PROXY_TOOLBOX_BASE_URL`                   | 文字列     | `{PROXY_PROTOCOL}://{PROXY_DOMAIN}`                  | ツールボックスリクエスト用プロキシのベースURL                                      |
| `DEFAULT_RUNNER_DOMAIN`                    | 文字列     | `runner:3003`                                        | デフォルトランナーのドメイン                                                |
| `DEFAULT_RUNNER_API_URL`                   | string  | `http://runner:3003`                                 | デフォルトのランナー API URL                                            |
| `DEFAULT_RUNNER_PROXY_URL`                 | 文字列     | `http://runner:3003`                                 | ランナー プロキシのデフォルト URL                                           |
| `DEFAULT_RUNNER_API_KEY`                   | string  | `secret_api_token`                                   | デフォルトのランナー API キー                                             |
| `DEFAULT_RUNNER_CPU`                       | 数値      | `4`                                                  | ランナーのデフォルト CPU 割り当て                                           |
| `DEFAULT_RUNNER_MEMORY`                    | 数値      | `8`                                                  | デフォルトのランナーのメモリ割り当て (GB)                                       |
| `DEFAULT_RUNNER_DISK`                      | 数値      | `50`                                                 | ランナーのデフォルトディスク割り当て (GB)                                       |
| `DEFAULT_RUNNER_GPU`                       | 数値      | `0`                                                  | ランナーのデフォルト GPU 割り当て                                           |
| `DEFAULT_RUNNER_GPU_TYPE`                  | 文字列     | `none`                                               | デフォルトのランナー GPU 種別                                             |
| `DEFAULT_RUNNER_CAPACITY`                  | 数値      | `100`                                                | デフォルトのランナー容量                                                  |
| `DEFAULT_RUNNER_CLASS`                     | string  | `small`                                              | デフォルトのランナークラス                                                 |
| `DEFAULT_ORG_QUOTA_TOTAL_CPU_QUOTA`        | 数値      | `10000`                                              | 組織のデフォルトの合計 CPU クォータ                                          |
| `DEFAULT_ORG_QUOTA_TOTAL_MEMORY_QUOTA`     | 数値      | `10000`                                              | 組織のデフォルトの総メモリクォータ                                             |
| `DEFAULT_ORG_QUOTA_TOTAL_DISK_QUOTA`       | 数値      | `100000`                                             | デフォルト組織の合計ディスククォータ                                            |
| `DEFAULT_ORG_QUOTA_MAX_CPU_PER_SANDBOX`    | 数値      | `100`                                                | 組織のサンドボックスごとのデフォルト最大CPU                                       |
| `DEFAULT_ORG_QUOTA_MAX_MEMORY_PER_SANDBOX` | 数値      | `100`                                                | 組織のサンドボックスごとのデフォルト最大メモリ                                       |
| `DEFAULT_ORG_QUOTA_MAX_DISK_PER_SANDBOX`   | 数値      | `1000`                                               | 組織のサンドボックスあたりのデフォルト最大ディスク容量                                   |
| `DEFAULT_ORG_QUOTA_SNAPSHOT_QUOTA`         | 数値      | `1000`                                               | 組織のデフォルトスナップショットクォータ                                          |
| `DEFAULT_ORG_QUOTA_MAX_SNAPSHOT_SIZE`      | 数値      | `1000`                                               | 組織のスナップショットサイズのデフォルト最大値                                       |
| `DEFAULT_ORG_QUOTA_VOLUME_QUOTA`           | 数値      | `10000`                                              | 組織のデフォルトのボリュームクォータ                                            |
| `SSH_GATEWAY_API_KEY`                      | string  | `ssh_secret_api_token`                               | SSH ゲートウェイの API キー                                            |
| `SSH_GATEWAY_COMMAND`                      | 文字列     | `ssh -p 2222 {{TOKEN}}@localhost`                    | SSH ゲートウェイコマンド テンプレート                                         |
| `RUNNER_DECLARATIVE_BUILD_SCORE_THRESHOLD` | 数値      | `10`                                                 | ランナーの宣言的ビルドスコアしきい値                                            |
| `RUNNER_AVAILABILITY_SCORE_THRESHOLD`      | 数値      | `10`                                                 | ランナーの可用性スコアのしきい値                                              |
| `RUNNER_HEALTH_TIMEOUT_SECONDS`            | 数値      | `3`                                                  | ランナーのヘルスチェックのタイムアウト時間（秒）                                      |
| `RUN_MIGRATIONS`                           | ブール値    | `true`                                               | 起動時にデータベースマイグレーションを有効にする                                      |
| `ADMIN_API_KEY`                            | string  | (空)                                                  | 管理者用 API キー。未設定の場合は自動生成され、初期セットアップ時にのみ使用されます。本番環境での利用は推奨されません |
| `ADMIN_TOTAL_CPU_QUOTA`                    | 数値      | `0`                                                  | 管理者向けの合計 CPU クォータ。初回セットアップ時にのみ使用されます                          |
| `ADMIN_TOTAL_MEMORY_QUOTA`                 | 数値      | `0`                                                  | 管理者用の総メモリクォータ。初期セットアップ時にのみ使用されます                              |
| `ADMIN_TOTAL_DISK_QUOTA`                   | 数値      | `0`                                                  | 管理者の総ディスク容量上限。初期セットアップ時にのみ使用されます                              |
| `ADMIN_MAX_CPU_PER_SANDBOX`                | 数値      | `0`                                                  | サンドボックスごとの管理者用最大CPU（初期セットアップ時のみ使用）                            |
| `ADMIN_MAX_MEMORY_PER_SANDBOX`             | 数値      | `0`                                                  | サンドボックスごとの管理者用最大メモリ。初期セットアップ時にのみ使用されます                        |
| `ADMIN_MAX_DISK_PER_SANDBOX`               | 数値      | `0`                                                  | 初期セットアップ時にのみ使用される、サンドボックスごとの管理者設定ディスク上限                       |
| `ADMIN_SNAPSHOT_QUOTA`                     | 数値      | `100`                                                | 管理者用スナップショットクォータ。初期セットアップ時にのみ使用されます                           |
| `ADMIN_MAX_SNAPSHOT_SIZE`                  | 数値      | `100`                                                | 管理者向けスナップショットの最大サイズ。初期セットアップ時にのみ使用されます                        |
| `ADMIN_VOLUME_QUOTA`                       | 数値      | `0`                                                  | 初期セットアップ時にのみ使用される管理者用ボリュームクォータ                                |
| `SKIP_USER_EMAIL_VERIFICATION`             | ブール値    | `true`                                               | ユーザーのメールアドレス確認をスキップする                                         |
| `RATE_LIMIT_ANONYMOUS_TTL`                 | 数値      | (empty)                                              | 匿名ユーザー向けレート制限の有効期間（秒。空の場合はレート制限を無効化）                          |
| `RATE_LIMIT_ANONYMOUS_LIMIT`               | 数値      | (empty)                                              | 匿名アクセス用レート制限（TTL あたりのリクエスト数。空欄の場合はレート制限は無効）                   |
...
| `RATE_LIMIT_SANDBOX_CREATE_TTL`            | 数値      | (empty)                                              | サンドボックス作成レート制限の有効期間（秒。空の場合はレート制限を無効化）                         |
| `RATE_LIMIT_SANDBOX_CREATE_LIMIT`          | 数値      | (empty)                                              | サンドボックス作成レート制限（TTL あたりのリクエスト数。空欄の場合はレート制限は無効）                 |
| `RATE_LIMIT_SANDBOX_LIFECYCLE_TTL`         | 数値      | (empty)                                              | サンドボックスのライフサイクルに対するレート制限の有効期間（秒。空の場合はレート制限を無効化）               |
| `RATE_LIMIT_SANDBOX_LIFECYCLE_LIMIT`       | 数値      | (空)                                                  | サンドボックスライフサイクルのレート制限（TTL あたりのリクエスト数、空の場合はレート制限が無効）            |
| `DEFAULT_REGION_ID`                        | string  | `us`                                                 | デフォルトリージョン ID                                                 |
| `DEFAULT_REGION_NAME`                      | string  | `us`                                                 | デフォルトのリージョン名                                                  |
| `DEFAULT_REGION_ENFORCE_QUOTAS`            | 真偽値     | `false`                                              | デフォルトリージョンでリージョン別のリソース制限を有効化する                                |
