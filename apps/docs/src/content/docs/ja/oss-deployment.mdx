...
| `OTEL_ENABLED`                             | boolean | `true`                                               | OpenTelemetryトレーシングを有効化                                                                    |
...
| `DEFAULT_ORG_QUOTA_MAX_SNAPSHOT_SIZE`      | number  | `1000`                                               | デフォルト組織の最大スナップショットサイズ                                                               |
| `DEFAULT_ORG_QUOTA_VOLUME_QUOTA`           | number  | `10000`                                              | デフォルト組織のボリュームクォータ                                                                    |
...
| `RUNNER_DECLARATIVE_BUILD_SCORE_THRESHOLD` | number  | `10`                                                 | ランナーの宣言的ビルドスコア閾値                                                             |
| `RUNNER_AVAILABILITY_SCORE_THRESHOLD`      | number  | `10`                                                 | ランナーの可用性スコア閾値                                                                  |
| `RUN_MIGRATIONS`                           | boolean | `true`                                               | 起動時のデータベースマイグレーションを有効化                                                                |
| `ADMIN_API_KEY`                            | string  | (empty)                                              | 管理者APIキー（空の場合は自動生成、初期セットアップ時のみ使用、本番環境では非推奨） |
| `ADMIN_TOTAL_CPU_QUOTA`                    | number  | `0`                                                  | 管理者の合計CPUクォータ（初期セットアップ時のみ使用）                                                  |
| `ADMIN_TOTAL_MEMORY_QUOTA`                 | number  | `0`                                                  | 管理者の合計メモリクォータ（初期セットアップ時のみ使用）                                               |
| `ADMIN_TOTAL_DISK_QUOTA`                   | number  | `0`                                                  | 管理者の合計ディスククォータ（初期セットアップ時のみ使用）                                                 |
| `ADMIN_MAX_CPU_PER_SANDBOX`                | number  | `0`                                                  | 管理者のサンドボックスあたり最大CPU（初期セットアップ時のみ使用）                                              |
| `ADMIN_MAX_MEMORY_PER_SANDBOX`             | number  | `0`                                                  | 管理者のサンドボックスあたり最大メモリ（初期セットアップ時のみ使用）                                           |
| `ADMIN_MAX_DISK_PER_SANDBOX`               | number  | `0`                                                  | 管理者のサンドボックスあたり最大ディスク（初期セットアップ時のみ使用）                                             |
| `ADMIN_SNAPSHOT_QUOTA`                     | number  | `100`                                                | 管理者のスナップショットクォータ（初期セットアップ時のみ使用）                                                   |
| `ADMIN_MAX_SNAPSHOT_SIZE`                  | number  | `100`                                                | 管理者の最大スナップショットサイズ（初期セットアップ時のみ使用）                                                |
| `ADMIN_VOLUME_QUOTA`                       | number  | `0`                                                  | 管理者のボリュームクォータ（初期セットアップ時のみ使用）                                                     |
