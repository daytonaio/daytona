...
| `DEFAULT_ORG_QUOTA_MAX_SNAPSHOT_SIZE`      | number  | `1000`                                               | デフォルトの組織スナップショット最大サイズ                                                               |
...
| `RUNNER_DECLARATIVE_BUILD_SCORE_THRESHOLD` | number  | `10`                                                 | ランナー宣言的ビルドスコア閾値                                                             |
| `RUNNER_AVAILABILITY_SCORE_THRESHOLD`      | number  | `10`                                                 | ランナー可用性スコア閾値                                                                  |
| `RUN_MIGRATIONS`                           | boolean | `true`                                               | 起動時のデータベースマイグレーションを有効化                                                                |
| `ADMIN_API_KEY`                            | string  | (empty)                                              | 管理者APIキー。空の場合は自動生成。初期セットアップ時のみ使用。本番環境では非推奨 |
| `ADMIN_TOTAL_CPU_QUOTA`                    | number  | `0`                                                  | 管理者CPU合計クォータ。初期セットアップ時のみ使用                                                  |
| `ADMIN_TOTAL_MEMORY_QUOTA`                 | number  | `0`                                                  | 管理者メモリ合計クォータ。初期セットアップ時のみ使用                                               |
| `ADMIN_TOTAL_DISK_QUOTA`                   | number  | `0`                                                  | 管理者ディスク合計クォータ。初期セットアップ時のみ使用                                                 |
| `ADMIN_MAX_CPU_PER_SANDBOX`                | number  | `0`                                                  | 管理者サンドボックスあたりの最大CPU。初期セットアップ時のみ使用                                              |
| `ADMIN_MAX_MEMORY_PER_SANDBOX`             | number  | `0`                                                  | 管理者サンドボックスあたりの最大メモリ。初期セットアップ時のみ使用                                           |
| `ADMIN_MAX_DISK_PER_SANDBOX`               | number  | `0`                                                  | 管理者サンドボックスあたりの最大ディスク。初期セットアップ時のみ使用                                             |
| `ADMIN_SNAPSHOT_QUOTA`                     | number  | `100`                                                | 管理者スナップショットクォータ。初期セットアップ時のみ使用                                                   |
| `ADMIN_MAX_SNAPSHOT_SIZE`                  | number  | `100`                                                | 管理者スナップショット最大サイズ。初期セットアップ時のみ使用                                                |
| `ADMIN_VOLUME_QUOTA`                       | number  | `0`                                                  | 管理者ボリュームクォータ。初期セットアップ時のみ使用                                                     |
| `SKIP_USER_EMAIL_VERIFICATION`             | boolean | `true`                                               | ユーザーメール検証プロセスをスキップ                                                                 |
