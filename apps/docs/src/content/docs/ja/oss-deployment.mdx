...
| `DB_USERNAME`                              | string  | `user`                                               | PostgreSQL データベースユーザー名                                       |
| `DB_PASSWORD`                              | 文字列     | `pass`                                               | PostgreSQL データベース パスワード                                      |
| `DB_DATABASE`                              | 文字列     | `daytona`                                            | PostgreSQL データベース名                                           |
| `DB_TLS_ENABLED`                           | boolean | `false`                                              | データベース接続で TLS を有効にする                                         |
| `DB_TLS_REJECT_UNAUTHORIZED`               | boolean | `true`                                               | 信頼されていない TLS 証明書を拒否する                                        |
...
| `PUBLIC_OIDC_DOMAIN`                       | 文字列     | `http://localhost:5556/dex`                          | パブリック OIDC ドメイン                                              |
| `OIDC_AUDIENCE`                            | 文字列     | `daytona`                                            | OIDC のオーディエンス識別子                                             |
| `OIDC_MANAGEMENT_API_ENABLED`              | boolean | (empty)                                              | OIDC 管理 API の有効化                                             |
...
| `OIDC_MANAGEMENT_API_AUDIENCE`             | 文字列     | (空)                                                  | OIDC 管理 API のオーディエンス                                         |
| `DEFAULT_SNAPSHOT`                         | 文字列     | `daytonaio/sandbox:0.4.3`                            | 既定のサンドボックス スナップショット イメージ                                     |
| `DASHBOARD_URL`                            | 文字列     | `http://localhost:3000/dashboard`                    | ダッシュボード URL                                                  |
| `DASHBOARD_BASE_API_URL`                   | string  | `http://localhost:3000`                              | ダッシュボード API のベース URL                                         |
| `POSTHOG_API_KEY`                          | 文字列     | `phc_bYtEsdMDrNLydXPD4tufkBrHKgfO2zbycM30LOowYNv`    | 分析のための PostHog API キー                                        |
| `POSTHOG_HOST`                             | 文字列     | `https://d18ag4dodbta3l.cloudfront.net`              | PostHog のホストURL                                              |
| `POSTHOG_ENVIRONMENT`                      | 文字列     | `local`                                              | PostHog 環境 ID                                                |
| `TRANSIENT_REGISTRY_URL`                   | 文字列     | `http://registry:6000`                               | 一時的レジストリ URL                                                 |
| `TRANSIENT_REGISTRY_ADMIN`                 | string  | `admin`                                              | 一時レジストリの管理者ユーザー名                                             |
| `TRANSIENT_REGISTRY_PASSWORD`              | string  | `password`                                           | 一時レジストリ管理者パスワード                                              |
| `TRANSIENT_REGISTRY_PROJECT_ID`            | 文字列     | `daytona`                                            | 一時レジストリ プロジェクト ID                                            |
| `INTERNAL_REGISTRY_URL`                    | 文字列     | `http://registry:6000`                               | 内部レジストリURL                                                   |
| `INTERNAL_REGISTRY_ADMIN`                  | 文字列     | `admin`                                              | 内部レジストリ管理者のユーザー名                                             |
| `INTERNAL_REGISTRY_PASSWORD`               | 文字列     | `password`                                           | 内部レジストリの管理者パスワード                                             |
| `INTERNAL_REGISTRY_PROJECT_ID`             | 文字列     | `daytona`                                            | 内部レジストリのプロジェクト ID                                            |
| `SMTP_HOST`                                | string  | `maildev`                                            | SMTP サーバーホスト名                                                |
| `SMTP_PORT`                                | 数値      | `1025`                                               | SMTP サーバーポート                                                 |
| `SMTP_USER`                                | 文字列     | (empty)                                              | SMTP ユーザー名                                                   |
| `SMTP_PASSWORD`                            | 文字列     | (empty)                                              | SMTP パスワード                                                   |
| `SMTP_SECURE`                              | ブール値    | (empty)                                              | SMTP のセキュア接続を有効化                                             |
...
| `S3_REGION`                                | string  | `us-east-1`                                          | S3 リージョン                                                     |
...
| `OTEL_COLLECTOR_URL`                       | 文字列     | `http://jaeger:4318/v1/traces`                       | OpenTelemetry コレクターの URL                                     |
| `MAINTENANCE_MODE`                         | ブール値    | `false`                                              | メンテナンスモードを有効化                                                |
| `PROXY_DOMAIN`                             | 文字列     | `proxy.localhost:4000`                               | プロキシドメイン                                                     |
| `PROXY_PROTOCOL`                           | 文字列     | `http`                                               | PROXY プロトコル                                                  |
| `PROXY_API_KEY`                            | string  | `super_secret_key`                                   | プロキシ APIキー                                                   |
| `PROXY_TEMPLATE_URL`                       | 文字列     | `http://{{PORT}}-{{sandboxId}}.proxy.localhost:4000` | プロキシ テンプレートの URL パターン                                        |
...
| `DEFAULT_RUNNER_API_URL`                   | 文字列     | `http://runner:3003`                                 | デフォルトのランナー API URL                                           |
| `DEFAULT_RUNNER_PROXY_URL`                 | 文字列     | `http://runner:3003`                                 | デフォルト Runner プロキシ URL                                        |
| `DEFAULT_RUNNER_API_KEY`                   | 文字列     | `secret_api_token`                                   | デフォルトのランナー API キー                                            |
| `DEFAULT_RUNNER_CPU`                       | 数値      | `4`                                                  | デフォルトのランナーの CPU 割り当て                                         |
| `DEFAULT_RUNNER_MEMORY`                    | 数値      | `8`                                                  | 既定の Runner メモリ割り当て (GB)                                      |
| `DEFAULT_RUNNER_DISK`                      | 数値      | `50`                                                 | ランナーのデフォルトディスク割り当て (GB)                                      |
| `DEFAULT_RUNNER_GPU`                       | 数値      | `0`                                                  | デフォルトランナーの GPU 割り当て                                          |
| `DEFAULT_RUNNER_GPU_TYPE`                  | 文字列     | `none`                                               | デフォルトのランナー GPU の種類                                           |
| `DEFAULT_RUNNER_CAPACITY`                  | 数値      | `100`                                                | デフォルトのランナーキャパシティ                                             |
| `DEFAULT_RUNNER_REGION`                    | string  | `us`                                                 | ランナーのデフォルトリージョン                                              |
| `DEFAULT_RUNNER_CLASS`                     | 文字列     | `small`                                              | 既定のランナークラス                                                   |
| `DEFAULT_ORG_QUOTA_TOTAL_CPU_QUOTA`        | 数値      | `10000`                                              | 組織のデフォルトの合計 CPU クォータ                                         |
| `DEFAULT_ORG_QUOTA_TOTAL_MEMORY_QUOTA`     | 数値      | `10000`                                              | 組織のデフォルトの合計メモリクォータ                                           |
| `DEFAULT_ORG_QUOTA_TOTAL_DISK_QUOTA`       | 数値      | `100000`                                             | 組織のデフォルト合計ディスククォータ                                           |
| `DEFAULT_ORG_QUOTA_MAX_CPU_PER_SANDBOX`    | 数値      | `100`                                                | 組織のデフォルトのサンドボックスごとの最大 CPU 数                                  |
...
| `DEFAULT_ORG_QUOTA_SNAPSHOT_QUOTA`         | 数値      | `1000`                                               | 組織のデフォルトスナップショット割り当て                                         |
...
| `SSH_GATEWAY_COMMAND`                      | 文字列     | `ssh -p 2222 {{TOKEN}}@localhost`                    | SSH ゲートウェイ コマンドテンプレート                                        |
| `RUNNER_DECLARATIVE_BUILD_SCORE_THRESHOLD` | 数値      | `10`                                                 | Runner の宣言的ビルドのスコアしきい値                                       |
| `RUNNER_AVAILABILITY_SCORE_THRESHOLD`      | 数値      | `10`                                                 | Runner の可用性スコアしきい値                                           |
| `RUN_MIGRATIONS`                           | 真偽値     | `true`                                               | 起動時のデータベースマイグレーションの有効化                                       |
| `ADMIN_API_KEY`                            | 文字列     | (空)                                                  | Admin API キー。空の場合は自動生成され、初期セットアップ時にのみ使用されます。本番環境での使用は推奨されません |
| `ADMIN_TOTAL_CPU_QUOTA`                    | 番号      | `0`                                                  | 管理者の総 CPU クォータ。初期セットアップ時にのみ使用されます                            |
| `ADMIN_TOTAL_MEMORY_QUOTA`                 | 数値      | `0`                                                  | 初期セットアップ時にのみ使用される管理者の総メモリクォータ                                |
| `ADMIN_TOTAL_DISK_QUOTA`                   | 数値      | `0`                                                  | 初期セットアップ時にのみ使用される管理者用の総ディスククォータ                              |
| `ADMIN_MAX_CPU_PER_SANDBOX`                | 数値      | `0`                                                  | サンドボックスごとの管理者用最大 CPU 数。初回セットアップ時にのみ使用されます                    |
| `ADMIN_MAX_MEMORY_PER_SANDBOX`             | 数値      | `0`                                                  | 管理者が設定するサンドボックスごとの最大メモリ。初期セットアップ時にのみ使用                       |
| `ADMIN_MAX_DISK_PER_SANDBOX`               | 数値      | `0`                                                  | 初期セットアップ時にのみ使用される、サンドボックスごとの管理者設定最大ディスク容量                    |
| `ADMIN_SNAPSHOT_QUOTA`                     | 数値      | `100`                                                | 管理者スナップショットクォータ（初期セットアップ時のみ使用）                               |
| `ADMIN_MAX_SNAPSHOT_SIZE`                  | 数値      | `100`                                                | 管理者用のスナップショット最大サイズ。初回セットアップ時にのみ使用されます。                       |
| `ADMIN_VOLUME_QUOTA`                       | 数値      | `0`                                                  | 初期セットアップ時にのみ使用される管理用ボリュームクォータ                                |
| `SKIP_USER_EMAIL_VERIFICATION`             | ブール値    | `true`                                               | ユーザーのメールアドレス確認をスキップする                                        |
| `RATE_LIMIT_ANONYMOUS_TTL`                 | 数値      | (empty)                                              | 匿名レート制限の有効期限（秒。空欄の場合はレート制限は無効）                               |
| `RATE_LIMIT_ANONYMOUS_LIMIT`               | 数値      | (empty)                                              | 匿名アクセスのレート制限（TTL ごとのリクエスト数。空の場合はレート制限は無効）                    |
| `RATE_LIMIT_AUTHENTICATED_TTL`             | 数値      | (empty)                                              | 認証済みレート制限の有効期間（秒。空の場合はレート制限を無効化）                             |
| `RATE_LIMIT_AUTHENTICATED_LIMIT`           | 数値      | (空)                                                  | 認証済みレート制限（TTL あたりのリクエスト数。空の場合はレート制限は無効）                      |
| `RATE_LIMIT_SANDBOX_CREATE_TTL`            | 数値      | (空)                                                  | サンドボックス作成レート制限の有効期間（秒。空欄の場合はレート制限を無効化）                       |
| `RATE_LIMIT_SANDBOX_CREATE_LIMIT`          | 数値      | (empty)                                              | Sandbox 作成レート制限（TTL ごとのリクエスト数。空の場合はレート制限は無効）                 |
| `RATE_LIMIT_SANDBOX_LIFECYCLE_TTL`         | 数値      | (empty)                                              | Sandbox ライフサイクルのレート制限の有効期間（秒。空欄の場合はレート制限が無効化されます）            |
| `RATE_LIMIT_SANDBOX_LIFECYCLE_LIMIT`       | 数値      | (empty)                                              | Sandbox ライフサイクルのレート制限（TTL 期間あたりのリクエスト数。空の場合はレート制限は無効になります）   |
