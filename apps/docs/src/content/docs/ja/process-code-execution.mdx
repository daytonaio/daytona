...
* ステートレス実行は、作成時に選択したサンドボックスの言語を継承します。詳しくは [Basic Sandbox Creation](/docs/ja/sandbox-management/#basic-sandbox-creation) を参照してください。
...
詳細は [code&#95;run (Python SDK)](/docs/python-sdk/sync/process/#processcode_run)、[codeRun (TypeScript SDK)](/docs/typescript-sdk/process/#coderun) を参照してください。
...
詳しくは、[code&#95;interpreter (Python SDK)](/docs/python-sdk/sync/code-interpreter) および [codeInterpreter (TypeScript SDK)](/docs/typescript-sdk/code-interpreter) を参照してください。
