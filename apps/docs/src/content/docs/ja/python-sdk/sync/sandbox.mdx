...
@with_timeout(error_message=lambda self, timeout: (
    f"サンドボックス {cast('Sandbox', self).id} は {timeout} 秒のタイムアウト期間内に開始できませんでした"
))
...
@with_timeout(error_message=lambda self, timeout: (
    f"サンドボックス {cast('Sandbox', self).id} は {timeout} 秒のタイムアウト期間内に復旧できませんでした"
))
...
@with_timeout(error_message=lambda self, timeout: (
    f"サンドボックス {cast('Sandbox', self).id} は {timeout} 秒のタイムアウト期間内に停止できませんでした"
))
...
@with_timeout(error_message=lambda self, timeout: (
    f"サンドボックス {cast('Sandbox', self).id} は {timeout} 秒のタイムアウト期間内に準備完了になりませんでした"
))
