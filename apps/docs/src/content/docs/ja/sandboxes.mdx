...
詳細については、[Python SDK](/docs/python-sdk/sync/sandbox#sandboxresize)、[TypeScript SDK](/docs/typescript-sdk/sandbox#resize)、[Go SDK](/docs/go-sdk/sandbox#resize)、および [Ruby SDK](/docs/ruby-sdk/sandbox#resize) のリファレンスを参照してください。
