...
サンドボックスは、Daytona によって管理される隔離された開発環境です。このガイドでは、サンドボックスのライフサイクルと、Daytona SDK を使用して作成・管理・削除する方法について説明します。
...
詳細については、[Python SDK](/docs/ja/python-sdk/sync/daytona#resources) および [TypeScript SDK](/docs/ja/typescript-sdk/daytona#resources) のリファレンスを参照してください:
...
Daytona では、[Daytona Dashboard ↗](https://app.daytona.io/dashboard/) からサンドボックスを起動するか、[Python SDK](/docs/ja/python-sdk/) および [TypeScript SDK](/docs/ja/typescript-sdk/) を使用してプログラムから起動することができます。
...
より詳しくは、[Python SDK](/docs/python-sdk/sync/sandbox#sandboxstop) および [TypeScript SDK](/docs/typescript-sdk/sandbox#stop) のリファレンスを参照してください。
...
詳細については、[Python SDK](/docs/python-sdk/sync/sandbox#sandboxstop) および [TypeScript SDK](/docs/typescript-sdk/sandbox#stop) のリファレンスを参照してください。
...
Daytona では、Python および TypeScript からサンドボックスを停止するためのメソッドを提供しています。
...
> [**stop (Python SDK)**](/docs/python-sdk/sync/sandbox#sandboxstop), [**stop (TypeScript SDK)**](/docs/typescript-sdk/sandbox#stop)
>
> [**find&#95;one (Python SDK)**](/docs/python-sdk/sync/daytona#daytonafind_one), [**findOne (TypeScript SDK)**](/docs/typescript-sdk/daytona#findone)

## サンドボックスのアーカイブ \{#archive-sandboxes\}

Daytona は、Python と TypeScript を使用してサンドボックスをアーカイブするためのメソッドを提供します。
...
Daytona では、Python と TypeScript を使用してサンドボックスを復旧するためのメソッドを提供します。
...
詳細については、[Python SDK](/docs/python-sdk/sync/sandbox#sandboxrecover) および [TypeScript SDK](/docs/typescript-sdk/sandbox#recover) のリファレンスを参照してください。
...
サンドボックス内での SDK API 呼び出しや、[プレビュー URL](/docs/ja/preview-and-authentication) 経由のネットワークリクエストなどのアクティビティが発生すると、自動停止タイマーはリセットされます。
...
詳しくは、[Python SDK](/docs/python-sdk/sync/sandbox#sandboxset_autostop_interval) および [TypeScript SDK](/docs/typescript-sdk/sandbox#set_auto_stop_interval) のリファレンスを参照してください:
...
詳細については、[Python SDK](/docs/python-sdk/sync/sandbox#sandboxset_auto_archive_interval) および [TypeScript SDK](/docs/typescript-sdk/sandbox#set_auto_archive_interval) のリファレンスを参照してください:
...
詳しくは、[Python SDK](/docs/python-sdk/sync/sandbox#sandboxset_auto_delete_interval) および [TypeScript SDK](/docs/typescript-sdk/sandbox#set_auto_delete_interval) のリファレンスを参照してください:
