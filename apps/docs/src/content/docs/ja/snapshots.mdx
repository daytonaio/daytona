...
詳細については、[Python SDK](/docs/python-sdk/sync/snapshot#create)、[TypeScript SDK](/docs/typescript-sdk/snapshot#create)、および [Ruby SDK](/docs/ruby-sdk/snapshot#create) のリファレンスを参照してください。
...
詳細については、[Python SDK](/docs/python-sdk)、[TypeScript SDK](/docs/typescript-sdk)、および [Ruby SDK](/docs/ruby-sdk) のリファレンスを参照してください。
...
詳細については、[Python SDK](/docs/python-sdk/sync/snapshot#snapshotget)、[TypeScript SDK](/docs/typescript-sdk/snapshot#get)、および [Ruby SDK](/docs/ruby-sdk/snapshot#get) のリファレンスを参照してください。
...
詳細については、[Python SDK](/docs/python-sdk/sync/snapshot#snapshotlist)、[TypeScript SDK](/docs/typescript-sdk/snapshot#list)、および [Ruby SDK](/docs/ruby-sdk/snapshot#list) のリファレンスを参照してください。
...
詳細については、[Python SDK](/docs/python-sdk/sync/snapshot#snapshotactivate)、[TypeScript SDK](/docs/typescript-sdk/snapshot#activate)、および [Ruby SDK](/docs/ruby-sdk/snapshot#activate) のリファレンスを参照してください。
