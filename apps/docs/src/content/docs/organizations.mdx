...
Organizations in Daytona are used to group resources and enable collaboration. Users can work individually in their Personal Organization or together in a Team Organization.

### Personal vs Team Organizations

Every Daytona user starts with a **Personal Organization**, ideal for solo use and experimentation. **Team Organizations** are created manually and designed for company-wide collaboration with shared access and controls.

| Feature | Personal Organization | Team Organization |
|--------|------------------------|--------------------|
...
Users can switch between their Personal and Team Organizations using the dropdown in the sidebar. Each Organization has its own sandboxes, API keys, and resource quotas.
