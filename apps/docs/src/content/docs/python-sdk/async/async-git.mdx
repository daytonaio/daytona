...
- `path` _str_ - Path to the Git repository root. Relative paths are resolved based on the sandbox workdir.
...
- `path` _str_ - Path to the Git repository root. Relative paths are resolved based on the sandbox
