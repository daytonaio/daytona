...
- `network_allow_all` _Optional[bool]_ - Whether to allow all network access for the Sandbox.
- `network_allow_list` _Optional[str]_ - Comma-separated list of allowed network addresses for the Sandbox
