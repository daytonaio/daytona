...
- `path` _str_ - Path to the file to delete. Relative paths are resolved based on the sandbox workdir.
...
- `path` _str_ - Path to the file or directory. Relative paths are resolved based on the sandbox workdir.
...
- `source` _str_ - Path to the source file or directory. Relative paths are resolved
  based on the sandbox workdir.
- `destination` _str_ - Path to the destination. Relative paths are resolved based on the sandbox workdir.
...
- `remote_path` _str_ - Path to the destination file. Relative paths are resolved based on the sandbox workdir.
