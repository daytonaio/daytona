...
- `network_allow_all` _bool_ - Whether to allow all network access for the Sandbox.
- `network_allow_list` _str_ - Comma-separated list of allowed network addresses for the Sandbox
