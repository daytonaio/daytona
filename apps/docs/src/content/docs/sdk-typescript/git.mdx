...
await git.clone('https://github.com/user/repo.git', 'workspace/repo-old', (commitId = 'abc123'))
```
...
await git.commit('workspace/repo', 'Update documentation', 'John Doe', 'john@example.com')
```
