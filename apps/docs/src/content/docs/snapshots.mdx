...
3. Input the Registry's name and URL, username, password, project, and click submit
...
For examples of running code inside a sandbox, see the [Getting Started Guide](https://www.daytona.io/docs/getting-started/#run-code-inside-a-sandbox).
