...
```ts
new FileSystem(sandboxId: string, toolboxApi: ToolboxApi): FileSystem
```
...
- `path` _string_ - Path where the directory should be created. Relative paths are resolved based on the sandbox workdir.
...
- `path` _string_ - Path to the file or directory to delete. Relative paths are resolved based on the sandbox workdir.
...
- `remotePath` _string_ - Path to the file to download. Relative paths are resolved based on the sandbox workdir.
...
- `remotePath` _string_ - Path to the file to download in the Sandbox. Relative paths are resolved based on the sandbox workdir.
...
- `path` _string_ - Directory to search in. Relative paths are resolved based on the sandbox workdir.
...
- `path` _string_ - Path to the file or directory. Relative paths are resolved based on the sandbox workdir.
...
- `path` _string_ - Directory path to list. Relative paths are resolved based on the sandbox workdir.
...
- `source` _string_ - Source path. Relative paths are resolved based on the sandbox workdir.
- `destination` _string_ - Destination path. Relative paths are resolved based on the sandbox workdir.
...
- `files` _string\[\]_ - Array of file paths to process. Relative paths are resolved based on the sandbox workdir.
...
- `remotePath` _string_ - Destination path in the Sandbox. Relative paths are resolved based on the sandbox workdir.
...
- `destination` _string_ - Absolute destination path in the Sandbox. Relative paths are resolved based on the sandbox workdir.
