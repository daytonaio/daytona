...
const generateLlmsTxtFile = docsData => {
  const llmsContent = [
    ...
    '',
    '- **Daytona SDKs**: [TypeScript](https://daytona.io/docs/en/typescript-sdk.md), [Python](https://daytona.io/docs/en/python-sdk.md), [Ruby](https://daytona.io/docs/en/ruby-sdk.md), [Go](https://daytona.io/docs/en/go-sdk.md), [Java](https://daytona.io/docs/en/java-sdk.md)',
    '- **Daytona API**: [RESTful API](https://daytona.io/docs/en/tools/api.md#daytona) ([OpenAPI spec](https://daytona.io/docs/openapi.json)), [Toolbox API](https://daytona.io/docs/en/tools/api.md#daytona-toolbox) ([OpenAPI spec](https://daytona.io/docs/toolbox-openapi.json))',
    '- **Daytona CLI**: [Mac/Linux](https://daytona.io/docs/en/getting-started.md#cli), [Windows](https://daytona.io/docs/en/getting-started.md#cli), [Reference](https://daytona.io/docs/en/tools/cli.md)',
    '',
    '## Daytona Documentation',
    '',
