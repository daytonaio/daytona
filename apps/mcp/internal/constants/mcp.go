...
const (
	DAYTONA_MCP_SOURCE         = "daytona-mcp"
	DAYTONA_SANDBOX_MCP_SOURCE = "daytona-sandbox-mcp"
	DAYTONA_FS_MCP_SOURCE      = "daytona-fs-mcp"
	DAYTONA_GIT_MCP_SOURCE     = "daytona-git-mcp"
)

var PYTHON_CODE_WRAPPER string = `
