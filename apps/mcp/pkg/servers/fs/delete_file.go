...
func (s *DaytonaFileSystemMCPServer) getDeleteFileTool() *mcp.Tool {
	return &mcp.Tool{
		Name:        "delete_file",
		Title:       "Delete File",
...
func (s *DaytonaFileSystemMCPServer) handleDeleteFile(ctx context.Context, request *mcp.CallToolRequest, input *DeleteFileInput) (*mcp.CallToolResult, *DeleteFileOutput, error) {
	if input.SandboxId == "" {
