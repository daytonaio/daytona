...
func (x *GetSandboxInfoResponse) GetState() SandboxState {
	if x != nil {
		return x.State
	}
...
func (x *GetSandboxInfoResponse) GetBackupState() BackupState {
	if x != nil {
...
const file_runner_v1_runner_proto_rawDesc = "" +
	...
	"\aversion\x18\x02 \x01(\tR\aversion\"\xb8\x04\n" +
	...
	"\n" +
	"sandbox_id\x18\x01 \x01(\tR\tsandboxId\"\x82\x01\n" +
	"\x16GetSandboxInfoResponse\x12-\n" +
	...
	"\rHealthService\x12N\n" +
	"\vHealthCheck\x12\x1d.runner.v1.HealthCheckRequest\x1a\x1e.runner.v1.HealthCheckResponse\"\x002\xff\x04\n" +
	...
	"\vStopSandbox\x12\x1d.runner.v1.StopSandboxRequest\x1a\x1e.runner.v1.StopSandboxResponse\"\x00\x12W\n" +
	"\x0eGetSandboxInfo\x12 .runner.v1.GetSandboxInfoRequest\x1a!.runner.v1.GetSandboxInfoResponse\"\x00\x12o\n" +
	"\x16RemoveDestroyedSandbox\x12(.runner.v1.RemoveDestroyedSandboxRequest\x1a).runner.v1.RemoveDestroyedSandboxResponse\"\x002\xca\x03\n" +
...
var file_runner_v1_runner_proto_goTypes = []any{
	...
	(*CreateSandboxRequest)(nil),           // 5: runner.v1.CreateSandboxRequest
	(*CreateSandboxResponse)(nil),          // 6: runner.v1.CreateSandboxResponse
	(*DestroySandboxRequest)(nil),          // 7: runner.v1.DestroySandboxRequest
	(*DestroySandboxResponse)(nil),         // 8: runner.v1.DestroySandboxResponse
	(*CreateBackupRequest)(nil),            // 9: runner.v1.CreateBackupRequest
	(*CreateBackupResponse)(nil),           // 10: runner.v1.CreateBackupResponse
	(*StartSandboxRequest)(nil),            // 11: runner.v1.StartSandboxRequest
	(*StartSandboxResponse)(nil),           // 12: runner.v1.StartSandboxResponse
	(*StopSandboxRequest)(nil),             // 13: runner.v1.StopSandboxRequest
	(*StopSandboxResponse)(nil),            // 14: runner.v1.StopSandboxResponse
	(*GetSandboxInfoRequest)(nil),          // 15: runner.v1.GetSandboxInfoRequest
	(*GetSandboxInfoResponse)(nil),         // 16: runner.v1.GetSandboxInfoResponse
	(*RemoveDestroyedSandboxRequest)(nil),  // 17: runner.v1.RemoveDestroyedSandboxRequest
	(*RemoveDestroyedSandboxResponse)(nil), // 18: runner.v1.RemoveDestroyedSandboxResponse
	(*Registry)(nil),                       // 19: runner.v1.Registry
	(*PullSnapshotRequest)(nil),            // 20: runner.v1.PullSnapshotRequest
	(*PullSnapshotResponse)(nil),           // 21: runner.v1.PullSnapshotResponse
	(*BuildSnapshotRequest)(nil),           // 22: runner.v1.BuildSnapshotRequest
	(*BuildSnapshotResponse)(nil),          // 23: runner.v1.BuildSnapshotResponse
	(*SnapshotExistsRequest)(nil),          // 24: runner.v1.SnapshotExistsRequest
	(*SnapshotExistsResponse)(nil),         // 25: runner.v1.SnapshotExistsResponse
	(*RemoveSnapshotRequest)(nil),          // 26: runner.v1.RemoveSnapshotRequest
	(*RemoveSnapshotResponse)(nil),         // 27: runner.v1.RemoveSnapshotResponse
	(*GetSnapshotLogsRequest)(nil),         // 28: runner.v1.GetSnapshotLogsRequest
	(*GetSnapshotLogsResponse)(nil),        // 29: runner.v1.GetSnapshotLogsResponse
	(*Volume)(nil),                         // 30: runner.v1.Volume
	nil,                                    // 31: runner.v1.CreateSandboxRequest.EnvEntry
}
var file_runner_v1_runner_proto_depIdxs = []int32{
	0,  // 0: runner.v1.HealthCheckResponse.status:type_name -> runner.v1.HealthStatus
	31, // 1: runner.v1.CreateSandboxRequest.env:type_name -> runner.v1.CreateSandboxRequest.EnvEntry
	19, // 2: runner.v1.CreateSandboxRequest.registry:type_name -> runner.v1.Registry
	30, // 3: runner.v1.CreateSandboxRequest.volumes:type_name -> runner.v1.Volume
	19, // 4: runner.v1.CreateBackupRequest.registry:type_name -> runner.v1.Registry
	1,  // 5: runner.v1.GetSandboxInfoResponse.state:type_name -> runner.v1.SandboxState
	2,  // 6: runner.v1.GetSandboxInfoResponse.backup_state:type_name -> runner.v1.BackupState
	19, // 7: runner.v1.PullSnapshotRequest.registry:type_name -> runner.v1.Registry
	19, // 8: runner.v1.BuildSnapshotRequest.registry:type_name -> runner.v1.Registry
	3,  // 9: runner.v1.HealthService.HealthCheck:input_type -> runner.v1.HealthCheckRequest
	5,  // 10: runner.v1.SandboxService.CreateSandbox:input_type -> runner.v1.CreateSandboxRequest
	7,  // 11: runner.v1.SandboxService.DestroySandbox:input_type -> runner.v1.DestroySandboxRequest
	9,  // 12: runner.v1.SandboxService.CreateBackup:input_type -> runner.v1.CreateBackupRequest
	11, // 13: runner.v1.SandboxService.StartSandbox:input_type -> runner.v1.StartSandboxRequest
	13, // 14: runner.v1.SandboxService.StopSandbox:input_type -> runner.v1.StopSandboxRequest
	15, // 15: runner.v1.SandboxService.GetSandboxInfo:input_type -> runner.v1.GetSandboxInfoRequest
	17, // 16: runner.v1.SandboxService.RemoveDestroyedSandbox:input_type -> runner.v1.RemoveDestroyedSandboxRequest
	20, // 17: runner.v1.SnapshotService.PullSnapshot:input_type -> runner.v1.PullSnapshotRequest
	22, // 18: runner.v1.SnapshotService.BuildSnapshot:input_type -> runner.v1.BuildSnapshotRequest
	24, // 19: runner.v1.SnapshotService.SnapshotExists:input_type -> runner.v1.SnapshotExistsRequest
	26, // 20: runner.v1.SnapshotService.RemoveSnapshot:input_type -> runner.v1.RemoveSnapshotRequest
	28, // 21: runner.v1.SnapshotService.GetSnapshotLogs:input_type -> runner.v1.GetSnapshotLogsRequest
	4,  // 22: runner.v1.HealthService.HealthCheck:output_type -> runner.v1.HealthCheckResponse
	6,  // 23: runner.v1.SandboxService.CreateSandbox:output_type -> runner.v1.CreateSandboxResponse
	8,  // 24: runner.v1.SandboxService.DestroySandbox:output_type -> runner.v1.DestroySandboxResponse
	10, // 25: runner.v1.SandboxService.CreateBackup:output_type -> runner.v1.CreateBackupResponse
	12, // 26: runner.v1.SandboxService.StartSandbox:output_type -> runner.v1.StartSandboxResponse
	14, // 27: runner.v1.SandboxService.StopSandbox:output_type -> runner.v1.StopSandboxResponse
	16, // 28: runner.v1.SandboxService.GetSandboxInfo:output_type -> runner.v1.GetSandboxInfoResponse
	18, // 29: runner.v1.SandboxService.RemoveDestroyedSandbox:output_type -> runner.v1.RemoveDestroyedSandboxResponse
	21, // 30: runner.v1.SnapshotService.PullSnapshot:output_type -> runner.v1.PullSnapshotResponse
	23, // 31: runner.v1.SnapshotService.BuildSnapshot:output_type -> runner.v1.BuildSnapshotResponse
	25, // 32: runner.v1.SnapshotService.SnapshotExists:output_type -> runner.v1.SnapshotExistsResponse
	27, // 33: runner.v1.SnapshotService.RemoveSnapshot:output_type -> runner.v1.RemoveSnapshotResponse
	29, // 34: runner.v1.SnapshotService.GetSnapshotLogs:output_type -> runner.v1.GetSnapshotLogsResponse
...
func file_runner_v1_runner_proto_init() {
	...
	file_runner_v1_runner_proto_msgTypes[2].OneofWrappers = []any{}
	file_runner_v1_runner_proto_msgTypes[16].OneofWrappers = []any{}
	file_runner_v1_runner_proto_msgTypes[19].OneofWrappers = []any{}
	type x struct{}
