...
const (
	...
	SandboxService_GetSandboxInfo_FullMethodName         = "/runner.v1.SandboxService/GetSandboxInfo"
...
func (c *sandboxServiceClient) GetSandboxInfo(ctx context.Context, in *GetSandboxInfoRequest, opts ...grpc.CallOption) (*GetSandboxInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSandboxInfoResponse)
	err := c.cc.Invoke(ctx, SandboxService_GetSandboxInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSandboxServiceServer) GetSandboxInfo(context.Context, *GetSandboxInfoRequest) (*GetSandboxInfoResponse, error) {
...
func _SandboxService_GetSandboxInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSandboxInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SandboxServiceServer).GetSandboxInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SandboxService_GetSandboxInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxServiceServer).GetSandboxInfo(ctx, req.(*GetSandboxInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SandboxService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SandboxService_GetSandboxInfo_Handler,
		},
		{
