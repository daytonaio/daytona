...
func (s *SandboxService) GetSandboxInfo(ctx context.Context, req *pb.GetSandboxInfoRequest) (*pb.GetSandboxInfoResponse, error) {
...
func (s *SandboxService) getSandboxState(ctx context.Context, sandboxId string) (pb.SandboxState, error) {
	...
	case "running":
		if s.isContainerPullingImage(container.ID) {
			return pb.SandboxState_SANDBOX_STATE_PULLING_IMAGE, nil
		}
