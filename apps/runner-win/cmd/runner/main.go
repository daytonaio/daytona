...
import (
	...
	"github.com/daytonaio/runner-win/internal/metrics"
	"github.com/daytonaio/runner-win/internal/util"
	"github.com/daytonaio/runner-win/pkg/api"
	"github.com/daytonaio/runner-win/pkg/cache"
	"github.com/daytonaio/runner-win/pkg/daemon"
	...
	"github.com/daytonaio/runner-win/pkg/runner/v2/executor"
	"github.com/daytonaio/runner-win/pkg/runner/v2/healthcheck"
	"github.com/daytonaio/runner-win/pkg/runner/v2/poller"
...
func main() {
	...
	// Start LibVirt events monitor
	monitor := libvirt.NewLibVirtMonitor(netRulesManager)
	go func() {
		err = monitor.Start()
		if err != nil {
			log.Fatal(err)
	...
	if sshgateway.IsSSHGatewayEnabled() {
		sshGatewayService = sshgateway.NewService(libvirtClient)
