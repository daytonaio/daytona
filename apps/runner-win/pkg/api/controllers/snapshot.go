...
func TagImage(ctx *gin.Context) {
	...
	exists, err := runner.LibVirt.ImageExists(ctx.Request.Context(), request.SourceImage, false)
	if err != nil {
		ctx.Error(err)
		return
	}
	...
	if err := runner.LibVirt.TagImage(ctx.Request.Context(), request.SourceImage, request.TargetImage); err != nil {
		ctx.Error(err)
		return
	}
...
func PullSnapshot(ctx *gin.Context) {
	...
	err = runner.LibVirt.PullSnapshot(ctx.Request.Context(), request)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func BuildSnapshot(ctx *gin.Context) {
	...
	err = runner.LibVirt.BuildSnapshot(ctx.Request.Context(), request)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func SnapshotExists(ctx *gin.Context) {
	...
	exists, err := runner.LibVirt.ImageExists(ctx.Request.Context(), snapshot, false)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func RemoveSnapshot(ctx *gin.Context) {
	...
	err := runner.LibVirt.RemoveImage(ctx.Request.Context(), snapshot, true)
	if err != nil {
		ctx.Error(err)
		return
	}
...
func GetBuildLogs(ctx *gin.Context) {
	...
	for {
		exists, err := runner.LibVirt.ImageExists(ctx.Request.Context(), checkSnapshotRef, false)
		if err != nil {
...
func GetSnapshotInfo(ctx *gin.Context) {
	...
	info, err := runner.LibVirt.GetImageInfo(ctx.Request.Context(), snapshot)
	if err != nil {
		ctx.Error(err)
		return
	}
