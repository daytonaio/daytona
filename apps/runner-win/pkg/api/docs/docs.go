    ...
    "paths": {
        ...
        "/snapshots/push": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Push snapshot request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Snapshot successfully pushed",
                        "schema": {
                            "$ref": "#/definitions/PushSnapshotResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/stats/memory/view": {
            "get": {
                ...
                "operationId": "GetMemoryStatsView",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Lookback hours (default: 24)",
    ...
    "definitions": {
        ...
        "PushSnapshotRequestDTO": {
            ...
            "properties": {
                ...
                "snapshotName": {
                    "description": "Name for the new snapshot (e.g., \"myapp-v1.0\")",
                    "type": "string"
                }
            }
        },
        "PushSnapshotResponseDTO": {
            "type": "object",
            "properties": {
                "sizeBytes": {
                    "type": "integer",
