...
func Logs(ctx *gin.Context) {
	...
	// Get timestamps parameter from query string, default to false
...
// normalizeLogs processes raw Docker container logs to improve formatting consistency
...
// normalizeWhitespace normalizes whitespace in a single line
