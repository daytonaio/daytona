...
// Wrap the exporter with our custom filter to ignore 404 errors
func ApplyTraceExporter404Filter(exporter *otlptrace.Exporter) sdktrace.SpanExporter {
	return &filtered404Exporter{
		next: exporter,
	}
}
