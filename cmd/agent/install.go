...
import (
	...
	view "dagent/cmd/views/installation_wizard"
...
var installCmd = &cobra.Command{
	Use:   "install",
	Short: "Install the Daytona Agent on a remote host",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if agentRegistered {
			fmt.Println("Daytona Agent is already installed on the remote machine.")
			return
		}
		...
		fmt.Println("\nDaytona Agent has been successfully installed.")
