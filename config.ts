  ...
  return [
    {
      ...
      entries: [
        ...
        {
           type: 'link',
           href: localizePath('/docs/examples', locale),
           label: t('sidebarconfig.examples'),
           attrs: {
            icon: 'book.svg',
         },
           relatedGroupCategory: NavigationCategory.EXAMPLES,
          },

          autopopulateFromDir: localizePath('/docs/examples', locale),
