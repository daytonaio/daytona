...
<CardGroup>
  ...
  <Card title="Sandboxes" href="/docs/sandbox-management">
  ...
  <Card title="Declarative Builder" href="/docs/declarative-builder">
    Learn how to dynamically build Snapshots from Docker/OCI compatible images using the Daytona SDK.
  </Card>
  <Card title="Volumes" href="/docs/volumes">
...
<CardGroup>
  ...
  <Card title="Linked Accounts" href="/docs/linked-accounts">
...
<CardGroup>
  <Card title="Web Terminal" href="/docs/web-terminal">
    Web Terminal access to Daytona Sandboxes.
  </Card>
  <Card title="Preview & Authentication" href="/docs/preview-and-authentication">
