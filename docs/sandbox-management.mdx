...
<Note>
  Daytona keeps a pool of warm Sandboxes using default Snapshots.<br/>When available, your Sandbox will launch in milliseconds instead of cold-booting.
</Note>
