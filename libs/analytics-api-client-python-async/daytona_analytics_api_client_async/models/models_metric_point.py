...
class ModelsMetricPoint(BaseModel):
    """
    ModelsMetricPoint
    """ # noqa: E501
    metric_name: Optional[StrictStr] = Field(default=None, serialization_alias="metricName")
    timestamp: Optional[StrictStr] = None
    value: Optional[Union[StrictFloat, StrictInt]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["metricName", "timestamp", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelsMetricPoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelsMetricPoint from a dict"""
        if obj is None:
            return None
