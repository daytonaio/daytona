...
type PreviewAPI interface {
	...
	/*
		GetSandboxInfo Get sandbox info for proxy/gateway

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param sandboxId ID of the sandbox
		@return PreviewAPIGetSandboxInfoRequest
	*/
	GetSandboxInfo(ctx context.Context, sandboxId string) PreviewAPIGetSandboxInfoRequest

	// GetSandboxInfoExecute executes the request
	//  @return SandboxStateInfo
	GetSandboxInfoExecute(r PreviewAPIGetSandboxInfoRequest) (*SandboxStateInfo, *http.Response, error)
...
type PreviewAPIGetSandboxInfoRequest struct {
	ctx        context.Context
	ApiService PreviewAPI
	sandboxId  string
}

func (r PreviewAPIGetSandboxInfoRequest) Execute() (*SandboxStateInfo, *http.Response, error) {
	return r.ApiService.GetSandboxInfoExecute(r)
}
...
GetSandboxInfo Get sandbox info for proxy/gateway
	...
	@return PreviewAPIGetSandboxInfoRequest
*/
func (a *PreviewAPIService) GetSandboxInfo(ctx context.Context, sandboxId string) PreviewAPIGetSandboxInfoRequest {
	return PreviewAPIGetSandboxInfoRequest{
		ApiService: a,
		ctx:        ctx,
		sandboxId:  sandboxId,
...
//
//	@return SandboxStateInfo
func (a *PreviewAPIService) GetSandboxInfoExecute(r PreviewAPIGetSandboxInfoRequest) (*SandboxStateInfo, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SandboxStateInfo
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PreviewAPIService.GetSandboxInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/preview/{sandboxId}/info"
