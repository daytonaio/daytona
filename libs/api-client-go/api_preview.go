...
type PreviewAPI interface {
	...
	*/
	...
	/*
	GetSandboxInfoFromSignedFileDownloadToken Get sandbox info from signed file download token

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param signedFileDownloadToken Signed file download URL token
	@return PreviewAPIGetSandboxInfoFromSignedFileDownloadTokenRequest
	*/
	GetSandboxInfoFromSignedFileDownloadToken(ctx context.Context, signedFileDownloadToken string) PreviewAPIGetSandboxInfoFromSignedFileDownloadTokenRequest

	// GetSandboxInfoFromSignedFileDownloadTokenExecute executes the request
	//  @return SignedFileDownloadInfo
	GetSandboxInfoFromSignedFileDownloadTokenExecute(r PreviewAPIGetSandboxInfoFromSignedFileDownloadTokenRequest) (*SignedFileDownloadInfo, *http.Response, error)
...
type PreviewAPIGetSandboxInfoFromSignedFileDownloadTokenRequest struct {
	ctx context.Context
	ApiService PreviewAPI
	signedFileDownloadToken string
}

func (r PreviewAPIGetSandboxInfoFromSignedFileDownloadTokenRequest) Execute() (*SignedFileDownloadInfo, *http.Response, error) {
	return r.ApiService.GetSandboxInfoFromSignedFileDownloadTokenExecute(r)
}
...
GetSandboxInfoFromSignedFileDownloadToken Get sandbox info from signed file download token
 ...
 @return PreviewAPIGetSandboxInfoFromSignedFileDownloadTokenRequest
*/
func (a *PreviewAPIService) GetSandboxInfoFromSignedFileDownloadToken(ctx context.Context, signedFileDownloadToken string) PreviewAPIGetSandboxInfoFromSignedFileDownloadTokenRequest {
	return PreviewAPIGetSandboxInfoFromSignedFileDownloadTokenRequest{
		ApiService: a,
		ctx: ctx,
		signedFileDownloadToken: signedFileDownloadToken,
	}
}

// Execute executes the request
//  @return SignedFileDownloadInfo
func (a *PreviewAPIService) GetSandboxInfoFromSignedFileDownloadTokenExecute(r PreviewAPIGetSandboxInfoFromSignedFileDownloadTokenRequest) (*SignedFileDownloadInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SignedFileDownloadInfo
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PreviewAPIService.GetSandboxInfoFromSignedFileDownloadToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/preview/file-download/{signedFileDownloadToken}/sandbox-info"
	localVarPath = strings.Replace(localVarPath, "{"+"signedFileDownloadToken"+"}", url.PathEscape(parameterValueToString(r.signedFileDownloadToken, "signedFileDownloadToken")), -1)
