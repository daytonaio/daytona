...
type RegionsAPI interface {
	...
	*/
	...
	//  @return RegionDto
	GetRegionByIdExecute(r RegionsAPIGetRegionByIdRequest) (*RegionDto, *http.Response, error)
...
func (r RegionsAPIGetRegionByIdRequest) Execute() (*RegionDto, *http.Response, error) {
...
//
//	@return RegionDto
func (a *RegionsAPIService) GetRegionByIdExecute(r RegionsAPIGetRegionByIdRequest) (*RegionDto, *http.Response, error) {
	var (
