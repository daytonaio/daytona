...
type RunnersAPI interface {
	...
	*/
	...
	UpdateRunnerDrainingExecute(r RunnersAPIUpdateRunnerDrainingRequest) (*http.Response, error)
...
func (r RunnersAPIUpdateRunnerDrainingRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *RunnersAPIService) UpdateRunnerDrainingExecute(r RunnersAPIUpdateRunnerDrainingRequest) (*http.Response, error) {
	var (
