...
type SnapshotsAPI interface {
	...
	*/
	...
	/*
		GetSnapshotRunnerClass Get runner class for a snapshot by name

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param name Snapshot name
		@return SnapshotsAPIGetSnapshotRunnerClassRequest
	*/
	GetSnapshotRunnerClass(ctx context.Context, name string) SnapshotsAPIGetSnapshotRunnerClassRequest

	// GetSnapshotRunnerClassExecute executes the request
	//  @return SnapshotRunnerClassDto
	GetSnapshotRunnerClassExecute(r SnapshotsAPIGetSnapshotRunnerClassRequest) (*SnapshotRunnerClassDto, *http.Response, error)
...
type SnapshotsAPIGetSnapshotRunnerClassRequest struct {
	ctx                    context.Context
	ApiService             SnapshotsAPI
	name                   string
	xDaytonaOrganizationID *string
...
// Use with JWT to specify the organization ID
func (r SnapshotsAPIGetSnapshotRunnerClassRequest) XDaytonaOrganizationID(xDaytonaOrganizationID string) SnapshotsAPIGetSnapshotRunnerClassRequest {
	r.xDaytonaOrganizationID = &xDaytonaOrganizationID
	return r
}

func (r SnapshotsAPIGetSnapshotRunnerClassRequest) Execute() (*SnapshotRunnerClassDto, *http.Response, error) {
	return r.ApiService.GetSnapshotRunnerClassExecute(r)
}
...
GetSnapshotRunnerClass Get runner class for a snapshot by name
	...
	@return SnapshotsAPIGetSnapshotRunnerClassRequest
*/
func (a *SnapshotsAPIService) GetSnapshotRunnerClass(ctx context.Context, name string) SnapshotsAPIGetSnapshotRunnerClassRequest {
	return SnapshotsAPIGetSnapshotRunnerClassRequest{
		ApiService: a,
		ctx:        ctx,
		name:       name,
...
//
//	@return SnapshotRunnerClassDto
func (a *SnapshotsAPIService) GetSnapshotRunnerClassExecute(r SnapshotsAPIGetSnapshotRunnerClassRequest) (*SnapshotRunnerClassDto, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SnapshotRunnerClassDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SnapshotsAPIService.GetSnapshotRunnerClass")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/snapshots/{name}/runner-class"
