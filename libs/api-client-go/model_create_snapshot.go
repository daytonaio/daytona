...
type CreateSnapshot struct {
	...
	TargetPropagations []SetSnapshotTargetPropagationDto `json:"targetPropagations,omitempty"`
}
...
func (o *CreateSnapshot) GetTargetPropagations() []SetSnapshotTargetPropagationDto {
...
// and a boolean to check if the value has been set.
func (o *CreateSnapshot) GetTargetPropagationsOk() ([]SetSnapshotTargetPropagationDto, bool) {
	if o == nil || IsNil(o.TargetPropagations) {
		return nil, false
	}
...
// SetTargetPropagations gets a reference to the given []SetSnapshotTargetPropagationDto and assigns it to the TargetPropagations field.
func (o *CreateSnapshot) SetTargetPropagations(v []SetSnapshotTargetPropagationDto) {
