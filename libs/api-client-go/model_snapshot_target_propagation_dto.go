...
func NewSnapshotTargetPropagationDto(id string, target string, desiredConcurrentSandboxes float32, userMinimum float32, snapshotId string, createdAt time.Time, updatedAt time.Time) *SnapshotTargetPropagationDto {
...
func (o *SnapshotTargetPropagationDto) GetUserMinimum() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SnapshotTargetPropagationDto) GetUserMinimumOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SnapshotTargetPropagationDto) SetUserMinimum(v float32) {
	o.UserMinimum = v
}
