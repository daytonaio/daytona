...
func (o *UpdateRegion) GetStorageRegion() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *UpdateRegion) GetStorageRegionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UpdateRegion) HasStorageRegion() bool {
