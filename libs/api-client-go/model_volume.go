...
func NewVolume(id string, name string, organizationId string, state VolumeState, createdAt string, updatedAt string, lastUsedAt string) *Volume {
	this := Volume{}
	this.Id = id
	this.Name = name
...
func (o *Volume) HasErrorReason() bool {
	if o != nil && !IsNil(o.ErrorReason) {
		return true
	}
