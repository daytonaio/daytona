...
|**value** | **String** | The masked API key value |  |
...
|**lastUsedAt** | **OffsetDateTime** | When the API key was last used |  |
|**expiresAt** | **OffsetDateTime** | When the API key expires |  |
|**userId** | **String** | The user ID of the user who created the API key |  |
