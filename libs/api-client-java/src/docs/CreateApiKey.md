...
|**permissions** | [**List&lt;PermissionsEnum&gt;**](#List&lt;PermissionsEnum&gt;) | The list of organization resource permissions explicitly assigned to the API key |  |
|**expiresAt** | **OffsetDateTime** | When the API key expires |  [optional] |
