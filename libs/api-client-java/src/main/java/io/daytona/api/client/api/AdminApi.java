...
public class AdminApi {
    ...
    /**
     * Build call for adminSetSandboxErrorState
     * @param sandboxId ID of the sandbox (required)
     * @param setSandboxErrorStateDto  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Sandbox state updated to error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call adminSetSandboxErrorStateCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull SetSandboxErrorStateDto setSandboxErrorStateDto, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = setSandboxErrorStateDto;

        // create path and map variables
        String localVarPath = "/admin/sandbox/{sandboxId}/error"
            .replace("{" + "sandboxId" + "}", localVarApiClient.escapeString(sandboxId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminSetSandboxErrorStateValidateBeforeCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull SetSandboxErrorStateDto setSandboxErrorStateDto, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling adminSetSandboxErrorState(Async)");
        }

        // verify the required parameter 'setSandboxErrorStateDto' is set
        if (setSandboxErrorStateDto == null) {
            throw new ApiException("Missing the required parameter 'setSandboxErrorStateDto' when calling adminSetSandboxErrorState(Async)");
        }

        return adminSetSandboxErrorStateCall(sandboxId, setSandboxErrorStateDto, _callback);
     ...
     */
    public Sandbox adminSetSandboxErrorState(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull SetSandboxErrorStateDto setSandboxErrorStateDto) throws ApiException {
        ApiResponse<Sandbox> localVarResp = adminSetSandboxErrorStateWithHttpInfo(sandboxId, setSandboxErrorStateDto);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Sandbox> adminSetSandboxErrorStateWithHttpInfo(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull SetSandboxErrorStateDto setSandboxErrorStateDto) throws ApiException {
        okhttp3.Call localVarCall = adminSetSandboxErrorStateValidateBeforeCall(sandboxId, setSandboxErrorStateDto, null);
        Type localVarReturnType = new TypeToken<Sandbox>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Set sandbox state to error as an admin (asynchronously)
     * 
     * @param sandboxId ID of the sandbox (required)
     * @param setSandboxErrorStateDto  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call adminSetSandboxErrorStateAsync(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull SetSandboxErrorStateDto setSandboxErrorStateDto, final ApiCallback<Sandbox> _callback) throws ApiException {

        okhttp3.Call localVarCall = adminSetSandboxErrorStateValidateBeforeCall(sandboxId, setSandboxErrorStateDto, _callback);
        Type localVarReturnType = new TypeToken<Sandbox>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
