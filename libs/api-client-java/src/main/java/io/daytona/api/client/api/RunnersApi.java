...
public class RunnersApi {
     ...
     */
    public okhttp3.Call listRunnersCall(String regionId, String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listRunnersValidateBeforeCall(String regionId, String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
     ...
     */
    public List<Runner> listRunners(String regionId, String xDaytonaOrganizationID) throws ApiException {
     ...
     */
    public ApiResponse<List<Runner>> listRunnersWithHttpInfo(String regionId, String xDaytonaOrganizationID) throws ApiException {
     ...
     */
    public okhttp3.Call listRunnersAsync(String regionId, String xDaytonaOrganizationID, final ApiCallback<List<Runner>> _callback) throws ApiException {
