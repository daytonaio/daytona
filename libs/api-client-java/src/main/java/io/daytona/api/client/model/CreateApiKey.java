...
public class CreateApiKey {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, permissions, expiresAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateApiKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateApiKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
