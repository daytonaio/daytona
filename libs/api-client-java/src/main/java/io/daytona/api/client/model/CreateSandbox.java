...
public class CreateSandbox {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, snapshot, user, env, labels, _public, networkBlockAll, networkAllowList, propertyClass, target, cpu, gpu, memory, disk, autoStopInterval, autoArchiveInterval, autoDeleteInterval, volumes, buildInfo);
  }
