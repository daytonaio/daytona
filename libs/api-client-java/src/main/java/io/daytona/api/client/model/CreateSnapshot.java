...
public class CreateSnapshot {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, imageName, entrypoint, general, cpu, gpu, memory, disk, buildInfo, regionId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSnapshot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSnapshot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
