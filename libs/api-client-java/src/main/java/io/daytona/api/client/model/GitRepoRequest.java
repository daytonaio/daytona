...
public class GitRepoRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(path, username, password);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GitRepoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GitRepoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
