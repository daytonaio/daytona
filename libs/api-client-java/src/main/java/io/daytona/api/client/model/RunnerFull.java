...
public class RunnerFull {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "cpu", "memory", "disk", "region", "name", "state", "unschedulable", "createdAt", "updatedAt", "version", "apiVersion", "runnerClass", "apiKey"));
  }
