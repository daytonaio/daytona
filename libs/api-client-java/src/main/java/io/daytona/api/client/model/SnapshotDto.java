...
public class SnapshotDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, organizationId, general, name, imageName, state, size, entrypoint, cpu, gpu, mem, disk, errorReason, createdAt, updatedAt, lastUsedAt, buildInfo, regionIds, initialRunnerId, ref);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SnapshotDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SnapshotDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
