...
public class SnapshotsApi {
    ...
    /**
     * Build call for canCleanupImage
     ...
     */
    public okhttp3.Call canCleanupImageCall(String imageName, String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/snapshots/can-cleanup-image";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call canCleanupImageValidateBeforeCall(String imageName, String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'imageName' is set
        if (imageName == null) {
            throw new ApiException("Missing the required parameter 'imageName' when calling canCleanupImage(Async)");
        }

        return canCleanupImageCall(imageName, xDaytonaOrganizationID, _callback);
     ...
     */
    public Boolean canCleanupImage(String imageName, String xDaytonaOrganizationID) throws ApiException {
        ApiResponse<Boolean> localVarResp = canCleanupImageWithHttpInfo(imageName, xDaytonaOrganizationID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Boolean> canCleanupImageWithHttpInfo(String imageName, String xDaytonaOrganizationID) throws ApiException {
        okhttp3.Call localVarCall = canCleanupImageValidateBeforeCall(imageName, xDaytonaOrganizationID, null);
     ...
     */
    public okhttp3.Call canCleanupImageAsync(String imageName, String xDaytonaOrganizationID, final ApiCallback<Boolean> _callback) throws ApiException {

        okhttp3.Call localVarCall = canCleanupImageValidateBeforeCall(imageName, xDaytonaOrganizationID, _callback);
        Type localVarReturnType = new TypeToken<Boolean>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for setSnapshotGeneralStatus
     * @param id Snapshot ID (required)
     ...
     */
    public okhttp3.Call setSnapshotGeneralStatusCall(String id, SetSnapshotGeneralStatusDto setSnapshotGeneralStatusDto, String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/snapshots/{id}/general"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setSnapshotGeneralStatusValidateBeforeCall(String id, SetSnapshotGeneralStatusDto setSnapshotGeneralStatusDto, String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling setSnapshotGeneralStatus(Async)");
        }

        // verify the required parameter 'setSnapshotGeneralStatusDto' is set
        if (setSnapshotGeneralStatusDto == null) {
            throw new ApiException("Missing the required parameter 'setSnapshotGeneralStatusDto' when calling setSnapshotGeneralStatus(Async)");
        }

        return setSnapshotGeneralStatusCall(id, setSnapshotGeneralStatusDto, xDaytonaOrganizationID, _callback);
     ...
     */
    public SnapshotDto setSnapshotGeneralStatus(String id, SetSnapshotGeneralStatusDto setSnapshotGeneralStatusDto, String xDaytonaOrganizationID) throws ApiException {
        ApiResponse<SnapshotDto> localVarResp = setSnapshotGeneralStatusWithHttpInfo(id, setSnapshotGeneralStatusDto, xDaytonaOrganizationID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SnapshotDto> setSnapshotGeneralStatusWithHttpInfo(String id, SetSnapshotGeneralStatusDto setSnapshotGeneralStatusDto, String xDaytonaOrganizationID) throws ApiException {
        okhttp3.Call localVarCall = setSnapshotGeneralStatusValidateBeforeCall(id, setSnapshotGeneralStatusDto, xDaytonaOrganizationID, null);
        Type localVarReturnType = new TypeToken<SnapshotDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call setSnapshotGeneralStatusAsync(String id, SetSnapshotGeneralStatusDto setSnapshotGeneralStatusDto, String xDaytonaOrganizationID, final ApiCallback<SnapshotDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = setSnapshotGeneralStatusValidateBeforeCall(id, setSnapshotGeneralStatusDto, xDaytonaOrganizationID, _callback);
        Type localVarReturnType = new TypeToken<SnapshotDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
