...
public class UsersApi {
     ...
     */
    public ApiResponse<Void> listUsersWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call listUsersAsync(final ApiCallback<Void> _callback) throws ApiException {
    ...
    /**
     * Build call for regenerateKeyPair
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call regenerateKeyPairCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/users/{id}/regenerate-key-pair"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call regenerateKeyPairValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling regenerateKeyPair(Async)");
        }

        return regenerateKeyPairCall(id, _callback);
     ...
     */
    public void regenerateKeyPair(String id) throws ApiException {
     ...
     */
    public ApiResponse<Void> regenerateKeyPairWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = regenerateKeyPairValidateBeforeCall(id, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call regenerateKeyPairAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = regenerateKeyPairValidateBeforeCall(id, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
