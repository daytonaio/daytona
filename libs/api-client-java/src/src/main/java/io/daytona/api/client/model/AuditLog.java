...
public class AuditLog {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, actorId, actorEmail, organizationId, action, targetType, targetId, statusCode, errorMessage, ipAddress, userAgent, source, metadata, createdAt);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("actorId");
    openapiRequiredFields.add("actorEmail");
