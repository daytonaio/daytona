...
_DYNAMIC_IMPORTS: dict[str, str] = {
    ...
    "SignedFileDownloadInfo": "daytona_api_client_async.models.signed_file_download_info",
    "SignedFileDownloadUrl": "daytona_api_client_async.models.signed_file_download_url",
