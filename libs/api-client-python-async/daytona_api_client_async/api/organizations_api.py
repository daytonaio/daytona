...
from daytona_api_client_async.models.organization_sandbox_default_network_block_all import OrganizationSandboxDefaultNetworkBlockAll
...
class OrganizationsApi:
    ...
    @validate_call
    async def update_sandbox_default_network_block_all(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        organization_sandbox_default_network_block_all: OrganizationSandboxDefaultNetworkBlockAll,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Update sandbox default network block all


        :param organization_id: Organization ID (required)
        :type organization_id: str
        :param organization_sandbox_default_network_block_all: (required)
        :type organization_sandbox_default_network_block_all: OrganizationSandboxDefaultNetworkBlockAll
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_sandbox_default_network_block_all_serialize(
            organization_id=organization_id,
            organization_sandbox_default_network_block_all=organization_sandbox_default_network_block_all,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def update_sandbox_default_network_block_all_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        organization_sandbox_default_network_block_all: OrganizationSandboxDefaultNetworkBlockAll,
        _request_timeout: Union[
    ...
    @validate_call
    async def update_sandbox_default_network_block_all_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        organization_sandbox_default_network_block_all: OrganizationSandboxDefaultNetworkBlockAll,
        _request_timeout: Union[
    ...
    def _update_sandbox_default_network_block_all_serialize(
        self,
        organization_id,
        ...
        # process the form parameters
        # process the body parameter
        if organization_sandbox_default_network_block_all is not None:
            _body_params = organization_sandbox_default_network_block_all
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/organizations/{organizationId}/sandbox-default-network-block-all',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
