...
class OrganizationsApi:
    ...
    @validate_call
    async def delete_custom_bucket_config(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        _request_timeout: Union[
            None,
        ...
        _param = self._delete_custom_bucket_config_serialize(
            organization_id=organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def delete_custom_bucket_config_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def delete_custom_bucket_config_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        _request_timeout: Union[
            None,
    ...
    def _delete_custom_bucket_config_serialize(
        self,
        organization_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/organizations/{organizationId}/custom-bucket',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def set_custom_bucket_config(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        update_organization_custom_bucket: UpdateOrganizationCustomBucket,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param organization_id: Organization ID (required)
        :type organization_id: str
        :param update_organization_custom_bucket: (required)
        :type update_organization_custom_bucket: UpdateOrganizationCustomBucket
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._set_custom_bucket_config_serialize(
            organization_id=organization_id,
            update_organization_custom_bucket=update_organization_custom_bucket,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def set_custom_bucket_config_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        update_organization_custom_bucket: UpdateOrganizationCustomBucket,
        _request_timeout: Union[
    ...
    @validate_call
    async def set_custom_bucket_config_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        update_organization_custom_bucket: UpdateOrganizationCustomBucket,
        _request_timeout: Union[
    ...
    def _set_custom_bucket_config_serialize(
        self,
        organization_id,
        update_organization_custom_bucket,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_organization_custom_bucket is not None:
            _body_params = update_organization_custom_bucket
    ...
    @validate_call
    async def set_default_volume_backend(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        update_organization_default_volume_backend: UpdateOrganizationDefaultVolumeBackend,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param organization_id: Organization ID (required)
        :type organization_id: str
        :param update_organization_default_volume_backend: (required)
        :type update_organization_default_volume_backend: UpdateOrganizationDefaultVolumeBackend
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._set_default_volume_backend_serialize(
            organization_id=organization_id,
            update_organization_default_volume_backend=update_organization_default_volume_backend,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def set_default_volume_backend_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        update_organization_default_volume_backend: UpdateOrganizationDefaultVolumeBackend,
        _request_timeout: Union[
    ...
    @validate_call
    async def set_default_volume_backend_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        update_organization_default_volume_backend: UpdateOrganizationDefaultVolumeBackend,
        _request_timeout: Union[
    ...
    def _set_default_volume_backend_serialize(
        self,
        organization_id,
        update_organization_default_volume_backend,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_organization_default_volume_backend is not None:
            _body_params = update_organization_default_volume_backend
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/organizations/{organizationId}/default-volume-backend',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
