...
class PreviewApi:
    ...
    @validate_call
    async def has_sandbox_access_by_token(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        x_daytona_bearer_token: StrictStr,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type sandbox_id: str
        :param x_daytona_bearer_token: (required)
        :type x_daytona_bearer_token: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._has_sandbox_access_by_token_serialize(
            sandbox_id=sandbox_id,
            x_daytona_bearer_token=x_daytona_bearer_token,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def has_sandbox_access_by_token_with_http_info(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        x_daytona_bearer_token: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def has_sandbox_access_by_token_without_preload_content(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        x_daytona_bearer_token: StrictStr,
        _request_timeout: Union[
    ...
    def _has_sandbox_access_by_token_serialize(
        self,
        sandbox_id,
        x_daytona_bearer_token,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the query parameters
        # process the header parameters
        if x_daytona_bearer_token is not None:
            _header_params['x-daytona-bearer-token'] = x_daytona_bearer_token
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/preview/{sandboxId}/proxy-access',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
