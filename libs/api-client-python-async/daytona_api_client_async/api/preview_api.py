...
from typing_extensions import Annotated
from daytona_api_client_async.models.signed_file_download_info import SignedFileDownloadInfo
...
class PreviewApi:
    ...
    @validate_call
    async def get_sandbox_info_from_signed_file_download_token(
        self,
        signed_file_download_token: Annotated[StrictStr, Field(description="Signed file download URL token")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param signed_file_download_token: Signed file download URL token (required)
        :type signed_file_download_token: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_sandbox_info_from_signed_file_download_token_serialize(
            signed_file_download_token=signed_file_download_token,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_sandbox_info_from_signed_file_download_token_with_http_info(
        self,
        signed_file_download_token: Annotated[StrictStr, Field(description="Signed file download URL token")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SignedFileDownloadInfo]:
        """Get sandbox info from signed file download token
    ...
    @validate_call
    async def get_sandbox_info_from_signed_file_download_token_without_preload_content(
        self,
        signed_file_download_token: Annotated[StrictStr, Field(description="Signed file download URL token")],
        _request_timeout: Union[
            None,
    ...
    def _get_sandbox_info_from_signed_file_download_token_serialize(
        self,
        signed_file_download_token,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the path parameters
        if signed_file_download_token is not None:
            _path_params['signedFileDownloadToken'] = signed_file_download_token
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/preview/file-download/{signedFileDownloadToken}/sandbox-info',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
