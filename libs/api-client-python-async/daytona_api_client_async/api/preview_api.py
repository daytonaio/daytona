...
from typing_extensions import Annotated
from daytona_api_client_async.models.sandbox_state_info import SandboxStateInfo
...
class PreviewApi:
    ...
    async def get_sandbox_info(
        ...
        """Get sandbox info for proxy/gateway
        ...
        _param = self._get_sandbox_info_serialize(
    ...
    @validate_call
    async def get_sandbox_info_with_http_info(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_sandbox_info_without_preload_content(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        _request_timeout: Union[
            None,
    ...
    def _get_sandbox_info_serialize(
        self,
        sandbox_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/preview/{sandboxId}/info',
