...
class RegionsApi:
    ...
    async def get_region_by_name(
        self,
        name: Annotated[StrictStr, Field(description="Region name")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param name: Region name (required)
        :type name: str
        :param x_daytona_organization_id: Use with JWT to specify the organization ID
        :type x_daytona_organization_id: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_region_by_name_serialize(
            name=name,
            x_daytona_organization_id=x_daytona_organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def get_region_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Region name")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_region_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Region name")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
    ...
    def _get_region_by_name_serialize(
        self,
        name,
        x_daytona_organization_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/regions/by-name/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def list_regions(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        include_global: Annotated[Optional[StrictBool], Field(description="Include global regions in the response")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_daytona_organization_id: Use with JWT to specify the organization ID
        :type x_daytona_organization_id: str
        :param include_global: Include global regions in the response
    ...
    def _list_regions_serialize(
        ...
        if include_global is not None:
            ...
            _query_params.append(('includeGlobal', include_global))
