...
class RunnersApi:
    ...
    @validate_call
    async def get_initial_runner_by_snapshot_id(
        self,
        ...
        """Get initial runner by snapshot ID
        ...
        _param = self._get_initial_runner_by_snapshot_id_serialize(
    ...
    @validate_call
    async def get_initial_runner_by_snapshot_id_with_http_info(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="Snapshot ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_initial_runner_by_snapshot_id_without_preload_content(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="Snapshot ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_initial_runner_by_snapshot_id_serialize(
        self,
        snapshot_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/runners/inital-by-snapshot-id/{snapshotId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
