...
from daytona_api_client_async.models.update_sandbox_degraded_reason_dto import UpdateSandboxDegradedReasonDto
...
class SandboxApi:
    ...
    @validate_call
    async def update_sandbox_degraded_reason(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        update_sandbox_degraded_reason_dto: UpdateSandboxDegradedReasonDto,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param sandbox_id: ID of the sandbox (required)
        :type sandbox_id: str
        :param update_sandbox_degraded_reason_dto: (required)
        :type update_sandbox_degraded_reason_dto: UpdateSandboxDegradedReasonDto
        :param x_daytona_organization_id: Use with JWT to specify the organization ID
        :type x_daytona_organization_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._update_sandbox_degraded_reason_serialize(
            sandbox_id=sandbox_id,
            update_sandbox_degraded_reason_dto=update_sandbox_degraded_reason_dto,
            x_daytona_organization_id=x_daytona_organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def update_sandbox_degraded_reason_with_http_info(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        update_sandbox_degraded_reason_dto: UpdateSandboxDegradedReasonDto,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    @validate_call
    async def update_sandbox_degraded_reason_without_preload_content(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        update_sandbox_degraded_reason_dto: UpdateSandboxDegradedReasonDto,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    def _update_sandbox_degraded_reason_serialize(
        self,
        sandbox_id,
        update_sandbox_degraded_reason_dto,
        x_daytona_organization_id,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if update_sandbox_degraded_reason_dto is not None:
            _body_params = update_sandbox_degraded_reason_dto
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/sandbox/{sandboxId}/degraded-reason',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
