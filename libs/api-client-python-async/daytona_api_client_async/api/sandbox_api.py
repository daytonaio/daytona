...
from daytona_api_client_async.models.sandbox_notification_dto import SandboxNotificationDto
...
class SandboxApi:
    ...
    @validate_call
    async def create_sandbox_notification(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        sandbox_notification_dto: SandboxNotificationDto,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        """Create a sandbox notification


        :param sandbox_id: ID of the sandbox (required)
        :type sandbox_id: str
        :param sandbox_notification_dto: (required)
        :type sandbox_notification_dto: SandboxNotificationDto
        :param x_daytona_organization_id: Use with JWT to specify the organization ID
        :type x_daytona_organization_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_sandbox_notification_serialize(
            sandbox_id=sandbox_id,
            sandbox_notification_dto=sandbox_notification_dto,
            x_daytona_organization_id=x_daytona_organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def create_sandbox_notification_with_http_info(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        sandbox_notification_dto: SandboxNotificationDto,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    @validate_call
    async def create_sandbox_notification_without_preload_content(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        sandbox_notification_dto: SandboxNotificationDto,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    def _create_sandbox_notification_serialize(
        self,
        sandbox_id,
        sandbox_notification_dto,
        x_daytona_organization_id,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if sandbox_notification_dto is not None:
            _body_params = sandbox_notification_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/sandbox/{sandboxId}/notification',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
