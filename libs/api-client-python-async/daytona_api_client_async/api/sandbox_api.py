...
from daytona_api_client_async.models.fork_sandbox_response import ForkSandboxResponse
...
class SandboxApi:
    ...
    @validate_call
    async def clone_sandbox_with_http_info(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox to clone")],
        clone_sandbox: CloneSandbox,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    @validate_call
    async def clone_sandbox_without_preload_content(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox to clone")],
        clone_sandbox: CloneSandbox,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
