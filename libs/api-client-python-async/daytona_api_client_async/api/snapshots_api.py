...
class SnapshotsApi:
    ...
    async def build_snapshot(
        ...
        :param build_snapshot: (required)
        :type build_snapshot: BuildSnapshot
        ...
        _param = self._build_snapshot_serialize(
    ...
    @validate_call
    async def build_snapshot_with_http_info(
        self,
        build_snapshot: BuildSnapshot,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def build_snapshot_without_preload_content(
        self,
        build_snapshot: BuildSnapshot,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
