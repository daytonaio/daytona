...
from daytona_api_client_async.models.snapshot_runner_class_dto import SnapshotRunnerClassDto
...
class SnapshotsApi:
    ...
    @validate_call
    async def get_snapshot_runner_class(
        self,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> SnapshotRunnerClassDto:
        """Get runner class for a snapshot by name
        ...
        _param = self._get_snapshot_runner_class_serialize(
            name=name,
            x_daytona_organization_id=x_daytona_organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def get_snapshot_runner_class_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Snapshot name")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SnapshotRunnerClassDto]:
        """Get runner class for a snapshot by name
    ...
    @validate_call
    async def get_snapshot_runner_class_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Snapshot name")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
    ...
    def _get_snapshot_runner_class_serialize(
        self,
        name,
        x_daytona_organization_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/snapshots/{name}/runner-class',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
