...
from typing_extensions import Annotated
from daytona_api_client_async.models.change_volume_backend import ChangeVolumeBackend
...
class VolumesApi:
    ...
    @validate_call
    async def change_volume_backend(
        self,
        volume_id: Annotated[StrictStr, Field(description="ID of the volume")],
        change_volume_backend: ChangeVolumeBackend,
        ...
        :type volume_id: str
        :param change_volume_backend: (required)
        :type change_volume_backend: ChangeVolumeBackend
        ...
        _param = self._change_volume_backend_serialize(
            volume_id=volume_id,
            change_volume_backend=change_volume_backend,
    ...
    @validate_call
    async def change_volume_backend_with_http_info(
        self,
        volume_id: Annotated[StrictStr, Field(description="ID of the volume")],
        change_volume_backend: ChangeVolumeBackend,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    @validate_call
    async def change_volume_backend_without_preload_content(
        self,
        volume_id: Annotated[StrictStr, Field(description="ID of the volume")],
        change_volume_backend: ChangeVolumeBackend,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    def _change_volume_backend_serialize(
        self,
        volume_id,
        change_volume_backend,
        ...
        if change_volume_backend is not None:
            _body_params = change_volume_backend
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/volumes/{volumeId}/backend',
