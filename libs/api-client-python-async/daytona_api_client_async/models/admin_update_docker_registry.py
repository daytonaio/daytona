...
class AdminUpdateDockerRegistry(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "url", "username", "password", "project", "isActive", "isFallback"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminUpdateDockerRegistry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminUpdateDockerRegistry from a dict"""
        if obj is None:
            return None
