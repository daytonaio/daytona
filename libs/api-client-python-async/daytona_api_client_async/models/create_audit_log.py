...
class CreateAuditLog(BaseModel):
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['create', 'read', 'update', 'delete', 'login', 'docker_registry_set_default', 'organization_user_update_role', 'organization_user_update_assigned_roles', 'organization_update_quota', 'organization_suspend', 'organization_unsuspend', 'organization_invitation_accept', 'organization_invitation_decline', 'user_link_account', 'user_unlink_account', 'user_leave_organization', 'user_regenerate_key_pair', 'runner_update_scheduling', 'sandbox_start', 'sandbox_stop', 'sandbox_replace_labels', 'sandbox_create_backup', 'sandbox_update_public_status', 'sandbox_set_auto_stop_interval', 'sandbox_set_auto_archive_interval', 'sandbox_archive', 'sandbox_get_port_preview_url', 'snapshot_toggle_state', 'snapshot_set_general_status', 'toolbox_delete_file', 'toolbox_download_file', 'toolbox_create_folder', 'toolbox_move_file', 'toolbox_set_file_permissions', 'toolbox_replace_in_files', 'toolbox_upload_file', 'toolbox_bulk_upload_files', 'toolbox_git_add_files', 'toolbox_git_create_branch', 'toolbox_git_delete_branch', 'toolbox_git_clone_repository', 'toolbox_git_commit_changes', 'toolbox_git_pull_changes', 'toolbox_git_push_changes', 'toolbox_git_checkout_branch', 'toolbox_execute_command', 'toolbox_create_session', 'toolbox_session_execute_command', 'toolbox_delete_session']):
