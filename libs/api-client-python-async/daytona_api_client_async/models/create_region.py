...
class CreateRegion(BaseModel):
    ...
    registry_id: Optional[StrictStr] = Field(default=None, description="Registry ID for the region", alias="registryId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "proxyUrl", "sshGatewayUrl", "registryId"]
