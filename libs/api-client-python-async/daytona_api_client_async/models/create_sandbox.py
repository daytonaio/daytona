...
class CreateSandbox(BaseModel):
    ...
    disk_id: Optional[StrictStr] = Field(default=None, description="Existing disk ID to attach to the sandbox", alias="diskId")
    ...
    __properties: ClassVar[List[str]] = ["name", "snapshot", "user", "env", "labels", "public", "networkBlockAll", "networkAllowList", "class", "target", "cpu", "gpu", "memory", "disk", "diskId", "autoStopInterval", "autoArchiveInterval", "autoDeleteInterval", "volumes", "buildInfo"]
