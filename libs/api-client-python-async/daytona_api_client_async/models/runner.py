...
class Runner(BaseModel):
    ...
    current_cpu_load_average: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Current CPU load average", alias="currentCpuLoadAverage")
    ...
    __properties: ClassVar[List[str]] = ["id", "domain", "apiUrl", "proxyUrl", "apiKey", "cpu", "memory", "disk", "gpu", "gpuType", "class", "currentCpuUsagePercentage", "currentCpuLoadAverage", "currentMemoryUsagePercentage", "currentDiskUsagePercentage", "currentAllocatedCpu", "currentAllocatedMemoryGiB", "currentAllocatedDiskGiB", "currentSnapshotCount", "availabilityScore", "region", "state", "lastChecked", "unschedulable", "createdAt", "updatedAt", "version"]
