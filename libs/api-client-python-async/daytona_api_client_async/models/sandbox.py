...
class Sandbox(BaseModel):
    ...
    last_activity_at: Optional[StrictStr] = Field(default=None, description="The last activity timestamp of the sandbox", alias="lastActivityAt")
