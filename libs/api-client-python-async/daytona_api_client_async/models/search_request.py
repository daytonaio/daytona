...
class SearchRequest(BaseModel):
    ...
    file_types: Optional[List[StrictStr]] = Field(default=None, description="File types to include (e.g., [\"js\", \"ts\"])")
    ...
    context: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Lines of context around matches")
    ...
    __properties: ClassVar[List[str]] = ["query", "path", "file_types", "include_globs", "exclude_globs", "case_sensitive", "multiline", "context", "count_only", "filenames_only", "json", "max_results", "rg_args"]
