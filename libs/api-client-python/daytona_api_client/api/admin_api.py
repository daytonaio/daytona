...
class AdminApi:
    ...
    @validate_call
    def admin_set_sandbox_error_state(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        set_sandbox_error_state_dto: SetSandboxErrorStateDto,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sandbox_id: ID of the sandbox (required)
        :type sandbox_id: str
        :param set_sandbox_error_state_dto: (required)
        :type set_sandbox_error_state_dto: SetSandboxErrorStateDto
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._admin_set_sandbox_error_state_serialize(
            sandbox_id=sandbox_id,
            set_sandbox_error_state_dto=set_sandbox_error_state_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def admin_set_sandbox_error_state_with_http_info(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        set_sandbox_error_state_dto: SetSandboxErrorStateDto,
        _request_timeout: Union[
    ...
    @validate_call
    def admin_set_sandbox_error_state_without_preload_content(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox")],
        set_sandbox_error_state_dto: SetSandboxErrorStateDto,
        _request_timeout: Union[
    ...
    def _admin_set_sandbox_error_state_serialize(
        self,
        sandbox_id,
        set_sandbox_error_state_dto,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if set_sandbox_error_state_dto is not None:
            _body_params = set_sandbox_error_state_dto
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/admin/sandbox/{sandboxId}/error',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
