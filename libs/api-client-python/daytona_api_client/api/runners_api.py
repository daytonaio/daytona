...
class RunnersApi:
    ...
    @validate_call
    def get_initial_runner_by_snapshot_id(
        self,
    ...
    @validate_call
    def get_initial_runner_by_snapshot_id_with_http_info(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="Snapshot ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_initial_runner_by_snapshot_id_without_preload_content(
        self,
        snapshot_id: Annotated[StrictStr, Field(description="Snapshot ID")],
        _request_timeout: Union[
            None,
