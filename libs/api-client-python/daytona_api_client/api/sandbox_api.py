...
from typing_extensions import Annotated
from daytona_api_client.models.clone_sandbox import CloneSandbox
from daytona_api_client.models.clone_sandbox_response import CloneSandboxResponse
...
class SandboxApi:
    ...
    def clone_sandbox(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox to clone")],
        clone_sandbox: CloneSandbox,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param sandbox_id_or_name: ID or name of the sandbox to clone (required)
        :type sandbox_id_or_name: str
        :param clone_sandbox: (required)
        :type clone_sandbox: CloneSandbox
        :param x_daytona_organization_id: Use with JWT to specify the organization ID
        :type x_daytona_organization_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._clone_sandbox_serialize(
            sandbox_id_or_name=sandbox_id_or_name,
    ...
    @validate_call
    def clone_sandbox_with_http_info(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox to clone")],
        clone_sandbox: CloneSandbox,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloneSandboxResponse]:
        """Clone a sandbox
    ...
    @validate_call
    def clone_sandbox_without_preload_content(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox to clone")],
        clone_sandbox: CloneSandbox,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    def _clone_sandbox_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if clone_sandbox is not None:
            _body_params = clone_sandbox
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/sandbox/{sandboxIdOrName}/clone',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def create_sandbox_snapshot(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox to create a snapshot from")],
        ...
        :param sandbox_id_or_name: ID or name of the sandbox to create a snapshot from (required)
        :type sandbox_id_or_name: str
    ...
    def fork_sandbox(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox to fork")],
        ...
        :param sandbox_id_or_name: ID or name of the sandbox to fork (required)
        :type sandbox_id_or_name: str
    ...
    def fork_sandbox_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ForkSandboxResponse]:
        """Fork a sandbox
    ...
    def get_sandbox_forks(
        ...
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        include_destroyed: Annotated[Optional[StrictBool], Field(description="Include destroyed sandboxes in the result")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_daytona_organization_id: Use with JWT to specify the organization ID
        :type x_daytona_organization_id: str
        :param include_destroyed: Include destroyed sandboxes in the result
    ...
    def get_sandbox_parent(
        ...
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        ancestors: Annotated[Optional[StrictBool], Field(description="If true, returns the full ancestor chain up to the root. If false, returns only the direct parent.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_daytona_organization_id: Use with JWT to specify the organization ID
        :type x_daytona_organization_id: str
        :param ancestors: If true, returns the full ancestor chain up to the root. If false, returns only the direct parent.
        :type ancestors: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
