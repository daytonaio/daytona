...
class Announcement(BaseModel):
    ...
    learn_more_url: Optional[StrictStr] = Field(
        default=None, description="URL to learn more about the announcement", alias="learnMoreUrl"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"text": obj.get("text"), "learnMoreUrl": obj.get("learnMoreUrl")})
