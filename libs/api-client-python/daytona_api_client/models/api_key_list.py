...
class ApiKeyList(BaseModel):
    ...
    last_used_at: datetime = Field(description="When the API key was last used", alias="lastUsedAt")
    expires_at: datetime = Field(description="When the API key expires", alias="expiresAt")
