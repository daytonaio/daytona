...
class CreateApiKey(BaseModel):
    ...
    def permissions_validate_enum(cls, value):
        """Validates the enum"""
        for i in value:
            if i not in set(['write:registries', 'delete:registries', 'write:snapshots', 'delete:snapshots', 'read:sandboxes', 'write:sandboxes', 'delete:sandboxes', 'read:volumes', 'write:volumes', 'delete:volumes', 'read:audit_logs']):
                raise ValueError("each list item must be one of ('write:registries', 'delete:registries', 'write:snapshots', 'delete:snapshots', 'read:sandboxes', 'write:sandboxes', 'delete:sandboxes', 'read:volumes', 'write:volumes', 'delete:volumes', 'read:audit_logs')")
        return value
