...
class CreateSnapshot(BaseModel):
    ...
    experimental: Optional[StrictBool] = Field(default=None, description="Whether the snapshot is experimental")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "imageName", "entrypoint", "general", "cpu", "gpu", "memory", "disk", "buildInfo", "experimental"]
