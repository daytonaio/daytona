...
class DaytonaConfiguration(BaseModel):
    ...
    linked_accounts_enabled: StrictBool = Field(
        description="Whether linked accounts are enabled", alias="linkedAccountsEnabled"
    )
    ...
    max_auto_archive_interval: Union[StrictFloat, StrictInt] = Field(
        description="Maximum auto-archive interval in minutes", alias="maxAutoArchiveInterval"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "announcements": dict((_k, Announcement.from_dict(_v)) for _k, _v in obj["announcements"].items())
