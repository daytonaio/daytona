...
class DaytonaConfiguration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["posthog", "oidc", "linkedAccountsEnabled", "announcements", "pylonAppId", "proxyTemplateUrl", "defaultSnapshot", "dashboardUrl", "maxAutoArchiveInterval", "maintananceMode", "environment", "billingApiUrl", "sshGatewayCommand"]
