...
class Organization(BaseModel):
    ...
    snapshot_deactivation_timeout_minutes: Union[StrictFloat, StrictInt] = Field(description="Time in minutes before an unused snapshot is deactivated", alias="snapshotDeactivationTimeoutMinutes")
    ...
    authenticated_rate_limit_ttl_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(description="Authenticated rate limit TTL in seconds", alias="authenticatedRateLimitTtlSeconds")
    sandbox_create_rate_limit_ttl_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(description="Sandbox create rate limit TTL in seconds", alias="sandboxCreateRateLimitTtlSeconds")
    sandbox_lifecycle_rate_limit_ttl_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(description="Sandbox lifecycle rate limit TTL in seconds", alias="sandboxLifecycleRateLimitTtlSeconds")
