...
class RegionDto(BaseModel):
    ...
    RegionDto
    """ # noqa: E501
    code: StrictStr = Field(description="Region code")
    ...
    docker_registry_id: Optional[StrictStr] = Field(description="Docker registry ID (optional)", alias="dockerRegistryId")
    ...
    __properties: ClassVar[List[str]] = ["code", "name", "organizationId", "dockerRegistryId", "createdAt", "updatedAt"]
