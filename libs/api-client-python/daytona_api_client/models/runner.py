...
class Runner(BaseModel):
    ...
    api_url: StrictStr = Field(description="The API URL of the runner", serialization_alias="apiUrl")
    proxy_url: StrictStr = Field(description="The proxy URL of the runner", serialization_alias="proxyUrl")
    ...
    gpu_type: StrictStr = Field(description="The type of GPU", serialization_alias="gpuType")
