...
module DaytonaApiClient
  class AdminApi
    ...
    # @param sandbox_id [String] ID of the sandbox
    # @param set_sandbox_error_state_dto [SetSandboxErrorStateDto] 
    # @param [Hash] opts the optional parameters
    # @return [Sandbox]
    def admin_set_sandbox_error_state(sandbox_id, set_sandbox_error_state_dto, opts = {})
      data, _status_code, _headers = admin_set_sandbox_error_state_with_http_info(sandbox_id, set_sandbox_error_state_dto, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Sandbox, Integer, Hash)>] Sandbox data, response status code and response headers
    def admin_set_sandbox_error_state_with_http_info(sandbox_id, set_sandbox_error_state_dto, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdminApi.admin_set_sandbox_error_state ...'
      end
      # verify the required parameter 'sandbox_id' is set
      if @api_client.config.client_side_validation && sandbox_id.nil?
        fail ArgumentError, "Missing the required parameter 'sandbox_id' when calling AdminApi.admin_set_sandbox_error_state"
      end
      # verify the required parameter 'set_sandbox_error_state_dto' is set
      if @api_client.config.client_side_validation && set_sandbox_error_state_dto.nil?
        fail ArgumentError, "Missing the required parameter 'set_sandbox_error_state_dto' when calling AdminApi.admin_set_sandbox_error_state"
      end
      # resource path
      local_var_path = '/admin/sandbox/{sandboxId}/error'.sub('{' + 'sandboxId' + '}', CGI.escape(sandbox_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(set_sandbox_error_state_dto)
      ...
      new_options = opts.merge(
        :operation => :"AdminApi.admin_set_sandbox_error_state",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdminApi#admin_set_sandbox_error_state\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
