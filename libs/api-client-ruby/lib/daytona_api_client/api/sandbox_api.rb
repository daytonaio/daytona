...
module DaytonaApiClient
  class SandboxApi
    ...
    # @param sandbox_id [String] ID of the sandbox
    # @param update_sandbox_degraded_reason_dto [UpdateSandboxDegradedReasonDto] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_daytona_organization_id Use with JWT to specify the organization ID
    # @return [nil]
    def update_sandbox_degraded_reason(sandbox_id, update_sandbox_degraded_reason_dto, opts = {})
      update_sandbox_degraded_reason_with_http_info(sandbox_id, update_sandbox_degraded_reason_dto, opts)
      nil
    end
    ...
    # @option opts [String] :x_daytona_organization_id Use with JWT to specify the organization ID
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_sandbox_degraded_reason_with_http_info(sandbox_id, update_sandbox_degraded_reason_dto, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SandboxApi.update_sandbox_degraded_reason ...'
      end
      # verify the required parameter 'sandbox_id' is set
      if @api_client.config.client_side_validation && sandbox_id.nil?
        fail ArgumentError, "Missing the required parameter 'sandbox_id' when calling SandboxApi.update_sandbox_degraded_reason"
      end
      # verify the required parameter 'update_sandbox_degraded_reason_dto' is set
      if @api_client.config.client_side_validation && update_sandbox_degraded_reason_dto.nil?
        fail ArgumentError, "Missing the required parameter 'update_sandbox_degraded_reason_dto' when calling SandboxApi.update_sandbox_degraded_reason"
      end
      # resource path
      local_var_path = '/sandbox/{sandboxId}/degraded-reason'.sub('{' + 'sandboxId' + '}', CGI.escape(sandbox_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_sandbox_degraded_reason_dto)
      ...
      new_options = opts.merge(
        :operation => :"SandboxApi.update_sandbox_degraded_reason",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SandboxApi#update_sandbox_degraded_reason\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
