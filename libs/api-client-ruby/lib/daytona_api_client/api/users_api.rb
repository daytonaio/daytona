...
module DaytonaApiClient
  class UsersApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_authenticated_user(opts = {})
      delete_authenticated_user_with_http_info(opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_authenticated_user_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.delete_authenticated_user ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UsersApi.delete_authenticated_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#delete_authenticated_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
