...
export const AuditApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllAuditLogs: async (limit?: number, page?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/audit`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getOrganizationAuditLogs: async (organizationId: string, limit?: number, page?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AuditApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllAuditLogs(limit?: number, page?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedAuditLogs>> {
         ...
         * @throws {RequiredError}
         */
        async getOrganizationAuditLogs(organizationId: string, limit?: number, page?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedAuditLogs>> {
...
export const AuditApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getOrganizationAuditLogs(organizationId: string, limit?: number, page?: number, options?: RawAxiosRequestConfig): AxiosPromise<PaginatedAuditLogs> {
            return localVarFp.getOrganizationAuditLogs(organizationId, limit, page, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AuditApi extends BaseAPI {
    ...
    public getAllAuditLogs(limit?: number, page?: number, options?: RawAxiosRequestConfig) {
        return AuditApiFp(this.configuration).getAllAuditLogs(limit, page, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AuditApi
     */
    public getOrganizationAuditLogs(organizationId: string, limit?: number, page?: number, options?: RawAxiosRequestConfig) {
        return AuditApiFp(this.configuration).getOrganizationAuditLogs(organizationId, limit, page, options).then((request) => request(this.axios, this.basePath));
    }
}
