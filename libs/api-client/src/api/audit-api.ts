...
export const AuditApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createAuditLog: async (createAuditLog: CreateAuditLog, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getAllAuditLogs: async (page?: number, limit?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/audit`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getOrganizationAuditLogs: async (organizationId: string, page?: number, limit?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AuditApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createAuditLog(createAuditLog: CreateAuditLog, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuditLog>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createAuditLog(createAuditLog, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuditApi.createAuditLog']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getAllAuditLogs(page?: number, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedAuditLogs>> {
         ...
         * @throws {RequiredError}
         */
        async getOrganizationAuditLogs(organizationId: string, page?: number, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedAuditLogs>> {
...
export const AuditApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getOrganizationAuditLogs(organizationId: string, page?: number, limit?: number, options?: RawAxiosRequestConfig): AxiosPromise<PaginatedAuditLogs> {
            return localVarFp.getOrganizationAuditLogs(organizationId, page, limit, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AuditApi extends BaseAPI {
    ...
    public createAuditLog(createAuditLog: CreateAuditLog, options?: RawAxiosRequestConfig) {
        return AuditApiFp(this.configuration).createAuditLog(createAuditLog, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAllAuditLogs(page?: number, limit?: number, options?: RawAxiosRequestConfig) {
        return AuditApiFp(this.configuration).getAllAuditLogs(page, limit, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AuditApi
     */
    public getOrganizationAuditLogs(organizationId: string, page?: number, limit?: number, options?: RawAxiosRequestConfig) {
        return AuditApiFp(this.configuration).getOrganizationAuditLogs(organizationId, page, limit, options).then((request) => request(this.axios, this.basePath));
    }
}
