...
// @ts-ignore
import type { OrganizationSandboxDefaultNetworkBlockAll } from '../models'
// @ts-ignore
...
export const OrganizationsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {string} organizationId Organization ID
     * @param {OrganizationSandboxDefaultNetworkBlockAll} organizationSandboxDefaultNetworkBlockAll
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    updateSandboxDefaultNetworkBlockAll: async (
      organizationId: string,
      organizationSandboxDefaultNetworkBlockAll: OrganizationSandboxDefaultNetworkBlockAll,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'organizationId' is not null or undefined
      assertParamExists('updateSandboxDefaultNetworkBlockAll', 'organizationId', organizationId)
      // verify required parameter 'organizationSandboxDefaultNetworkBlockAll' is not null or undefined
      assertParamExists(
        'updateSandboxDefaultNetworkBlockAll',
        'organizationSandboxDefaultNetworkBlockAll',
        organizationSandboxDefaultNetworkBlockAll,
      )
      const localVarPath = `/organizations/{organizationId}/sandbox-default-network-block-all`.replace(
        `{${'organizationId'}}`,
        encodeURIComponent(String(organizationId)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const OrganizationsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async updateSandboxDefaultNetworkBlockAll(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateSandboxDefaultNetworkBlockAll(
        organizationId,
        organizationSandboxDefaultNetworkBlockAll,
        options,
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['OrganizationsApi.updateSandboxDefaultNetworkBlockAll']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const OrganizationsApiFactory = function (
  ...
  return {
    ...
    updateSandboxDefaultNetworkBlockAll(
      ...
      return localVarFp
        .updateSandboxDefaultNetworkBlockAll(organizationId, organizationSandboxDefaultNetworkBlockAll, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class OrganizationsApi extends BaseAPI {
   ...
   * @memberof OrganizationsApi
   */
  public updateSandboxDefaultNetworkBlockAll(
    organizationId: string,
    organizationSandboxDefaultNetworkBlockAll: OrganizationSandboxDefaultNetworkBlockAll,
    options?: RawAxiosRequestConfig,
  ) {
