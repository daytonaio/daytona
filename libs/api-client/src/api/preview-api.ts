...
export const PreviewApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} xDaytonaBearerToken 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        hasSandboxAccessByToken: async (sandboxId: string, xDaytonaBearerToken: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'sandboxId' is not null or undefined
            assertParamExists('hasSandboxAccessByToken', 'sandboxId', sandboxId)
            // verify required parameter 'xDaytonaBearerToken' is not null or undefined
            assertParamExists('hasSandboxAccessByToken', 'xDaytonaBearerToken', xDaytonaBearerToken)
            const localVarPath = `/preview/{sandboxId}/proxy-access`
                .replace(`{${"sandboxId"}}`, encodeURIComponent(String(sandboxId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            if (xDaytonaBearerToken != null) {
                localVarHeaderParameter['x-daytona-bearer-token'] = String(xDaytonaBearerToken);
            }
            setSearchParams(localVarUrlObj, localVarQueryParameter);
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
...
export const PreviewApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async hasSandboxAccessByToken(sandboxId: string, xDaytonaBearerToken: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<boolean>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.hasSandboxAccessByToken(sandboxId, xDaytonaBearerToken, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PreviewApi.hasSandboxAccessByToken']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const PreviewApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        hasSandboxAccessByToken(sandboxId: string, xDaytonaBearerToken: string, options?: RawAxiosRequestConfig): AxiosPromise<boolean> {
            return localVarFp.hasSandboxAccessByToken(sandboxId, xDaytonaBearerToken, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Check if sandbox is public
...
export class PreviewApi extends BaseAPI {
     ...
     * @memberof PreviewApi
     */
    public hasSandboxAccessByToken(sandboxId: string, xDaytonaBearerToken: string, options?: RawAxiosRequestConfig) {
        return PreviewApiFp(this.configuration).hasSandboxAccessByToken(sandboxId, xDaytonaBearerToken, options).then((request) => request(this.axios, this.basePath));
    }
