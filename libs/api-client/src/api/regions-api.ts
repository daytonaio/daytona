...
export const RegionsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteRegion: async (
      ...
      assertParamExists('deleteRegion', 'code', code)
      const localVarPath = `/regions/{code}`.replace(`{${'code'}}`, encodeURIComponent(String(code)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const RegionsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createRegion(
      ...
      xDaytonaOrganizationID?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegionDto>> {
    ...
    async deleteRegion(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteRegion(code, xDaytonaOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async listRegions(
      xDaytonaOrganizationID?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RegionDto>>> {
...
export const RegionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    deleteRegion(code: string, xDaytonaOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
      return localVarFp.deleteRegion(code, xDaytonaOrganizationID, options).then((request) => request(axios, basePath))
    },
    /**
     *
     * @summary List all regions
     ...
     * @throws {RequiredError}
     */
    listRegions(xDaytonaOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<RegionDto>> {
...
export class RegionsApi extends BaseAPI {
   ...
   * @memberof RegionsApi
   */
  public deleteRegion(code: string, xDaytonaOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return RegionsApiFp(this.configuration)
      .deleteRegion(code, xDaytonaOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
