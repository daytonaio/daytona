...
export const RunnersApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    updateRunnerDraining: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const RunnersApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async updateRunnerDraining(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateRunnerDraining(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
...
export const RunnersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    updateRunnerDraining(id: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
      return localVarFp.updateRunnerDraining(id, options).then((request) => request(axios, basePath))
    },
    /**
     *
     * @summary Update runner scheduling status
...
export class RunnersApi extends BaseAPI {
   ...
   * @memberof RunnersApi
   */
  public updateRunnerDraining(id: string, options?: RawAxiosRequestConfig) {
    return RunnersApiFp(this.configuration)
      .updateRunnerDraining(id, options)
      .then((request) => request(this.axios, this.basePath))
  }
