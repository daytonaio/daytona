...
export const SandboxApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getSandboxesForRunner(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getSandboxesForRunner(xDaytonaOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
...
export const SandboxApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    getSandboxesForRunner(
      ...
      return localVarFp
        .getSandboxesForRunner(xDaytonaOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
...
export class SandboxApi extends BaseAPI {
   ...
   * @memberof SandboxApi
   */
  public getSandboxesForRunner(xDaytonaOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return SandboxApiFp(this.configuration)
      .getSandboxesForRunner(xDaytonaOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
