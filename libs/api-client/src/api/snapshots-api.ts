...
export const SnapshotsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllSnapshots: async (xDaytonaOrganizationID?: string, limit?: number, page?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/snapshots`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const SnapshotsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllSnapshots(xDaytonaOrganizationID?: string, limit?: number, page?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedSnapshotsDto>> {
...
export const SnapshotsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getAllSnapshots(xDaytonaOrganizationID?: string, limit?: number, page?: number, options?: RawAxiosRequestConfig): AxiosPromise<PaginatedSnapshotsDto> {
            return localVarFp.getAllSnapshots(xDaytonaOrganizationID, limit, page, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get snapshot by ID or name
...
export class SnapshotsApi extends BaseAPI {
     ...
     * @memberof SnapshotsApi
     */
    public getAllSnapshots(xDaytonaOrganizationID?: string, limit?: number, page?: number, options?: RawAxiosRequestConfig) {
        return SnapshotsApiFp(this.configuration).getAllSnapshots(xDaytonaOrganizationID, limit, page, options).then((request) => request(this.axios, this.basePath));
    }
