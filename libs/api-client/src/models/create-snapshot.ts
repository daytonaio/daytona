...
// May contain unused imports in some cases
// @ts-ignore
import type { CreateSnapshotTargetPropagation } from './create-snapshot-target-propagation'
...
export interface CreateSnapshot {
   ...
   * @type {Array<CreateSnapshotTargetPropagation>}
   * @memberof CreateSnapshot
   */
  targetPropagations?: Array<CreateSnapshotTargetPropagation>
}
