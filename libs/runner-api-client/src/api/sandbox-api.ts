...
export const SandboxApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async create(sandbox: CreateSandboxDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
         ...
         * @throws {RequiredError}
         */
        async removeDestroyed(sandboxId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.removeDestroyed(sandboxId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SandboxApi.removeDestroyed']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Resize sandbox
         ...
         * @throws {RequiredError}
         */
        async start(sandboxId: string, metadata?: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
         ...
         * @throws {RequiredError}
         */
        async stop(sandboxId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
...
export class SandboxApi extends BaseAPI {
    ...
    public removeDestroyed(sandboxId: string, options?: RawAxiosRequestConfig) {
        return SandboxApiFp(this.configuration).removeDestroyed(sandboxId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public start(sandboxId: string, metadata?: object, options?: RawAxiosRequestConfig) {
        return SandboxApiFp(this.configuration).start(sandboxId, metadata, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public stop(sandboxId: string, options?: RawAxiosRequestConfig) {
        return SandboxApiFp(this.configuration).stop(sandboxId, options).then((request) => request(this.axios, this.basePath));
    }
