...
export const SnapshotsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Create a snapshot by committing a sandbox container and pushing to the registry. The operation runs asynchronously and returns 202 immediately.
...
export const SnapshotsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createSnapshot(request: CreateSnapshotDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
...
export const SnapshotsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createSnapshot(request: CreateSnapshotDTO, options?: RawAxiosRequestConfig): AxiosPromise<string> {
...
export class SnapshotsApi extends BaseAPI {
    ...
    public createSnapshot(request: CreateSnapshotDTO, options?: RawAxiosRequestConfig) {
        return SnapshotsApiFp(this.configuration).createSnapshot(request, options).then((request) => request(this.axios, this.basePath));
    }
