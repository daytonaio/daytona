...
export interface SandboxServiceClient {
  ...
  getSandboxInfo(request: GetSandboxInfoRequest, metadata: Metadata, ...rest: any): Observable<GetSandboxInfoResponse>
...
export interface SandboxServiceController {
  ...
  getSandboxInfo(
    ...
    metadata: Metadata,
    ...rest: any
  ): Promise<GetSandboxInfoResponse> | Observable<GetSandboxInfoResponse> | GetSandboxInfoResponse
