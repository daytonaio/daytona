...
var (
	...
	// Proxy.
	ErrSandboxNotFound   = &DaytonaError{Source: SourceProxy, Code: "SANDBOX_NOT_FOUND"}
	ErrSandboxNotStarted = &DaytonaError{Source: SourceProxy, Code: "SANDBOX_NOT_STARTED"}
	ErrRunnerUnreachable = &DaytonaError{Source: SourceProxy, Code: "RUNNER_UNREACHABLE"}

	// API.
	ErrApiKeyExpired                 = &DaytonaError{Source: SourceAPI, Code: "API_KEY_EXPIRED"}
	ErrOrganizationSuspended         = &DaytonaError{Source: SourceAPI, Code: "ORGANIZATION_SUSPENDED"}
	ErrSandboxDiskExpansionLimit     = &DaytonaError{Source: SourceAPI, Code: "SANDBOX_DISK_EXPANSION_LIMIT"}
	ErrSandboxRunnerNotFound         = &DaytonaError{Source: SourceAPI, Code: "SANDBOX_RUNNER_NOT_FOUND"}
	ErrSandboxStateChangeInProgress  = &DaytonaError{Source: SourceAPI, Code: "SANDBOX_STATE_CHANGE_IN_PROGRESS"}
	ErrVolumeInUse                   = &DaytonaError{Source: SourceAPI, Code: "VOLUME_IN_USE"}
	ErrDefaultRegionRequired         = &DaytonaError{Source: SourceAPI, Code: "DEFAULT_REGION_REQUIRED"}
	ErrNoAvailableRunners            = &DaytonaError{Source: SourceAPI, Code: "NO_AVAILABLE_RUNNERS"}
	ErrOrganizationQuotaExceeded     = &DaytonaError{Source: SourceAPI, Code: "ORGANIZATION_QUOTA_EXCEEDED"}
	ErrSandboxBackupState            = &DaytonaError{Source: SourceAPI, Code: "SANDBOX_BACKUP_STATE"}
	ErrSandboxOperationNotSupported  = &DaytonaError{Source: SourceAPI, Code: "SANDBOX_OPERATION_NOT_SUPPORTED"}
	ErrSandboxState                  = &DaytonaError{Source: SourceAPI, Code: "SANDBOX_STATE"}
	ErrSnapshotStateChangeInProgress = &DaytonaError{Source: SourceAPI, Code: "SNAPSHOT_STATE_CHANGE_IN_PROGRESS"}
)
