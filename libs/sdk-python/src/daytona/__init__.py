...
_DYNAMIC_IMPORTS: dict[str, str] = {
    ...
    "DaytonaGitError": "common.errors",
    "DaytonaGitAuthenticationError": "common.errors",
    "DaytonaGitAuthorizationError": "common.errors",
    "DaytonaGitRepoNotFoundError": "common.errors",
    "DaytonaGitBranchNotFoundError": "common.errors",
    "DaytonaGitRefNotFoundError": "common.errors",
    "DaytonaGitEmptyRepoError": "common.errors",
