...
class AsyncMouse:
    ...
    def __init__(self, sandbox_id: str, api_client: ComputerUseApi):
...
class AsyncComputerUse:
    ...
    def __init__(self, sandbox_id: str, api_client: ComputerUseApi):
        ...
        self.mouse = AsyncMouse(sandbox_id, api_client)
        self.keyboard = AsyncKeyboard(sandbox_id, api_client)
        self.screenshot = AsyncScreenshot(sandbox_id, api_client)
        self.display = AsyncDisplay(sandbox_id, api_client)
