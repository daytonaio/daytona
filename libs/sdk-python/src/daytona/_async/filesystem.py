...
class AsyncFileSystem:
    ...
    async def delete_file(self, path: str, recursive: bool = False) -> None:
        ...
        await self._api_client.delete_file(
            path=prefix_relative_path(await self._get_root_dir(), path), recursive=recursive
        )
    ...
    async def download_file(self, *args: str) -> Union[bytes, None]:
        if len(args) == 1 or (len(args) == 2 and isinstance(args[1], int)):
            ...
            return await self._api_client.download_file(
    ...
    async def get_file_info(self, path: str) -> FileInfo:
        ...
        Example:
            ...
            ```
        """
        return await self._api_client.get_file_info(path=prefix_relative_path(await self._get_root_dir(), path))
    ...
    async def list_files(self, path: str) -> List[FileInfo]:
        ...
        Example:
            ...
            ```
        """
        return await self._api_client.list_files(path=prefix_relative_path(await self._get_root_dir(), path))
