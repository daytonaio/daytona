...
class Keyboard:
    ...
    def type(self, text: str, delay: Optional[int] = None) -> bool:
        ...
        response = self._toolbox_api.type_text(self._sandbox_id, request)
        return response
    ...
    def press(self, key: str, modifiers: Optional[List[str]] = None) -> bool:
        ...
        response = self._toolbox_api.press_key(self._sandbox_id, request)
        return response
    ...
    def hotkey(self, keys: str) -> bool:
        ...
        response = self._toolbox_api.press_hotkey(self._sandbox_id, request)
        return response
...
class ComputerUse:
    ...
    def get_status(self) -> ComputerUseStatusResponse:
        ...
        Example:
            ...
            ```
        """
        response = self._toolbox_api.get_computer_use_status(self._sandbox_id)
        return response
