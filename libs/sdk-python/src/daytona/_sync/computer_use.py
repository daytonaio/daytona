...
class ComputerUse:
    ...
    def __init__(self, sandbox_id: str, api_client: ComputerUseApi):
        ...
        self.mouse = Mouse(sandbox_id, api_client)
        self.keyboard = Keyboard(sandbox_id, api_client)
        self.screenshot = Screenshot(sandbox_id, api_client)
        self.display = Display(sandbox_id, api_client)
