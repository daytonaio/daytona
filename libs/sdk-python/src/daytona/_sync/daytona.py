    ...
    def __init__(self, config: Optional[DaytonaConfig] = None):
        ...
        if config:
            if not config.api_key and config.jwt_token:
                ...
                self._api_key = config.api_key or self._api_key
            self._jwt_token = config.jwt_token or self._jwt_token
            self._organization_id = config.organization_id or self._organization_id
