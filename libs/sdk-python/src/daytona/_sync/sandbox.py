...
class Sandbox(SandboxDto):
    ...
    def __init__(
        ...
        self._fs = FileSystem(self.id, FileSystemApi(api_client), self.__get_root_dir)
        self._git = Git(self.id, GitApi(api_client), self.__get_root_dir)
        self._process = Process(
            self.id, code_toolbox, ProcessApi(api_client), self.__get_root_dir, self.get_preview_link
        )
        self._computer_use = ComputerUse(self.id, ComputerUseApi(api_client))
    ...
    def get_user_root_dir(self) -> str:
        ...
        Example:
            ...
            ```
        """
        response = self._info_api.get_project_dir()
        return response.dir
