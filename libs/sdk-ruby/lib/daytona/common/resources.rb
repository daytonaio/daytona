...
module Daytona
  class Resources
    ...
    # @return [String, Array<String>, nil] Preferred GPU type. Accepts a single
    #   {Daytona::GpuType} value or an ordered preference list — the scheduler
    #   tries each in order and pins the sandbox/snapshot to the first that
    ...
    # @param gpu_type [String, Array<String>, nil] Preferred GPU type or
    #   ordered preference list of {Daytona::GpuType} values.
