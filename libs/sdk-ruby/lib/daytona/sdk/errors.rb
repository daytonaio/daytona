...
module Daytona
  module Sdk # rubocop:disable Metrics/ModuleLength
    ...
    # Proxy
    class SandboxNotFoundError < NotFoundError; end
    class SandboxNotStartedError < BadRequestError; end
    class RunnerUnreachableError < BadGatewayError; end

    # API
    class ApiKeyExpiredError < AuthenticationError; end
    class OrganizationSuspendedError < ForbiddenError; end
    class SandboxDiskExpansionLimitError < ForbiddenError; end
    class SandboxRunnerNotFoundError < NotFoundError; end
    class SandboxStateChangeInProgressError < ConflictError; end
    class VolumeInUseError < ConflictError; end
    class DefaultRegionRequiredError < BadRequestError; end
    class NoAvailableRunnersError < BadRequestError; end
    class OrganizationQuotaExceededError < BadRequestError; end
    class SandboxBackupStateError < BadRequestError; end
    class SandboxOperationNotSupportedError < BadRequestError; end
    class SandboxStateError < BadRequestError; end
    class SnapshotStateChangeInProgressError < BadRequestError; end
    ...
    CODE_TO_ERROR = {
      ...
      # Proxy
      [SOURCE_PROXY, 'SANDBOX_NOT_FOUND'] => SandboxNotFoundError,
      [SOURCE_PROXY, 'SANDBOX_NOT_STARTED'] => SandboxNotStartedError,
      [SOURCE_PROXY, 'RUNNER_UNREACHABLE'] => RunnerUnreachableError,

      # API
      [SOURCE_API, 'API_KEY_EXPIRED'] => ApiKeyExpiredError,
      [SOURCE_API, 'ORGANIZATION_SUSPENDED'] => OrganizationSuspendedError,
      [SOURCE_API, 'SANDBOX_DISK_EXPANSION_LIMIT'] => SandboxDiskExpansionLimitError,
      [SOURCE_API, 'SANDBOX_RUNNER_NOT_FOUND'] => SandboxRunnerNotFoundError,
      [SOURCE_API, 'SANDBOX_STATE_CHANGE_IN_PROGRESS'] => SandboxStateChangeInProgressError,
      [SOURCE_API, 'VOLUME_IN_USE'] => VolumeInUseError,
      [SOURCE_API, 'DEFAULT_REGION_REQUIRED'] => DefaultRegionRequiredError,
      [SOURCE_API, 'NO_AVAILABLE_RUNNERS'] => NoAvailableRunnersError,
      [SOURCE_API, 'ORGANIZATION_QUOTA_EXCEEDED'] => OrganizationQuotaExceededError,
      [SOURCE_API, 'SANDBOX_BACKUP_STATE'] => SandboxBackupStateError,
      [SOURCE_API, 'SANDBOX_OPERATION_NOT_SUPPORTED'] => SandboxOperationNotSupportedError,
      [SOURCE_API, 'SANDBOX_STATE'] => SandboxStateError,
      [SOURCE_API, 'SNAPSHOT_STATE_CHANGE_IN_PROGRESS'] => SnapshotStateChangeInProgressError
    }.freeze
