...
type ComputerUseAPI interface {
	...
	*/
	...
	/*
	GetBrowserCDP Get browser CDP URL

	Lazily start managed Chromium and return a CDP WebSocket URL

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ComputerUseAPIGetBrowserCDPRequest
	*/
	GetBrowserCDP(ctx context.Context) ComputerUseAPIGetBrowserCDPRequest

	// GetBrowserCDPExecute executes the request
	//  @return BrowserCDPResponse
	GetBrowserCDPExecute(r ComputerUseAPIGetBrowserCDPRequest) (*BrowserCDPResponse, *http.Response, error)

	/*
	GetBrowserStatus Get browser status

	Get the managed Chromium process status

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ComputerUseAPIGetBrowserStatusRequest
	*/
	GetBrowserStatus(ctx context.Context) ComputerUseAPIGetBrowserStatusRequest

	// GetBrowserStatusExecute executes the request
	//  @return BrowserStatusResponse
	GetBrowserStatusExecute(r ComputerUseAPIGetBrowserStatusRequest) (*BrowserStatusResponse, *http.Response, error)
	...
	*/
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ComputerUseAPIStopBrowserRequest
	*/
	StopBrowser(ctx context.Context) ComputerUseAPIStopBrowserRequest

	// StopBrowserExecute executes the request
	//  @return map[string]interface{}
	StopBrowserExecute(r ComputerUseAPIStopBrowserRequest) (map[string]interface{}, *http.Response, error)
...
type ComputerUseAPIGetBrowserCDPRequest struct {
	ctx context.Context
	ApiService ComputerUseAPI
}

func (r ComputerUseAPIGetBrowserCDPRequest) Execute() (*BrowserCDPResponse, *http.Response, error) {
	return r.ApiService.GetBrowserCDPExecute(r)
}
...
Lazily start managed Chromium and return a CDP WebSocket URL
 ...
 @return ComputerUseAPIGetBrowserCDPRequest
*/
func (a *ComputerUseAPIService) GetBrowserCDP(ctx context.Context) ComputerUseAPIGetBrowserCDPRequest {
	return ComputerUseAPIGetBrowserCDPRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BrowserCDPResponse
func (a *ComputerUseAPIService) GetBrowserCDPExecute(r ComputerUseAPIGetBrowserCDPRequest) (*BrowserCDPResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BrowserCDPResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ComputerUseAPIService.GetBrowserCDP")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/computeruse/browser/cdp"
...
type ComputerUseAPIGetBrowserStatusRequest struct {
	ctx context.Context
	ApiService ComputerUseAPI
}

func (r ComputerUseAPIGetBrowserStatusRequest) Execute() (*BrowserStatusResponse, *http.Response, error) {
	return r.ApiService.GetBrowserStatusExecute(r)
}
...
Get the managed Chromium process status
 ...
 @return ComputerUseAPIGetBrowserStatusRequest
*/
func (a *ComputerUseAPIService) GetBrowserStatus(ctx context.Context) ComputerUseAPIGetBrowserStatusRequest {
	return ComputerUseAPIGetBrowserStatusRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BrowserStatusResponse
func (a *ComputerUseAPIService) GetBrowserStatusExecute(r ComputerUseAPIGetBrowserStatusRequest) (*BrowserStatusResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BrowserStatusResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ComputerUseAPIService.GetBrowserStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/computeruse/browser/status"
...
type ComputerUseAPIStopBrowserRequest struct {
	ctx context.Context
	ApiService ComputerUseAPI
}

func (r ComputerUseAPIStopBrowserRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.StopBrowserExecute(r)
}
...
Stop the managed Chromium process
 ...
 @return ComputerUseAPIStopBrowserRequest
*/
func (a *ComputerUseAPIService) StopBrowser(ctx context.Context) ComputerUseAPIStopBrowserRequest {
	return ComputerUseAPIStopBrowserRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ComputerUseAPIService) StopBrowserExecute(r ComputerUseAPIStopBrowserRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ComputerUseAPIService.StopBrowser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/computeruse/browser/stop"
