...
public class UploadedFile {
  ...
  public UploadedFile name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UploadedFile path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public UploadedFile type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the UploadedFile instance itself
   */
  public UploadedFile putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, uploadedFile.name) &&
        Objects.equals(this.path, uploadedFile.path) &&
        Objects.equals(this.type, uploadedFile.type)&&
        Objects.equals(this.additionalProperties, uploadedFile.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, path, type, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UploadedFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UploadedFile is not found in the empty JSON string", UploadedFile.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UploadedFile>() {
           ...
           public UploadedFile read(JsonReader in) throws IOException {
             ...
             UploadedFile instance = thisAdapter.fromJsonTree(jsonObj);
