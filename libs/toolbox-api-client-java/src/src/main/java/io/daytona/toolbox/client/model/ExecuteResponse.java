...
public class ExecuteResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(exitCode, result);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExecuteResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExecuteResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
