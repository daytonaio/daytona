...
from daytona_toolbox_api_client_async.models.accessibility_wait_request import AccessibilityWaitRequest
from daytona_toolbox_api_client_async.models.accessibility_wait_response import AccessibilityWaitResponse
...
class ComputerUseApi:
    ...
    @validate_call
    async def wait_accessibility(
        self,
        request: Annotated[AccessibilityWaitRequest, Field(description="Wait request")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type request: AccessibilityWaitRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._wait_accessibility_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def wait_accessibility_with_http_info(
        self,
        request: Annotated[AccessibilityWaitRequest, Field(description="Wait request")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccessibilityWaitResponse]:
        """Wait for accessibility readiness
    ...
    @validate_call
    async def wait_accessibility_without_preload_content(
        self,
        request: Annotated[AccessibilityWaitRequest, Field(description="Wait request")],
        _request_timeout: Union[
            None,
    ...
    def _wait_accessibility_serialize(
        self,
        request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/computeruse/a11y/wait',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
