...
from daytona_toolbox_api_client_async.models.git_clone_job_response import GitCloneJobResponse
from daytona_toolbox_api_client_async.models.git_clone_request import GitCloneRequest
from daytona_toolbox_api_client_async.models.git_clone_response import GitCloneResponse
...
class GitApi:
    ...
    async def clone_repository(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GitCloneResponse",
            '202': "GitCloneResponse",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    async def get_clone_job(
        self,
        job_id: Annotated[StrictStr, Field(description="Clone expansion job ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param job_id: Clone expansion job ID (required)
        :type job_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_clone_job_serialize(
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_clone_job_with_http_info(
        self,
        job_id: Annotated[StrictStr, Field(description="Clone expansion job ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GitCloneJobResponse]:
        """Get clone expansion job status
    ...
    @validate_call
    async def get_clone_job_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="Clone expansion job ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_clone_job_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/git/clone/jobs/{jobId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
