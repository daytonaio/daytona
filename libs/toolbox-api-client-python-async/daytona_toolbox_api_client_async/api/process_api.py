...
class ProcessApi:
    ...
    @validate_call
    async def terminate_session_command(
        self,
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        command_id: Annotated[StrictStr, Field(description="Command ID")],
        _request_timeout: Union[
        ...
        _param = self._terminate_session_command_serialize(
            session_id=session_id,
            command_id=command_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def terminate_session_command_with_http_info(
        self,
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        command_id: Annotated[StrictStr, Field(description="Command ID")],
        _request_timeout: Union[
    ...
    @validate_call
    async def terminate_session_command_without_preload_content(
        self,
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        command_id: Annotated[StrictStr, Field(description="Command ID")],
        _request_timeout: Union[
    ...
    def _terminate_session_command_serialize(
        self,
        session_id,
        command_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/process/session/{sessionId}/command/{commandId}/terminate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
