...
class ProcessApi:
    ...
    async def kill_process(
        self,
        pid: Annotated[StrictInt, Field(description="OS Process ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._kill_process_serialize(
            pid=pid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def kill_process_with_http_info(
        self,
        pid: Annotated[StrictInt, Field(description="OS Process ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def kill_process_without_preload_content(
        self,
        pid: Annotated[StrictInt, Field(description="OS Process ID")],
        _request_timeout: Union[
            None,
    ...
    async def list_processes_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListProcessesResponse]:
        """List all running processes
