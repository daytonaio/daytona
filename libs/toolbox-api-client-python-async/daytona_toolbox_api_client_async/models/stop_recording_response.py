...
class StopRecordingResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["durationSeconds", "filePath", "id", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StopRecordingResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StopRecordingResponse from a dict"""
        if obj is None:
            return None
