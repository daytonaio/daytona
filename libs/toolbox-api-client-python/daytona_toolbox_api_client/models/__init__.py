...
if TYPE_CHECKING:
    ...
    from daytona_toolbox_api_client.models.execute_tty_response import ExecuteTTYResponse
...
_DYNAMIC_IMPORTS: dict[str, str] = {
    ...
    "ExecuteTTYResponse": "daytona_toolbox_api_client.models.execute_tty_response",
