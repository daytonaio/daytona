...
_DYNAMIC_IMPORTS: dict[str, str] = {
    ...
    "BrowserCDPResponse": "daytona_toolbox_api_client.models.browser_cdp_response",
    "BrowserStatusResponse": "daytona_toolbox_api_client.models.browser_status_response",
