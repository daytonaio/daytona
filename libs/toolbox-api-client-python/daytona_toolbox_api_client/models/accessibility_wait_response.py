...
class AccessibilityWaitResponse(BaseModel):
    """
    AccessibilityWaitResponse
    """ # noqa: E501
    elapsed_ms: Optional[StrictInt] = Field(default=None, serialization_alias="elapsedMs")
    matched: Optional[StrictBool] = None
    matches: Optional[List[ComputerUseAccessibilityNode]] = None
    timed_out: Optional[StrictBool] = Field(default=None, serialization_alias="timedOut")
    truncated: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["elapsedMs", "matched", "matches", "timedOut", "truncated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessibilityWaitResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessibilityWaitResponse from a dict"""
        if obj is None:
            return None
