...
// @ts-ignore
import type { BrowserCDPResponse } from '../models';
// @ts-ignore
import type { BrowserStatusResponse } from '../models';
// @ts-ignore
...
export const ComputerUseApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getBrowserCDP: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/computeruse/browser/cdp`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getBrowserStatus: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/computeruse/browser/status`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        stopBrowser: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/computeruse/browser/stop`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const ComputerUseApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getBrowserCDP(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BrowserCDPResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBrowserCDP(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ComputerUseApi.getBrowserCDP']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Get the managed Chromium process status
         ...
         * @throws {RequiredError}
         */
        async getBrowserStatus(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BrowserStatusResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBrowserStatus(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ComputerUseApi.getBrowserStatus']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Get the status of all computer use processes
         ...
         * @throws {RequiredError}
         */
        async stopBrowser(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.stopBrowser(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ComputerUseApi.stopBrowser']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Stop all computer use processes and return their status
...
export const ComputerUseApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getBrowserCDP(options?: RawAxiosRequestConfig): AxiosPromise<BrowserCDPResponse> {
            return localVarFp.getBrowserCDP(options).then((request) => request(axios, basePath));
        },
        /**
         * Get the managed Chromium process status
         * @summary Get browser status
         ...
         * @throws {RequiredError}
         */
        getBrowserStatus(options?: RawAxiosRequestConfig): AxiosPromise<BrowserStatusResponse> {
            return localVarFp.getBrowserStatus(options).then((request) => request(axios, basePath));
        },
        /**
         * Get the status of all computer use processes
         * @summary Get computer use process status
         ...
         * @throws {RequiredError}
         */
        stopBrowser(options?: RawAxiosRequestConfig): AxiosPromise<object> {
            return localVarFp.stopBrowser(options).then((request) => request(axios, basePath));
        },
        /**
         * Stop all computer use processes and return their status
         * @summary Stop computer use processes
...
export class ComputerUseApi extends BaseAPI {
     ...
     * @memberof ComputerUseApi
     */
    public getBrowserCDP(options?: RawAxiosRequestConfig) {
        return ComputerUseApiFp(this.configuration).getBrowserCDP(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ComputerUseApi
     */
    public getBrowserStatus(options?: RawAxiosRequestConfig) {
        return ComputerUseApiFp(this.configuration).getBrowserStatus(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ComputerUseApi
     */
    public stopBrowser(options?: RawAxiosRequestConfig) {
        return ComputerUseApiFp(this.configuration).stopBrowser(options).then((request) => request(this.axios, this.basePath));
    }
