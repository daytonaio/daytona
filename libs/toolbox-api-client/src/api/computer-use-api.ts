...
// @ts-ignore
import type { AccessibilityWaitRequest } from '../models';
// @ts-ignore
import type { AccessibilityWaitResponse } from '../models';
// @ts-ignore
...
export const ComputerUseApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {AccessibilityWaitRequest} request Wait request
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        waitAccessibility: async (request: AccessibilityWaitRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'request' is not null or undefined
            assertParamExists('waitAccessibility', 'request', request)
            const localVarPath = `/computeruse/a11y/wait`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const ComputerUseApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async waitAccessibility(request: AccessibilityWaitRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AccessibilityWaitResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.waitAccessibility(request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ComputerUseApi.waitAccessibility']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const ComputerUseApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        waitAccessibility(request: AccessibilityWaitRequest, options?: RawAxiosRequestConfig): AxiosPromise<AccessibilityWaitResponse> {
            return localVarFp.waitAccessibility(request, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ComputerUseApi extends BaseAPI {
     ...
     * @memberof ComputerUseApi
     */
    public waitAccessibility(request: AccessibilityWaitRequest, options?: RawAxiosRequestConfig) {
        return ComputerUseApiFp(this.configuration).waitAccessibility(request, options).then((request) => request(this.axios, this.basePath));
    }
}
