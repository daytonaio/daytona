...
export const InterpreterApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    createInterpreterContext: async (
...
export const InterpreterApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async createInterpreterContext(
      request: CreateContextRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InterpreterContext>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createInterpreterContext(request, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['InterpreterApi.createInterpreterContext']?.[localVarOperationServerIndex]?.url
     ...
     * @throws {RequiredError}
     */
    async deleteInterpreterContext(
      id: string,
      options?: RawAxiosRequestConfig,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['InterpreterApi.deleteInterpreterContext']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async executeInterpreterCode(
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.executeInterpreterCode(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['InterpreterApi.executeInterpreterCode']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async listInterpreterContexts(
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListContextsResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listInterpreterContexts(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['InterpreterApi.listInterpreterContexts']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const InterpreterApiFactory = function (
  ...
  return {
    ...
    createInterpreterContext(
      request: CreateContextRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<InterpreterContext> {
...
export class InterpreterApi extends BaseAPI {
  ...
  public createInterpreterContext(request: CreateContextRequest, options?: RawAxiosRequestConfig) {
    return InterpreterApiFp(this.configuration)
