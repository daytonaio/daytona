...
It provides the following capabilities. For a complete API reference and method signatures, check the [Python](/python-sdk/common/image) and [TypeScript](/typescript-sdk/image) SDK references.
...
For detailed method signatures and usage examples, refer to the [Python](/python-sdk/common/image) and [TypeScript](/typescript-sdk/image) SDK references.
