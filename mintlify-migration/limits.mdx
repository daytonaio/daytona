...
The number of Sandboxes you can run at once depends on how much CPU, RAM, and storage each one uses. You can see how to configure and estimate resource usage in the [Sandbox Management docs](/sandbox-management/).
...
| Tier 2 | 100 / 200GiB / 300GiB | Credit card linked, $25 top-up, [GitHub connected](/linked-accounts#how-to-link-an-account). |
...
If you need higher or specialized limits, reach out to support@daytona.io.