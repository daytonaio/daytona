...
* `path` *string* - Path where the directory should be created. Relative paths are resolved based on the user’s root directory.
...
* `path` *string* - Path to the file or directory to delete. Relative paths are resolved based on the user’s root directory.
...
* `remotePath` *string* - Path to the file to download. Relative paths are resolved based on the user’s root directory.
...
* `remotePath` *string* - Path to the file to download in the Sandbox. Relative paths are resolved based on the user’s root directory.
...
* `path` *string* - Directory to search in. Relative paths are resolved based on the user’s root directory.
...
* `path` *string* - Path to the file or directory. Relative paths are resolved based on the user’s root directory.
...
* `path` *string* - Directory path to list. Relative paths are resolved based on the user’s root directory.
...
* `source` *string* - Source path. Relative paths are resolved based on the user’s root directory.
* `destination` *string* - Destination path. Relative paths are resolved based on the user’s root directory.
...
* `files` *string\[]* - Array of file paths to process. Relative paths are resolved based on the user’s
...
* `path` *string* - Directory to search in. Relative paths are resolved based on the user’s
...
* `remotePath` *string* - Destination path in the Sandbox. Relative paths are resolved based on the user’s root directory.
...
* `destination` *string* - Absolute destination path in the Sandbox. Relative paths are resolved based on the user’s root directory.
