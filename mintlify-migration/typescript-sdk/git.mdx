...
* `path` *string* - Path to the Git repository root. Relative paths are resolved based on the user’s root directory.
...
* `path` *string* - Path where the repository should be cloned. Relative paths are resolved based on the user’s root directory.
