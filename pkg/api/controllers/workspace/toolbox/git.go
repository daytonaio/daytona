...
//	@Success		200
//	@Router			/workspace/{workspaceId}/toolbox/git/add [post]
//
//	@id				GitAddFiles
...
//	@Router			/workspace/{workspaceId}/toolbox/git/commit [post]
//
//	@id				GitCommitChanges
...
//	@Success		201
//	@Router			/workspace/{workspaceId}/toolbox/git/branches [post]
//
//	@id				GitCreateBranch
...
//	@Router			/workspace/{workspaceId}/toolbox/git/history [get]
//
//	@id				GitCommitHistory
...
//	@Router			/workspace/{workspaceId}/toolbox/git/branches [get]
//
//	@id				GitBranchList
...
//	@Success		200
//	@Router			/workspace/{workspaceId}/toolbox/git/pull [post]
//
//	@id				GitPullChanges
...
//	@Success		200
//	@Router			/workspace/{workspaceId}/toolbox/git/push [post]
//
//	@id				GitPushChanges
...
//	@Router			/workspace/{workspaceId}/toolbox/git/status [get]
//
//	@id				GitGitStatus
