...
//	@Param			server		body	LspServerRequest	true	"LspServerRequest"
...
//	@Param			workspaceId	path	string				true	"Workspace ID or Name"
//	@Param			projectId	path	string				true	"Project Id"
//	@Param			server		body	LspDocumentRequest	true	"LspDocumentRequest"
//	@Success		200			{array}	Match
//	@Router			/workspace/{workspaceId}/{projectId}/toolbox/lsp/didopen [post]
//
//	@id				LspDidOpen
...
//	@Param			server		body	LspDocumentRequest	true	"LspDocumentRequest"
//	@Success		200			{array}	Match
//	@Router			/workspace/{workspaceId}/{projectId}/toolbox/lsp/didclose [post]
//
//	@id				LspDidClose
...
//	@Success		200			{array}	Match
//	@Router			/workspace/{workspaceId}/{projectId}/toolbox/lsp/documentSymbols [get]
//
...
//	@Success		200			{array}	Match
//	@Router			/workspace/{workspaceId}/{projectId}/toolbox/lsp/workspaceSymbols [get]
//
