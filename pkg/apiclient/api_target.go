...
*/
func (a *TargetAPIService) SetProjectState(ctx context.Context, targetId string, projectId string) ApiSetProjectStateRequest {
	return ApiSetProjectStateRequest{
		ApiService: a,
		ctx:        ctx,
		targetId:   targetId,
...
// Execute executes the request
func (a *TargetAPIService) SetProjectStateExecute(r ApiSetProjectStateRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TargetAPIService.SetProjectState")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/target/{targetId}/{projectId}/state"
	localVarPath = strings.Replace(localVarPath, "{"+"targetId"+"}", url.PathEscape(parameterValueToString(r.targetId, "targetId")), -1)
...
*/
func (a *TargetAPIService) StartProject(ctx context.Context, targetId string, projectId string) ApiStartProjectRequest {
	return ApiStartProjectRequest{
		ApiService: a,
		ctx:        ctx,
		targetId:   targetId,
...
// Execute executes the request
func (a *TargetAPIService) StartProjectExecute(r ApiStartProjectRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TargetAPIService.StartProject")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/target/{targetId}/{projectId}/start"
	localVarPath = strings.Replace(localVarPath, "{"+"targetId"+"}", url.PathEscape(parameterValueToString(r.targetId, "targetId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
...
*/
func (a *TargetAPIService) StopProject(ctx context.Context, targetId string, projectId string) ApiStopProjectRequest {
	return ApiStopProjectRequest{
		ApiService: a,
		ctx:        ctx,
		targetId:   targetId,
...
// Execute executes the request
func (a *TargetAPIService) StopProjectExecute(r ApiStopProjectRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TargetAPIService.StopProject")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/target/{targetId}/{projectId}/stop"
	localVarPath = strings.Replace(localVarPath, "{"+"targetId"+"}", url.PathEscape(parameterValueToString(r.targetId, "targetId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
