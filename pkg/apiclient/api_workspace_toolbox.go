...
func (r ApiListSessionsRequest) Execute() ([]SessionDTO, *http.Response, error) {
...
//
//	@return []SessionDTO
func (a *WorkspaceToolboxAPIService) ListSessionsExecute(r ApiListSessionsRequest) ([]SessionDTO, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
