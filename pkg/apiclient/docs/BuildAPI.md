...
func main() {
	createBuildDto := *openapiclient.NewCreateBuildDTO("Branch_example", map[string]string{"key": "Inner_example"}, "WorkspaceConfigName_example") // CreateBuildDTO | Create Build DTO
