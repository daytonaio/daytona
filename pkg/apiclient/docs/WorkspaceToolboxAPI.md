...
------------- | ------------- | -------------
[**FsCreateFolder**](WorkspaceToolboxAPI.md#FsCreateFolder) | **Post** /workspace/{workspaceId}/{projectId}/toolbox/files/createfolder | Create folder
...
[**GetProjectDir**](WorkspaceToolboxAPI.md#GetProjectDir) | **Get** /workspace/{workspaceId}/{projectId}/toolbox/projectdir | Get project dir
[**GitBranchList**](WorkspaceToolboxAPI.md#GitBranchList) | **Get** /workspace/{workspaceId}/{projectId}/toolbox/git/branchs | Get branch list
...
[**GitCreateBranch**](WorkspaceToolboxAPI.md#GitCreateBranch) | **Post** /workspace/{workspaceId}/{projectId}/toolbox/git/branchs | Create branch
...
[**LspDidClose**](WorkspaceToolboxAPI.md#LspDidClose) | **Post** /workspace/{workspaceId}/{projectId}/toolbox/lsp/didclose | Call Lsp DidClose
[**LspDidOpen**](WorkspaceToolboxAPI.md#LspDidOpen) | **Post** /workspace/{workspaceId}/{projectId}/toolbox/lsp/didopen | Call Lsp DidOpen
[**LspDocumentSymbols**](WorkspaceToolboxAPI.md#LspDocumentSymbols) | **Get** /workspace/{workspaceId}/{projectId}/toolbox/lsp/documentSymbols | Call Lsp DocumentSymbols
...
[**LspWorkspaceSymbols**](WorkspaceToolboxAPI.md#LspWorkspaceSymbols) | **Get** /workspace/{workspaceId}/{projectId}/toolbox/lsp/workspaceSymbols | Call Lsp WorkspaceSymbols
...
> []Match FsReplaceInFiles(ctx, workspaceId, projectId).Replace(replace).Execute()
...
func main() {
	...
	// response from `FsReplaceInFiles`: []Match
...
> []string FsSearchFiles(ctx, workspaceId, projectId).Path(path).Pattern(pattern).Execute()
...
func main() {
	...
	// response from `FsSearchFiles`: []string
...
> []Match GitBranchList(ctx, workspaceId, projectId).Path(path).Execute()
...
func main() {
	...
	// response from `GitBranchList`: []Match
...
> []Match GitCloneRepository(ctx, workspaceId, projectId).Params(params).Execute()
...
func main() {
	workspaceId := "workspaceId_example" // string | Workspace ID or Name
	projectId := "projectId_example" // string | Project Id
	params := *openapiclient.NewGitCloneRequest() // GitCloneRequest | GitCloneRequest

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkspaceToolboxAPI.GitCloneRepository(context.Background(), workspaceId, projectId).Params(params).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkspaceToolboxAPI.GitCloneRepository``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GitCloneRepository`: []Match
	fmt.Fprintf(os.Stdout, "Response from `WorkspaceToolboxAPI.GitCloneRepository`: %v\n", resp)
}
```
...
> []Match GitCommitChanges(ctx, workspaceId, projectId).Params(params).Execute()
...
func main() {
	...
	// response from `GitCommitChanges`: []Match
...
> []Match GitCommitHistory(ctx, workspaceId, projectId).Path(path).Execute()
...
func main() {
	...
	// response from `GitCommitHistory`: []Match
...
> []Match GitCreateBranch(ctx, workspaceId, projectId).Params(params).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkspaceToolboxAPI.GitCreateBranch(context.Background(), workspaceId, projectId).Params(params).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkspaceToolboxAPI.GitCreateBranch``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GitCreateBranch`: []Match
	fmt.Fprintf(os.Stdout, "Response from `WorkspaceToolboxAPI.GitCreateBranch`: %v\n", resp)
}
```
...
> []Match GitGitStatus(ctx, workspaceId, projectId).Path(path).Execute()
...
func main() {
	...
	// response from `GitGitStatus`: []Match
...
> []Match GitPushChanges(ctx, workspaceId, projectId).Params(params).Execute()
...
func main() {
	workspaceId := "workspaceId_example" // string | Workspace ID or Name
	projectId := "projectId_example" // string | Project Id
	params := *openapiclient.NewGitPushRequest("Path_example") // GitPushRequest | GitPushRequest

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkspaceToolboxAPI.GitPushChanges(context.Background(), workspaceId, projectId).Params(params).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkspaceToolboxAPI.GitPushChanges``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GitPushChanges`: []Match
	fmt.Fprintf(os.Stdout, "Response from `WorkspaceToolboxAPI.GitPushChanges`: %v\n", resp)
}
```
 ...
 **params** | [**GitPushRequest**](GitPushRequest.md) | GitPushRequest | 
...
> []Match LspCompletions(ctx, workspaceId, projectId).Params(params).Execute()
...
func main() {
	workspaceId := "workspaceId_example" // string | Workspace ID or Name
	projectId := "projectId_example" // string | Project Id
	params := *openapiclient.NewLspCompletionParams("LanguageId_example") // LspCompletionParams | LspCompletionParams
	...
	// response from `LspCompletions`: []Match
...
> []Match LspDidClose(ctx, workspaceId, projectId).Server(server).Execute()
...
func main() {
	workspaceId := "workspaceId_example" // string | Workspace ID or Name
	projectId := "projectId_example" // string | Project Id
	server := *openapiclient.NewLspDocumentRequest("LanguageId_example", "Uri_example") // LspDocumentRequest | LspDocumentRequest

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkspaceToolboxAPI.LspDidClose(context.Background(), workspaceId, projectId).Server(server).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkspaceToolboxAPI.LspDidClose``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LspDidClose`: []Match
	fmt.Fprintf(os.Stdout, "Response from `WorkspaceToolboxAPI.LspDidClose`: %v\n", resp)
}
```
 ...
 **server** | [**LspDocumentRequest**](LspDocumentRequest.md) | LspDocumentRequest | 
...
> []Match LspDidOpen(ctx, workspaceId, projectId).Server(server).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkspaceToolboxAPI.LspDidOpen(context.Background(), workspaceId, projectId).Server(server).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkspaceToolboxAPI.LspDidOpen``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LspDidOpen`: []Match
	fmt.Fprintf(os.Stdout, "Response from `WorkspaceToolboxAPI.LspDidOpen`: %v\n", resp)
}
```
...
> []Match LspDocumentSymbols(ctx, workspaceId, projectId).LanguageId(languageId).Uri(uri).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkspaceToolboxAPI.LspDocumentSymbols(context.Background(), workspaceId, projectId).LanguageId(languageId).Uri(uri).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkspaceToolboxAPI.LspDocumentSymbols``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LspDocumentSymbols`: []Match
...
> []Match LspStart(ctx, workspaceId, projectId).Server(server).Execute()
...
func main() {
	workspaceId := "workspaceId_example" // string | Workspace ID or Name
	projectId := "projectId_example" // string | Project Id
	server := *openapiclient.NewLspServerRequest("LanguageId_example") // LspServerRequest | LspServerRequest

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkspaceToolboxAPI.LspStart(context.Background(), workspaceId, projectId).Server(server).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkspaceToolboxAPI.LspStart``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LspStart`: []Match
	fmt.Fprintf(os.Stdout, "Response from `WorkspaceToolboxAPI.LspStart`: %v\n", resp)
}
```
 ...
 **server** | [**LspServerRequest**](LspServerRequest.md) | LspServerRequest | 
...
> []Match LspStop(ctx, workspaceId, projectId).Server(server).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkspaceToolboxAPI.LspStop(context.Background(), workspaceId, projectId).Server(server).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkspaceToolboxAPI.LspStop``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LspStop`: []Match
	fmt.Fprintf(os.Stdout, "Response from `WorkspaceToolboxAPI.LspStop`: %v\n", resp)
}
```
...
> []Match LspWorkspaceSymbols(ctx, workspaceId, projectId).LanguageId(languageId).Query(query).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkspaceToolboxAPI.LspWorkspaceSymbols(context.Background(), workspaceId, projectId).LanguageId(languageId).Query(query).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkspaceToolboxAPI.LspWorkspaceSymbols``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `LspWorkspaceSymbols`: []Match
