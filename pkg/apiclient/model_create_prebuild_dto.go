...
type CreatePrebuildDTO struct {
	...
	RunAtInit         *bool    `json:"runAtInit,omitempty"`
...
// GetRunAtInit returns the RunAtInit field value if set, zero value otherwise.
func (o *CreatePrebuildDTO) GetRunAtInit() bool {
	if o == nil || IsNil(o.RunAtInit) {
		var ret bool
		return ret
	}
	return *o.RunAtInit
...
// GetRunAtInitOk returns a tuple with the RunAtInit field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRunAtInit gets a reference to the given bool and assigns it to the RunAtInit field.
