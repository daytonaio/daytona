...
// checks if the WorkspaceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkspaceConfig{}

// WorkspaceConfig struct for WorkspaceConfig
...
type _WorkspaceConfig WorkspaceConfig
...
func (o WorkspaceConfig) MarshalJSON() ([]byte, error) {
...
func (o WorkspaceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *WorkspaceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkspaceConfig := _WorkspaceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWorkspaceConfig)

	if err != nil {
		return err
	}

	*o = WorkspaceConfig(varWorkspaceConfig)

	return err
}

type NullableWorkspaceConfig struct {
	value *WorkspaceConfig
	isSet bool
}

func (v NullableWorkspaceConfig) Get() *WorkspaceConfig {
	return v.value
}

func (v *NullableWorkspaceConfig) Set(val *WorkspaceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkspaceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkspaceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkspaceConfig(val *WorkspaceConfig) *NullableWorkspaceConfig {
	return &NullableWorkspaceConfig{value: val, isSet: true}
}

func (v NullableWorkspaceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkspaceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
