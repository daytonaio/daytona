...
var CodeCmd = &cobra.Command{
  ...
  RunE: func(cmd *cobra.Command, args []string) error {
  	...
  	return openIDE(ideId, activeProfile, workspaceId, projectName, providerMetadata, codeYesFlag, gpgKey)
  },
...
func init() {
  ...
  CodeCmd.Flags().StringVarP(&codeIdeFlag, "ide", "i", "", fmt.Sprintf("Specify the IDE (%s)", ideListStr))

  CodeCmd.Flags().BoolVarP(&codeYesFlag, "yes", "y", false, "Automatically confirm any prompts")
}
