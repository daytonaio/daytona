...
func init() {
	...
	WorkspaceConfigCmd.AddCommand(workspaceConfigAddCmd)
	...
	WorkspaceConfigCmd.AddCommand(workspaceTemplateExportCmd)
	WorkspaceConfigCmd.AddCommand(workspaceTemplateImportCmd)
}
