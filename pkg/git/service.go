...
func (s *Service) shouldCloneBranch(repo *gitprovider.GitRepository) bool {
	...
	return *repo.Branch != repo.Sha
}

func (s *Service) shouldCheckoutSha(repo *gitprovider.GitRepository) bool {
	if repo.Sha == "" {
		return false
	}
