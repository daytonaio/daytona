...
func renderApiKeyList(apiKeyList []*types.ApiKey, selectable bool) model {
	rows := []table.Row{}
	activeProfileRow := 0
...
func GetApiKeyNameFromPrompt(apiKeyList []*types.ApiKey, title string) string {
...
func ListApiKeys(apiKeyList []*types.ApiKey) {
