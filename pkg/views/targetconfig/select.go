...
func GetTargetConfigFromPrompt(targetConfigs []apiclient.TargetConfig, activeProfileName string, providerViewList *[]provider.ProviderView, withNewTarget bool, actionVerb string) (*TargetConfigView, error) {
	items := util.ArrayMap(targetConfigs, func(t apiclient.TargetConfig) list.Item {
		return item{
			target: ToTargetConfigView(t),
		}
	})
...
func ToTargetConfigView(target apiclient.TargetConfig) TargetConfigView {
