...
func (a *ServerGRPCServer) SetKey(ctx context.Context, request *daytona_proto.SetKeyRequest) (*daytona_proto.GetPublicKeyResponse, error) {
	err := config_ssh_key.SetPrivateKey(request.PrivateKey)
	if err != nil {
		return nil, err
	}
